...
Type annotations and code completion for `#!python session.client("resource-groups").get_paginator("list_grouping_statuses")`.
...
Type annotations and code completion for `#!python session.client("resource-groups").get_paginator("list_tag_sync_tasks")`.
