...
1. See [:material-code-braces: ComponentPlatformPaginatorTypeDef](./type_defs.md#componentplatformpaginatortypedef) 
...
class ComponentPaginatorTypeDef(TypedDict):
    arn: NotRequired[str],
    componentName: NotRequired[str],
    latestVersion: NotRequired[ComponentLatestVersionPaginatorTypeDef],  # (1)
```

1. See [:material-code-braces: ComponentLatestVersionPaginatorTypeDef](./type_defs.md#componentlatestversionpaginatortypedef) 
## ComponentTypeDef
...
```python
# ListComponentsResponsePaginatorTypeDef definition

class ListComponentsResponsePaginatorTypeDef(TypedDict):
    components: List[ComponentPaginatorTypeDef],  # (1)
    nextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```
