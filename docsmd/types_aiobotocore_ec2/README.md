...
Install `types-aioboto3` for `EC2` service.

```bash
# install with aioboto3 type annotations
python -m pip install 'types-aioboto3[ec2]'


# Lite version does not provide session.client/resource overloads
# it is more RAM-friendly, but requires explicit type annotations
python -m pip install 'types-aioboto3-lite[ec2]'
...
Type annotations and code completion for  `#!python session.client("ec2")` as [EC2Client](./client.md)
...
from `#!python session.client("ec2").get_paginator("...")`.
...
Type annotations and code completion for
[waiters](./waiters.md)
from `#!python session.client("ec2").get_waiter("...")`.
...
- [ConnectionTrackingConfigurationResponseTypeDef](./type_defs.md#connectiontrackingconfigurationresponsetypedef)
...
- [TagSpecificationPaginatorTypeDef](./type_defs.md#tagspecificationpaginatortypedef)
...
- [IpPermissionPaginatorTypeDef](./type_defs.md#ippermissionpaginatortypedef)
...
- [SecurityGroupPaginatorTypeDef](./type_defs.md#securitygrouppaginatortypedef)
...
- [DescribeSecurityGroupsResultPaginatorTypeDef](./type_defs.md#describesecuritygroupsresultpaginatortypedef)
...
- [SpotFleetRequestConfigDataPaginatorTypeDef](./type_defs.md#spotfleetrequestconfigdatapaginatortypedef)
...
- [SpotFleetRequestConfigPaginatorTypeDef](./type_defs.md#spotfleetrequestconfigpaginatortypedef)
...
- [DescribeSpotFleetRequestsResponsePaginatorTypeDef](./type_defs.md#describespotfleetrequestsresponsepaginatortypedef)
