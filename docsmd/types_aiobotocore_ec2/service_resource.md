...
- `public_ip`: `str`
- `meta`: `Awaitable`[[EC2ResourceMeta](#ec2resourcemeta)]
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").reset_source_dest_check` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").start` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").stop` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").terminate` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").unmonitor` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").wait_until_running` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").wait_until_stopped` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").wait_until_terminated` method.
...
async def get_resource() -> InternetGateway:
    async with session.resource("ec2") as resource:
        return await resource.InternetGateway(...)
```
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").attach_to_vpc` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").detach_from_vpc` method.
...
async def get_resource() -> KeyPair:
    async with session.resource("ec2") as resource:
        return await resource.KeyPair(...)
```
...
async def get_resource() -> KeyPairInfo:
    async with session.resource("ec2") as resource:
        return await resource.KeyPairInfo(...)
```
...
async def get_resource() -> NetworkAcl:
    async with session.resource("ec2") as resource:
        return await resource.NetworkAcl(...)
```
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").create_entry` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").delete_entry` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").replace_association` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").replace_entry` method.
...
async def get_resource() -> NetworkInterface:
    async with session.resource("ec2") as resource:
        return await resource.NetworkInterface(...)
```
...
- `connection_tracking_configuration`: `Awaitable`[[ConnectionTrackingConfigurationResponseTypeDef](./type_defs.md#connectiontrackingconfigurationresponsetypedef)]
- `description`: `Awaitable`[`str`]
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").assign_private_ip_addresses` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").attach` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").detach` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").unassign_private_ip_addresses` method.
...
async def get_resource() -> NetworkInterfaceAssociation:
    async with session.resource("ec2") as resource:
        return await resource.NetworkInterfaceAssociation(...)
```
...
async def get_resource() -> PlacementGroup:
    async with session.resource("ec2") as resource:
        return await resource.PlacementGroup(...)
```
...
async def get_resource() -> Route:
    async with session.resource("ec2") as resource:
        return await resource.Route(...)
```
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").RouteTable` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").replace` method.
...
async def get_resource() -> RouteTable:
    async with session.resource("ec2") as resource:
        return await resource.RouteTable(...)
```
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").associate_with_subnet` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").create_route` method.
...
async def get_resource() -> RouteTableAssociation:
    async with session.resource("ec2") as resource:
        return await resource.RouteTableAssociation(...)
```
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").replace_subnet` method.
...
async def get_resource() -> SecurityGroup:
    async with session.resource("ec2") as resource:
        return await resource.SecurityGroup(...)
```
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").authorize_egress` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").authorize_ingress` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").revoke_egress` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").revoke_ingress` method.
...
async def get_resource() -> Snapshot:
    async with session.resource("ec2") as resource:
        return await resource.Snapshot(...)
```
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").copy` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").wait_until_completed` method.
...
async def get_resource() -> Subnet:
    async with session.resource("ec2") as resource:
        return await resource.Subnet(...)
```
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").create_instances` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").create_network_interface` method.
...
async def get_resource() -> Tag:
    async with session.resource("ec2") as resource:
        return await resource.Tag(...)
```
...
async def get_resource() -> Volume:
    async with session.resource("ec2") as resource:
        return await resource.Volume(...)
```
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").attach_to_instance` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").create_snapshot` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").describe_status` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").detach_from_instance` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").enable_io` method.
...
async def get_resource() -> Vpc:
    async with session.resource("ec2") as resource:
        return await resource.Vpc(...)
```
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").associate_dhcp_options` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").attach_classic_link_instance` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").attach_internet_gateway` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").create_network_acl` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").create_route_table` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").create_security_group` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").create_subnet` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").detach_classic_link_instance` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").detach_internet_gateway` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").disable_classic_link` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").enable_classic_link` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").request_vpc_peering_connection` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").wait_until_available` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").accept` method.
...
Type annotations and code completion for `#!python aioboto3.resource("ec2").reject` method.
