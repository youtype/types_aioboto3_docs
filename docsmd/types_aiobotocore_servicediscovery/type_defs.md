...
```python
# DnsConfigPaginatorTypeDef definition

class DnsConfigPaginatorTypeDef(TypedDict):
...
```python
# ServiceSummaryPaginatorTypeDef definition

class ServiceSummaryPaginatorTypeDef(TypedDict):
    Id: NotRequired[str],
    Arn: NotRequired[str],
    ...
    DnsConfig: NotRequired[DnsConfigPaginatorTypeDef],  # (2)
...
2. See [:material-code-braces: DnsConfigPaginatorTypeDef](./type_defs.md#dnsconfigpaginatortypedef) 
...
```python
# ListServicesResponsePaginatorTypeDef definition

class ListServicesResponsePaginatorTypeDef(TypedDict):
    Services: List[ServiceSummaryPaginatorTypeDef],  # (1)
    NextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: ServiceSummaryPaginatorTypeDef](./type_defs.md#servicesummarypaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
