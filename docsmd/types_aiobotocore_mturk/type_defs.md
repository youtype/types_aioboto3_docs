...
```python
# QualificationRequirementPaginatorTypeDef definition

class QualificationRequirementPaginatorTypeDef(TypedDict):
    QualificationTypeId: str,
...
```python
# HITPaginatorTypeDef definition

class HITPaginatorTypeDef(TypedDict):
    HITId: NotRequired[str],
    HITTypeId: NotRequired[str],
    ...
    QualificationRequirements: NotRequired[List[QualificationRequirementPaginatorTypeDef]],  # (2)
...
2. See [:material-code-braces: QualificationRequirementPaginatorTypeDef](./type_defs.md#qualificationrequirementpaginatortypedef) 
...
```python
# ListHITsForQualificationTypeResponsePaginatorTypeDef definition

class ListHITsForQualificationTypeResponsePaginatorTypeDef(TypedDict):
    NextToken: str,
    NumResults: int,
    HITs: List[HITPaginatorTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: HITPaginatorTypeDef](./type_defs.md#hitpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
## ListHITsResponsePaginatorTypeDef

```python
# ListHITsResponsePaginatorTypeDef definition

class ListHITsResponsePaginatorTypeDef(TypedDict):
    NextToken: str,
    NumResults: int,
    HITs: List[HITPaginatorTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
...
```python
# ListReviewableHITsResponsePaginatorTypeDef definition

class ListReviewableHITsResponsePaginatorTypeDef(TypedDict):
    NextToken: str,
    NumResults: int,
    HITs: List[HITPaginatorTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
