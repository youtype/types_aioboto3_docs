...
class GetGroupPolicyResponseTypeDef(TypedDict):
    GroupName: str,
    PolicyName: str,
    PolicyDocument: Union[str, PolicyDocumentDictTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```
...
class PolicyDetailTypeDef(TypedDict):
    PolicyName: NotRequired[str],
    PolicyDocument: NotRequired[Union[str, PolicyDocumentDictTypeDef]],  # (1)
```
...
class PolicyVersionTypeDef(TypedDict):
    Document: NotRequired[Union[str, PolicyDocumentDictTypeDef]],  # (1)
...
class RoleTypeDef(TypedDict):
    ...
    Arn: str,
    CreateDate: datetime,
    AssumeRolePolicyDocument: NotRequired[Union[str, PolicyDocumentDictTypeDef]],  # (1)
    Description: NotRequired[str],
    MaxSessionDuration: NotRequired[int],
