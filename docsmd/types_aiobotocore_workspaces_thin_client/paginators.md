...
async with session.client("workspaces-thin-client") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListEnvironmentsResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [WorkSpacesThinClientClient](./client.md)
2. paginator: [ListEnvironmentsPaginator](./paginators.md#listenvironmentspaginator)
3. item: [:material-code-braces: ListEnvironmentsResponsePaginatorTypeDef](./type_defs.md#listenvironmentsresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListEnvironmentsResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListEnvironmentsResponsePaginatorTypeDef](./type_defs.md#listenvironmentsresponsepaginatortypedef) 
