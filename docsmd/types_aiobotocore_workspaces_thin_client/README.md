...
- [EmbeddedTagTypeDef](./type_defs.md#embeddedtagtypedef)
- [MaintenanceWindowPaginatorTypeDef](./type_defs.md#maintenancewindowpaginatortypedef)
...
- [EnvironmentSummaryPaginatorTypeDef](./type_defs.md#environmentsummarypaginatortypedef)
...
- [ListEnvironmentsResponsePaginatorTypeDef](./type_defs.md#listenvironmentsresponsepaginatortypedef)
