...
Type annotations and code completion for `#!python session.client("comprehend").close` method.
...
Type annotations and code completion for `#!python session.client("comprehend").create_entity_recognizer` method.
...
Type annotations and code completion for `#!python session.client("comprehend").create_flywheel` method.
...
Type annotations and code completion for `#!python session.client("comprehend").describe_document_classifier` method.
...
Type annotations and code completion for `#!python session.client("comprehend").update_endpoint` method.
...
Type annotations and code completion for `#!python session.client("comprehend").update_flywheel` method.
...
Type annotations and code completion for `#!python session.client("comprehend").__aenter__` method.
...
Type annotations and code completion for `#!python session.client("comprehend").__aexit__` method.
...
Type annotations and code completion for `#!python session.client("comprehend").get_paginator` method with overloads.
