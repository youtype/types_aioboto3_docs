...
Type annotations and code completion for `#!python session.client("firehose").close` method.
...
) -> CreateDeliveryStreamOutputTypeDef:  # (15)
    ...
```
...
15. See [:material-code-braces: CreateDeliveryStreamOutputTypeDef](./type_defs.md#createdeliverystreamoutputtypedef) 
