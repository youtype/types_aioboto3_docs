...
class FailureConditionsOutputTypeDef(TypedDict):
    result: NotRequired[ResultType],  # (1)
    conditions: NotRequired[List[ConditionOutputTypeDef]],  # (2)
```
...
1. See [:material-code-brackets: ResultType](./literals.md#resulttype) 
2. See [:material-code-braces: ConditionTypeDef](./type_defs.md#conditiontypedef) [:material-code-braces: ConditionOutputTypeDef](./type_defs.md#conditionoutputtypedef) 
