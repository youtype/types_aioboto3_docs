...
class PipelineExecutionTypeDef(TypedDict):
    ...
    trigger: NotRequired[ExecutionTriggerTypeDef],  # (3)
    variables: NotRequired[List[ResolvedPipelineVariableTypeDef]],  # (4)
```

1. See [:material-code-brackets: PipelineExecutionStatusType](./literals.md#pipelineexecutionstatustype) 
2. See [:material-code-braces: ArtifactRevisionTypeDef](./type_defs.md#artifactrevisiontypedef) 
3. See [:material-code-braces: ExecutionTriggerTypeDef](./type_defs.md#executiontriggertypedef) 
4. See [:material-code-braces: ResolvedPipelineVariableTypeDef](./type_defs.md#resolvedpipelinevariabletypedef) 
...
class PipelineDeclarationTypeDef(TypedDict):
    ...
    version: NotRequired[int],
    pipelineType: NotRequired[PipelineTypeType],  # (4)
    triggers: NotRequired[Sequence[PipelineTriggerDeclarationTypeDef]],  # (5)
...
4. See [:material-code-brackets: PipelineTypeType](./literals.md#pipelinetypetype) 
5. See [:material-code-braces: PipelineTriggerDeclarationTypeDef](./type_defs.md#pipelinetriggerdeclarationtypedef) 
