...
```python
# CodeStarconnectionsClient.exceptions type checking example
...
Type annotations and code completion for `#!python session.client("codestar-connections").create_repository_link` method.
...
Type annotations and code completion for `#!python session.client("codestar-connections").create_sync_configuration` method.
...
2. See [:material-code-braces: CreateSyncConfigurationOutputTypeDef](./type_defs.md#createsyncconfigurationoutputtypedef) 
...
Type annotations and code completion for `#!python session.client("codestar-connections").delete_repository_link` method.
...
Type annotations and code completion for `#!python session.client("codestar-connections").delete_sync_configuration` method.
...
Type annotations and code completion for `#!python session.client("codestar-connections").get_repository_link` method.
...
Type annotations and code completion for `#!python session.client("codestar-connections").get_repository_sync_status` method.
...
Type annotations and code completion for `#!python session.client("codestar-connections").get_resource_sync_status` method.
...
Type annotations and code completion for `#!python session.client("codestar-connections").get_sync_blocker_summary` method.
...
Type annotations and code completion for `#!python session.client("codestar-connections").get_sync_configuration` method.
...
Type annotations and code completion for `#!python session.client("codestar-connections").list_repository_links` method.
...
Type annotations and code completion for `#!python session.client("codestar-connections").list_repository_sync_definitions` method.
...
Type annotations and code completion for `#!python session.client("codestar-connections").list_sync_configurations` method.
...
Type annotations and code completion for `#!python session.client("codestar-connections").update_repository_link` method.
...
Type annotations and code completion for `#!python session.client("codestar-connections").update_sync_blocker` method.
...
Type annotations and code completion for `#!python session.client("codestar-connections").update_sync_configuration` method.
...
await def update_sync_configuration(
    ...
    *,
    ...
    RepositoryLinkId: str = ...,
    RoleArn: str = ...,
) -> UpdateSyncConfigurationOutputTypeDef:  # (2)
    ...
```

1. See [:material-code-brackets: SyncConfigurationTypeType](./literals.md#syncconfigurationtypetype) 
2. See [:material-code-braces: UpdateSyncConfigurationOutputTypeDef](./type_defs.md#updatesyncconfigurationoutputtypedef) 
