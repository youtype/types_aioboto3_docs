...
```python
# ResolverPaginatorTypeDef definition

class ResolverPaginatorTypeDef(TypedDict):
    ...
    responseMappingTemplate: NotRequired[str],
    kind: NotRequired[ResolverKindType],  # (1)
    pipelineConfig: NotRequired[PipelineConfigPaginatorTypeDef],  # (2)
    syncConfig: NotRequired[SyncConfigTypeDef],  # (3)
    cachingConfig: NotRequired[CachingConfigPaginatorTypeDef],  # (4)
    maxBatchSize: NotRequired[int],
    runtime: NotRequired[AppSyncRuntimeTypeDef],  # (5)
    code: NotRequired[str],
```
...
1. See [:material-code-brackets: ResolverKindType](./literals.md#resolverkindtype) 
2. See [:material-code-braces: PipelineConfigPaginatorTypeDef](./type_defs.md#pipelineconfigpaginatortypedef) 
3. See [:material-code-braces: SyncConfigTypeDef](./type_defs.md#syncconfigtypedef) 
4. See [:material-code-braces: CachingConfigPaginatorTypeDef](./type_defs.md#cachingconfigpaginatortypedef) 
5. See [:material-code-braces: AppSyncRuntimeTypeDef](./type_defs.md#appsyncruntimetypedef) 
## ResolverTypeDef
...
```python
# ListResolversByFunctionResponsePaginatorTypeDef definition

class ListResolversByFunctionResponsePaginatorTypeDef(TypedDict):
    resolvers: List[ResolverPaginatorTypeDef],  # (1)
    nextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: ResolverPaginatorTypeDef](./type_defs.md#resolverpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
## ListResolversResponsePaginatorTypeDef

```python
# ListResolversResponsePaginatorTypeDef definition

class ListResolversResponsePaginatorTypeDef(TypedDict):
    resolvers: List[ResolverPaginatorTypeDef],  # (1)
    nextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```
