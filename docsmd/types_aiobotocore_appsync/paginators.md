...
3. item: [:material-code-braces: ListResolversResponsePaginatorTypeDef](./type_defs.md#listresolversresponsepaginatortypedef) 
...
1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListResolversResponsePaginatorTypeDef](./type_defs.md#listresolversresponsepaginatortypedef) 
...
3. item: [:material-code-braces: ListResolversByFunctionResponsePaginatorTypeDef](./type_defs.md#listresolversbyfunctionresponsepaginatortypedef) 
...
1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListResolversByFunctionResponsePaginatorTypeDef](./type_defs.md#listresolversbyfunctionresponsepaginatortypedef) 
