...
Type annotations and code completion for `#!python session.client("appsync").close` method.
...
) -> CreateGraphqlApiResponseTypeDef:  # (10)
    ...
```
...
10. See [:material-code-braces: CreateGraphqlApiResponseTypeDef](./type_defs.md#creategraphqlapiresponsetypedef) 
...
Type annotations and code completion for `#!python session.client("appsync").get_function` method.
...
Type annotations and code completion for `#!python session.client("appsync").list_data_sources` method.
...
await def update_graphql_api(
    ...
    *,
    ...
    queryDepthLimit: int = ...,
    resolverCountLimit: int = ...,
) -> UpdateGraphqlApiResponseTypeDef:  # (8)
    ...
```
...
8. See [:material-code-braces: UpdateGraphqlApiResponseTypeDef](./type_defs.md#updategraphqlapiresponsetypedef) 
