...
1. See [:material-code-braces: ResourcePaginatorTypeDef](./type_defs.md#resourcepaginatortypedef) 
...
1. See [:material-code-braces: ResourceSetOutputPaginatorTypeDef](./type_defs.md#resourcesetoutputpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
