...
async with session.client("route53-recovery-readiness") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListResourceSetsResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [Route53RecoveryReadinessClient](./client.md)
2. paginator: [ListResourceSetsPaginator](./paginators.md#listresourcesetspaginator)
3. item: [:material-code-braces: ListResourceSetsResponsePaginatorTypeDef](./type_defs.md#listresourcesetsresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListResourceSetsResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListResourceSetsResponsePaginatorTypeDef](./type_defs.md#listresourcesetsresponsepaginatortypedef) 
