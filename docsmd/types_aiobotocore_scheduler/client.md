...
Type annotations and code completion for `#!python session.client("scheduler").close` method.
...
Type annotations and code completion for `#!python session.client("scheduler").tag_resource` method.
