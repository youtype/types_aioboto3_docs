...
Type annotations and code completion for  `#!python session.client("lightsail")` as [LightsailClient](./client.md)
...
from `#!python session.client("lightsail").get_paginator("...")`.
...
- [DomainEntryPaginatorTypeDef](./type_defs.md#domainentrypaginatortypedef)
...
- [DomainPaginatorTypeDef](./type_defs.md#domainpaginatortypedef)
...
- [GetDomainsResultPaginatorTypeDef](./type_defs.md#getdomainsresultpaginatortypedef)
