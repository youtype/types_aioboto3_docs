...
3. item: [:material-code-braces: GetDomainsResultPaginatorTypeDef](./type_defs.md#getdomainsresultpaginatortypedef) 
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[GetDomainsResultPaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: GetDomainsResultPaginatorTypeDef](./type_defs.md#getdomainsresultpaginatortypedef) 
