...
Type annotations and code completion for `#!python session.client("auditmanager").close` method.
...
Type annotations and code completion for `#!python session.client("auditmanager").get_evidence` method.
