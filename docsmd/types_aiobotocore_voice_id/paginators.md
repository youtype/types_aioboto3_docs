...
Type annotations and code completion for `#!python session.client("voice-id").get_paginator("list_fraudsters")`.
...
Type annotations and code completion for `#!python session.client("voice-id").get_paginator("list_watchlists")`.
