...
3. item: [:material-code-braces: DescribeProjectVersionsResponsePaginatorTypeDef](./type_defs.md#describeprojectversionsresponsepaginatortypedef) 
...
async with session.client("rekognition") as client:  # (1)
    kwargs: AssociateFacesRequestRequestTypeDef = {...}  # (2)
    result: AssociateFacesResponseTypeDef = await client.associate_faces(**kwargs)  # (3)
```

1. client: [RekognitionClient](./client.md)
2. kwargs: [:material-code-braces: AssociateFacesRequestRequestTypeDef](./type_defs.md#associatefacesrequestrequesttypedef) 
...
from types_aiobotocore_rekognition.type_defs import DescribeProjectVersionsResponsePaginatorTypeDef
