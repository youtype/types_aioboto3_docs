...
) -> AsyncIterator[DescribeProjectVersionsResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: DescribeProjectVersionsResponsePaginatorTypeDef](./type_defs.md#describeprojectversionsresponsepaginatortypedef) 
