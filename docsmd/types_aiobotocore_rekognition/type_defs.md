...
```python
# TestingDataPaginatorTypeDef definition

class TestingDataPaginatorTypeDef(TypedDict):
...
```python
# TrainingDataPaginatorTypeDef definition

class TrainingDataPaginatorTypeDef(TypedDict):
    Assets: NotRequired[List[AssetTypeDef]],  # (1)
```
...
```python
# TestingDataResultPaginatorTypeDef definition

class TestingDataResultPaginatorTypeDef(TypedDict):
    Input: NotRequired[TestingDataPaginatorTypeDef],  # (1)
    Output: NotRequired[TestingDataPaginatorTypeDef],  # (1)
    Validation: NotRequired[ValidationDataTypeDef],  # (3)
```

1. See [:material-code-braces: TestingDataPaginatorTypeDef](./type_defs.md#testingdatapaginatortypedef) 
2. See [:material-code-braces: TestingDataPaginatorTypeDef](./type_defs.md#testingdatapaginatortypedef) 
...
```python
# TrainingDataResultPaginatorTypeDef definition

class TrainingDataResultPaginatorTypeDef(TypedDict):
    Input: NotRequired[TrainingDataPaginatorTypeDef],  # (1)
    Output: NotRequired[TrainingDataPaginatorTypeDef],  # (1)
    Validation: NotRequired[ValidationDataTypeDef],  # (3)
```

1. See [:material-code-braces: TrainingDataPaginatorTypeDef](./type_defs.md#trainingdatapaginatortypedef) 
2. See [:material-code-braces: TrainingDataPaginatorTypeDef](./type_defs.md#trainingdatapaginatortypedef) 
3. See [:material-code-braces: ValidationDataTypeDef](./type_defs.md#validationdatatypedef) 
...
```python
# ProjectVersionDescriptionPaginatorTypeDef definition

class ProjectVersionDescriptionPaginatorTypeDef(TypedDict):
    ...
    TrainingDataResult: NotRequired[TrainingDataResultPaginatorTypeDef],  # (3)
    TestingDataResult: NotRequired[TestingDataResultPaginatorTypeDef],  # (4)
...
3. See [:material-code-braces: TrainingDataResultPaginatorTypeDef](./type_defs.md#trainingdataresultpaginatortypedef) 
4. See [:material-code-braces: TestingDataResultPaginatorTypeDef](./type_defs.md#testingdataresultpaginatortypedef) 
...
```python
# DescribeProjectVersionsResponsePaginatorTypeDef definition

class DescribeProjectVersionsResponsePaginatorTypeDef(TypedDict):
    ProjectVersionDescriptions: List[ProjectVersionDescriptionPaginatorTypeDef],  # (1)
    NextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: ProjectVersionDescriptionPaginatorTypeDef](./type_defs.md#projectversiondescriptionpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
