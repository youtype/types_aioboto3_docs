...
Install `types-aioboto3` for `Glue` service.

```bash
# install with aioboto3 type annotations
python -m pip install 'types-aioboto3[glue]'


# Lite version does not provide session.client/resource overloads
# it is more RAM-friendly, but requires explicit type annotations
python -m pip install 'types-aioboto3-lite[glue]'
...
Type annotations and code completion for  `#!python session.client("glue")` as [GlueClient](./client.md)
...
from `#!python session.client("glue").get_paginator("...")`.
...
- [PartitionValueListPaginatorTypeDef](./type_defs.md#partitionvaluelistpaginatortypedef)
...
- [ColumnPaginatorTypeDef](./type_defs.md#columnpaginatortypedef)
...
- [PhysicalConnectionRequirementsPaginatorTypeDef](./type_defs.md#physicalconnectionrequirementspaginatortypedef)
...
- [SerDeInfoPaginatorTypeDef](./type_defs.md#serdeinfopaginatortypedef)
- [SerDeInfoTypeDef](./type_defs.md#serdeinfotypedef)
- [SkewedInfoPaginatorTypeDef](./type_defs.md#skewedinfopaginatortypedef)
...
- [BackfillErrorPaginatorTypeDef](./type_defs.md#backfillerrorpaginatortypedef)
...
- [ConnectionPaginatorTypeDef](./type_defs.md#connectionpaginatortypedef)
...
- [PrincipalPermissionsPaginatorTypeDef](./type_defs.md#principalpermissionspaginatortypedef)
...
- [EncryptionConfigurationPaginatorTypeDef](./type_defs.md#encryptionconfigurationpaginatortypedef)
...
- [PartitionIndexDescriptorPaginatorTypeDef](./type_defs.md#partitionindexdescriptorpaginatortypedef)
...
- [GetConnectionsResponsePaginatorTypeDef](./type_defs.md#getconnectionsresponsepaginatortypedef)
...
- [DatabasePaginatorTypeDef](./type_defs.md#databasepaginatortypedef)
...
- [StorageDescriptorPaginatorTypeDef](./type_defs.md#storagedescriptorpaginatortypedef)
- [StorageDescriptorTypeDef](./type_defs.md#storagedescriptortypedef)
- [SecurityConfigurationPaginatorTypeDef](./type_defs.md#securityconfigurationpaginatortypedef)
...
- [GetPartitionIndexesResponsePaginatorTypeDef](./type_defs.md#getpartitionindexesresponsepaginatortypedef)
...
- [GetDatabasesResponsePaginatorTypeDef](./type_defs.md#getdatabasesresponsepaginatortypedef)
...
- [PartitionPaginatorTypeDef](./type_defs.md#partitionpaginatortypedef)
...
- [GetSecurityConfigurationsResponsePaginatorTypeDef](./type_defs.md#getsecurityconfigurationsresponsepaginatortypedef)
...
- [GetPartitionsResponsePaginatorTypeDef](./type_defs.md#getpartitionsresponsepaginatortypedef)
