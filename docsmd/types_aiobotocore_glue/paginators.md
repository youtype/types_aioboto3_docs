...
async with session.client("glue") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: GetConnectionsResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [GlueClient](./client.md)
2. paginator: [GetConnectionsPaginator](./paginators.md#getconnectionspaginator)
3. item: [:material-code-braces: GetConnectionsResponsePaginatorTypeDef](./type_defs.md#getconnectionsresponsepaginatortypedef) 
...
) -> AsyncIterator[GetConnectionsResponsePaginatorTypeDef]:  # (3)
    ...
```

1. See [:material-code-braces: GetConnectionsFilterTypeDef](./type_defs.md#getconnectionsfiltertypedef) 
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
3. See [:material-code-braces: GetConnectionsResponsePaginatorTypeDef](./type_defs.md#getconnectionsresponsepaginatortypedef) 
...
async with session.client("glue") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: GetDatabasesResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [GlueClient](./client.md)
2. paginator: [GetDatabasesPaginator](./paginators.md#getdatabasespaginator)
3. item: [:material-code-braces: GetDatabasesResponsePaginatorTypeDef](./type_defs.md#getdatabasesresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[GetDatabasesResponsePaginatorTypeDef]:  # (3)
    ...
```

1. See [:material-code-brackets: ResourceShareTypeType](./literals.md#resourcesharetypetype) 
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
3. See [:material-code-braces: GetDatabasesResponsePaginatorTypeDef](./type_defs.md#getdatabasesresponsepaginatortypedef) 
...
async with session.client("glue") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: GetPartitionIndexesResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [GlueClient](./client.md)
2. paginator: [GetPartitionIndexesPaginator](./paginators.md#getpartitionindexespaginator)
3. item: [:material-code-braces: GetPartitionIndexesResponsePaginatorTypeDef](./type_defs.md#getpartitionindexesresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    CatalogId: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[GetPartitionIndexesResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: GetPartitionIndexesResponsePaginatorTypeDef](./type_defs.md#getpartitionindexesresponsepaginatortypedef) 
...
async with session.client("glue") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: GetPartitionsResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [GlueClient](./client.md)
2. paginator: [GetPartitionsPaginator](./paginators.md#getpartitionspaginator)
3. item: [:material-code-braces: GetPartitionsResponsePaginatorTypeDef](./type_defs.md#getpartitionsresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[GetPartitionsResponsePaginatorTypeDef]:  # (3)
    ...
```

1. See [:material-code-braces: SegmentTypeDef](./type_defs.md#segmenttypedef) 
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
3. See [:material-code-braces: GetPartitionsResponsePaginatorTypeDef](./type_defs.md#getpartitionsresponsepaginatortypedef) 
...
async with session.client("glue") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: GetSecurityConfigurationsResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [GlueClient](./client.md)
2. paginator: [GetSecurityConfigurationsPaginator](./paginators.md#getsecurityconfigurationspaginator)
3. item: [:material-code-braces: GetSecurityConfigurationsResponsePaginatorTypeDef](./type_defs.md#getsecurityconfigurationsresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[GetSecurityConfigurationsResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: GetSecurityConfigurationsResponsePaginatorTypeDef](./type_defs.md#getsecurityconfigurationsresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    QueryAsOfTime: Union[datetime, str] = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[GetTablesResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: GetTablesResponsePaginatorTypeDef](./type_defs.md#gettablesresponsepaginatortypedef) 
