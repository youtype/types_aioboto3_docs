...
```python
# SamplingRulePaginatorTypeDef definition

class SamplingRulePaginatorTypeDef(TypedDict):
    ResourceARN: str,
    Priority: int,
    FixedRate: float,
    ReservoirSize: int,
...
```python
# SamplingRuleRecordPaginatorTypeDef definition

class SamplingRuleRecordPaginatorTypeDef(TypedDict):
    SamplingRule: NotRequired[SamplingRulePaginatorTypeDef],  # (1)
    CreatedAt: NotRequired[datetime],
    ModifiedAt: NotRequired[datetime],
```

1. See [:material-code-braces: SamplingRulePaginatorTypeDef](./type_defs.md#samplingrulepaginatortypedef) 
...
```python
# GetSamplingRulesResultPaginatorTypeDef definition

class GetSamplingRulesResultPaginatorTypeDef(TypedDict):
    SamplingRuleRecords: List[SamplingRuleRecordPaginatorTypeDef],  # (1)
    NextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: SamplingRuleRecordPaginatorTypeDef](./type_defs.md#samplingrulerecordpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
