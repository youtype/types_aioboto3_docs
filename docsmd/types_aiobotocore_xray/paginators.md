...
async with session.client("xray") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: GetSamplingRulesResultPaginatorTypeDef
        print(item)  # (3)
```

1. client: [XRayClient](./client.md)
2. paginator: [GetSamplingRulesPaginator](./paginators.md#getsamplingrulespaginator)
3. item: [:material-code-braces: GetSamplingRulesResultPaginatorTypeDef](./type_defs.md#getsamplingrulesresultpaginatortypedef) 
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[GetSamplingRulesResultPaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: GetSamplingRulesResultPaginatorTypeDef](./type_defs.md#getsamplingrulesresultpaginatortypedef) 
