...
async with session.client("personalize") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListRecommendersResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [PersonalizeClient](./client.md)
2. paginator: [ListRecommendersPaginator](./paginators.md#listrecommenderspaginator)
3. item: [:material-code-braces: ListRecommendersResponsePaginatorTypeDef](./type_defs.md#listrecommendersresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    datasetGroupArn: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListRecommendersResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListRecommendersResponsePaginatorTypeDef](./type_defs.md#listrecommendersresponsepaginatortypedef) 
