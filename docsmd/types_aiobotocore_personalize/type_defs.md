...
```python
# TrainingDataConfigPaginatorTypeDef definition

class TrainingDataConfigPaginatorTypeDef(TypedDict):
...
```python
# RecommenderConfigPaginatorTypeDef definition

class RecommenderConfigPaginatorTypeDef(TypedDict):
    itemExplorationConfig: NotRequired[Dict[str, str]],
    minRecommendationRequestsPerSecond: NotRequired[int],
    trainingDataConfig: NotRequired[TrainingDataConfigPaginatorTypeDef],  # (1)
    enableMetadataWithRecommendations: NotRequired[bool],
```

1. See [:material-code-braces: TrainingDataConfigPaginatorTypeDef](./type_defs.md#trainingdataconfigpaginatortypedef) 
...
```python
# RecommenderSummaryPaginatorTypeDef definition

class RecommenderSummaryPaginatorTypeDef(TypedDict):
    name: NotRequired[str],
    recommenderArn: NotRequired[str],
    datasetGroupArn: NotRequired[str],
    recipeArn: NotRequired[str],
    recommenderConfig: NotRequired[RecommenderConfigPaginatorTypeDef],  # (1)
    status: NotRequired[str],
    creationDateTime: NotRequired[datetime],
    lastUpdatedDateTime: NotRequired[datetime],
```

1. See [:material-code-braces: RecommenderConfigPaginatorTypeDef](./type_defs.md#recommenderconfigpaginatortypedef) 
...
```python
# ListRecommendersResponsePaginatorTypeDef definition

class ListRecommendersResponsePaginatorTypeDef(TypedDict):
    recommenders: List[RecommenderSummaryPaginatorTypeDef],  # (1)
    nextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: RecommenderSummaryPaginatorTypeDef](./type_defs.md#recommendersummarypaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
