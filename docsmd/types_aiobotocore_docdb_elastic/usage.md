...
async with session.client("docdb-elastic") as client:  # (1)
    kwargs: CopyClusterSnapshotInputRequestTypeDef = {...}  # (2)
    result: CopyClusterSnapshotOutputTypeDef = await client.copy_cluster_snapshot(**kwargs)  # (3)
```

1. client: [DocDBElasticClient](./client.md)
2. kwargs: [:material-code-braces: CopyClusterSnapshotInputRequestTypeDef](./type_defs.md#copyclustersnapshotinputrequesttypedef) 
3. result: [:material-code-braces: CopyClusterSnapshotOutputTypeDef](./type_defs.md#copyclustersnapshotoutputtypedef) 
