...
async with session.client("docdb-elastic") as client:  # (1)
    kwargs: ApplyPendingMaintenanceActionInputRequestTypeDef = {...}  # (2)
    result: ApplyPendingMaintenanceActionOutputTypeDef = await client.apply_pending_maintenance_action(**kwargs)  # (3)
```

1. client: [DocDBElasticClient](./client.md)
2. kwargs: [:material-code-braces: ApplyPendingMaintenanceActionInputRequestTypeDef](./type_defs.md#applypendingmaintenanceactioninputrequesttypedef) 
