...
async with session.client("lexv2-models") as client:  # (1)
    kwargs: BatchCreateCustomVocabularyItemRequestRequestTypeDef = {...}  # (2)
    result: BatchCreateCustomVocabularyItemResponseTypeDef = await client.batch_create_custom_vocabulary_item(**kwargs)  # (3)
```

1. client: [LexModelsV2Client](./client.md)
2. kwargs: [:material-code-braces: BatchCreateCustomVocabularyItemRequestRequestTypeDef](./type_defs.md#batchcreatecustomvocabularyitemrequestrequesttypedef) 
