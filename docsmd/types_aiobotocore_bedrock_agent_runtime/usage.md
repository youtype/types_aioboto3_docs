...
async with session.client("bedrock-agent-runtime") as client:  # (1)
    kwargs: GetAgentMemoryRequestRequestTypeDef = {...}  # (2)
    result: GetAgentMemoryResponseTypeDef = await client.get_agent_memory(**kwargs)  # (3)
```

1. client: [AgentsforBedrockRuntimeClient](./client.md)
2. kwargs: [:material-code-braces: GetAgentMemoryRequestRequestTypeDef](./type_defs.md#getagentmemoryrequestrequesttypedef) 
3. result: [:material-code-braces: GetAgentMemoryResponseTypeDef](./type_defs.md#getagentmemoryresponsetypedef) 
