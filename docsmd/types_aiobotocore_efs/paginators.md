...
Type annotations and code completion for `#!python session.client("efs").get_paginator("describe_access_points")`.
...
async with session.client("efs") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: DescribeAccessPointsResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [EFSClient](./client.md)
2. paginator: [DescribeAccessPointsPaginator](./paginators.md#describeaccesspointspaginator)
3. item: [:material-code-braces: DescribeAccessPointsResponsePaginatorTypeDef](./type_defs.md#describeaccesspointsresponsepaginatortypedef) 
...
) -> AsyncIterator[DescribeAccessPointsResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: DescribeAccessPointsResponsePaginatorTypeDef](./type_defs.md#describeaccesspointsresponsepaginatortypedef) 
...
Type annotations and code completion for `#!python session.client("efs").get_paginator("describe_replication_configurations")`.
