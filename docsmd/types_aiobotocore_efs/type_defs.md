...
```python
# PosixUserPaginatorTypeDef definition

class PosixUserPaginatorTypeDef(TypedDict):
    Uid: int,
    Gid: int,
...
1. See [:material-code-braces: LifecyclePolicyTypeDef](./type_defs.md#lifecyclepolicytypedef) 
## AccessPointDescriptionPaginatorTypeDef

```python
# AccessPointDescriptionPaginatorTypeDef definition

class AccessPointDescriptionPaginatorTypeDef(TypedDict):
    ...
    FileSystemId: NotRequired[str],
    PosixUser: NotRequired[PosixUserPaginatorTypeDef],  # (2)
...
1. See [:material-code-braces: TagTypeDef](./type_defs.md#tagtypedef) 
2. See [:material-code-braces: PosixUserPaginatorTypeDef](./type_defs.md#posixuserpaginatortypedef) 
...
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
## DescribeAccessPointsResponsePaginatorTypeDef

```python
# DescribeAccessPointsResponsePaginatorTypeDef definition

class DescribeAccessPointsResponsePaginatorTypeDef(TypedDict):
    AccessPoints: List[AccessPointDescriptionPaginatorTypeDef],  # (1)
    NextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: AccessPointDescriptionPaginatorTypeDef](./type_defs.md#accesspointdescriptionpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
