...
async with session.client("appstream") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: DescribeFleetsResultPaginatorTypeDef
        print(item)  # (3)
```

1. client: [AppStreamClient](./client.md)
2. paginator: [DescribeFleetsPaginator](./paginators.md#describefleetspaginator)
3. item: [:material-code-braces: DescribeFleetsResultPaginatorTypeDef](./type_defs.md#describefleetsresultpaginatortypedef) 
...
def paginate(
    ...
    *,
    Names: Sequence[str] = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[DescribeFleetsResultPaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: DescribeFleetsResultPaginatorTypeDef](./type_defs.md#describefleetsresultpaginatortypedef) 
...
async with session.client("appstream") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: DescribeImageBuildersResultPaginatorTypeDef
        print(item)  # (3)
```

1. client: [AppStreamClient](./client.md)
2. paginator: [DescribeImageBuildersPaginator](./paginators.md#describeimagebuilderspaginator)
3. item: [:material-code-braces: DescribeImageBuildersResultPaginatorTypeDef](./type_defs.md#describeimagebuildersresultpaginatortypedef) 
...
def paginate(
    ...
    *,
    Names: Sequence[str] = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[DescribeImageBuildersResultPaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: DescribeImageBuildersResultPaginatorTypeDef](./type_defs.md#describeimagebuildersresultpaginatortypedef) 
...
async with session.client("appstream") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: DescribeStacksResultPaginatorTypeDef
        print(item)  # (3)
```

1. client: [AppStreamClient](./client.md)
2. paginator: [DescribeStacksPaginator](./paginators.md#describestackspaginator)
3. item: [:material-code-braces: DescribeStacksResultPaginatorTypeDef](./type_defs.md#describestacksresultpaginatortypedef) 
...
def paginate(
    ...
    *,
    Names: Sequence[str] = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[DescribeStacksResultPaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: DescribeStacksResultPaginatorTypeDef](./type_defs.md#describestacksresultpaginatortypedef) 
