...
1. See [:material-code-braces: AdvancedBackupSettingPaginatorTypeDef](./type_defs.md#advancedbackupsettingpaginatortypedef) 
...
1. See [:material-code-braces: BackupPlansListMemberPaginatorTypeDef](./type_defs.md#backupplanslistmemberpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
