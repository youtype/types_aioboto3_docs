...
async with session.client("backup") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListBackupPlanVersionsOutputPaginatorTypeDef
        print(item)  # (3)
```

1. client: [BackupClient](./client.md)
2. paginator: [ListBackupPlanVersionsPaginator](./paginators.md#listbackupplanversionspaginator)
3. item: [:material-code-braces: ListBackupPlanVersionsOutputPaginatorTypeDef](./type_defs.md#listbackupplanversionsoutputpaginatortypedef) 
...
def paginate(
    ...
    *,
    BackupPlanId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListBackupPlanVersionsOutputPaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListBackupPlanVersionsOutputPaginatorTypeDef](./type_defs.md#listbackupplanversionsoutputpaginatortypedef) 
...
async with session.client("backup") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListBackupPlansOutputPaginatorTypeDef
        print(item)  # (3)
```

1. client: [BackupClient](./client.md)
2. paginator: [ListBackupPlansPaginator](./paginators.md#listbackupplanspaginator)
3. item: [:material-code-braces: ListBackupPlansOutputPaginatorTypeDef](./type_defs.md#listbackupplansoutputpaginatortypedef) 
...
def paginate(
    ...
    *,
    IncludeDeleted: bool = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListBackupPlansOutputPaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListBackupPlansOutputPaginatorTypeDef](./type_defs.md#listbackupplansoutputpaginatortypedef) 
...
Type annotations and code completion for `#!python session.client("backup").get_paginator("list_restore_testing_selections")`.
