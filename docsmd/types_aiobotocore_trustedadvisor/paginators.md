...
) -> AsyncIterator[ListOrganizationRecommendationResourcesResponseTypeDef]:  # (3)
    ...
```
...
Type annotations and code completion for `#!python session.client("trustedadvisor").get_paginator("list_recommendation_resources")`.
...
def paginate(
    ...
    *,
    ...
    status: ResourceStatusType = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[ListRecommendationResourcesResponseTypeDef]:  # (3)
    ...
```
