...
async with session.client("trustedadvisor") as client:  # (1)
    kwargs: BatchUpdateRecommendationResourceExclusionRequestRequestTypeDef = {...}  # (2)
...
1. client: [TrustedAdvisorPublicAPIClient](./client.md)
2. kwargs: [:material-code-braces: BatchUpdateRecommendationResourceExclusionRequestRequestTypeDef](./type_defs.md#batchupdaterecommendationresourceexclusionrequestrequesttypedef) 
