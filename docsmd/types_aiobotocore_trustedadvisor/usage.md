...
2. result: [:material-code-braces: GetOrganizationRecommendationResponseTypeDef](./type_defs.md#getorganizationrecommendationresponsetypedef) 
...
1. client: [TrustedAdvisorPublicAPIClient](./client.md)
2. kwargs: [:material-code-braces: GetOrganizationRecommendationRequestRequestTypeDef](./type_defs.md#getorganizationrecommendationrequestrequesttypedef) 
3. result: [:material-code-braces: GetOrganizationRecommendationResponseTypeDef](./type_defs.md#getorganizationrecommendationresponsetypedef) 
