...
Install `types-aioboto3` for `IoTRoboRunner` service.

```bash
# install with aioboto3 type annotations
python -m pip install 'types-aioboto3[iot-roborunner]'


# Lite version does not provide session.client/resource overloads
# it is more RAM-friendly, but requires explicit type annotations
python -m pip install 'types-aioboto3-lite[iot-roborunner]'
...
Type annotations and code completion for  `#!python session.client("iot-roborunner")` as [IoTRoboRunnerClient](./client.md)
...
from `#!python session.client("iot-roborunner").get_paginator("...")`.
