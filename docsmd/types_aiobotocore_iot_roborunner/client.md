...
Type annotations and code completion for `#!python session.client("iot-roborunner")`
...
session = Session()
async with session.client("iot-roborunner") as client:
...
This class provides code completion for `#!python session.client("iot-roborunner").exceptions` structure.
...
```python
# IoTRoboRunnerClient.exceptions type checking example
...
Type annotations and code completion for `#!python session.client("iot-roborunner").can_paginate` method.
...
Type annotations and code completion for `#!python session.client("iot-roborunner").close` method.
...
Type annotations and code completion for `#!python session.client("iot-roborunner").create_destination` method.
...
Type annotations and code completion for `#!python session.client("iot-roborunner").create_site` method.
...
Type annotations and code completion for `#!python session.client("iot-roborunner").create_worker` method.
...
Type annotations and code completion for `#!python session.client("iot-roborunner").create_worker_fleet` method.
...
Type annotations and code completion for `#!python session.client("iot-roborunner").delete_destination` method.
...
Type annotations and code completion for `#!python session.client("iot-roborunner").delete_site` method.
...
Type annotations and code completion for `#!python session.client("iot-roborunner").delete_worker` method.
...
Type annotations and code completion for `#!python session.client("iot-roborunner").delete_worker_fleet` method.
...
Type annotations and code completion for `#!python session.client("iot-roborunner").generate_presigned_url` method.
...
Type annotations and code completion for `#!python session.client("iot-roborunner").get_destination` method.
...
Type annotations and code completion for `#!python session.client("iot-roborunner").get_site` method.
...
Type annotations and code completion for `#!python session.client("iot-roborunner").get_worker` method.
...
Type annotations and code completion for `#!python session.client("iot-roborunner").get_worker_fleet` method.
...
Type annotations and code completion for `#!python session.client("iot-roborunner").list_destinations` method.
...
Type annotations and code completion for `#!python session.client("iot-roborunner").list_sites` method.
...
Type annotations and code completion for `#!python session.client("iot-roborunner").list_worker_fleets` method.
...
Type annotations and code completion for `#!python session.client("iot-roborunner").list_workers` method.
...
Type annotations and code completion for `#!python session.client("iot-roborunner").update_destination` method.
...
Type annotations and code completion for `#!python session.client("iot-roborunner").update_site` method.
...
Type annotations and code completion for `#!python session.client("iot-roborunner").update_worker` method.
...
Type annotations and code completion for `#!python session.client("iot-roborunner").update_worker_fleet` method.
...
Type annotations and code completion for `#!python session.client("iot-roborunner").__aenter__` method.
...
Type annotations and code completion for `#!python session.client("iot-roborunner").__aexit__` method.
...
Type annotations and code completion for `#!python session.client("iot-roborunner").get_paginator` method with overloads.
