...
async with session.client("mediapackage-vod") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListPackagingConfigurationsResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [MediaPackageVodClient](./client.md)
2. paginator: [ListPackagingConfigurationsPaginator](./paginators.md#listpackagingconfigurationspaginator)
3. item: [:material-code-braces: ListPackagingConfigurationsResponsePaginatorTypeDef](./type_defs.md#listpackagingconfigurationsresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    PackagingGroupId: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListPackagingConfigurationsResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListPackagingConfigurationsResponsePaginatorTypeDef](./type_defs.md#listpackagingconfigurationsresponsepaginatortypedef) 
