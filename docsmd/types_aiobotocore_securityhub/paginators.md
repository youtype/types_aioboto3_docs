...
3. item: [:material-code-braces: GetFindingsResponsePaginatorTypeDef](./type_defs.md#getfindingsresponsepaginatortypedef) 
...
) -> AsyncIterator[GetFindingsResponsePaginatorTypeDef]:  # (4)
    ...
```
...
4. See [:material-code-braces: GetFindingsResponsePaginatorTypeDef](./type_defs.md#getfindingsresponsepaginatortypedef) 
