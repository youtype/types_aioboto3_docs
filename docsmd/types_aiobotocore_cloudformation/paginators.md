...
async with session.client("cloudformation") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: DescribeChangeSetOutputPaginatorTypeDef
        print(item)  # (3)
```

1. client: [CloudFormationClient](./client.md)
2. paginator: [DescribeChangeSetPaginator](./paginators.md#describechangesetpaginator)
3. item: [:material-code-braces: DescribeChangeSetOutputPaginatorTypeDef](./type_defs.md#describechangesetoutputpaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    StackName: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[DescribeChangeSetOutputPaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: DescribeChangeSetOutputPaginatorTypeDef](./type_defs.md#describechangesetoutputpaginatortypedef) 
...
async with session.client("cloudformation") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: DescribeStacksOutputPaginatorTypeDef
        print(item)  # (3)
```

1. client: [CloudFormationClient](./client.md)
2. paginator: [DescribeStacksPaginator](./paginators.md#describestackspaginator)
3. item: [:material-code-braces: DescribeStacksOutputPaginatorTypeDef](./type_defs.md#describestacksoutputpaginatortypedef) 
...
def paginate(
    ...
    *,
    StackName: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[DescribeStacksOutputPaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: DescribeStacksOutputPaginatorTypeDef](./type_defs.md#describestacksoutputpaginatortypedef) 
...
async with session.client("cloudformation") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListStackSetOperationsOutputPaginatorTypeDef
        print(item)  # (3)
```

1. client: [CloudFormationClient](./client.md)
2. paginator: [ListStackSetOperationsPaginator](./paginators.md#liststacksetoperationspaginator)
3. item: [:material-code-braces: ListStackSetOperationsOutputPaginatorTypeDef](./type_defs.md#liststacksetoperationsoutputpaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    CallAs: CallAsType = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[ListStackSetOperationsOutputPaginatorTypeDef]:  # (3)
    ...
```

1. See [:material-code-brackets: CallAsType](./literals.md#callastype) 
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
3. See [:material-code-braces: ListStackSetOperationsOutputPaginatorTypeDef](./type_defs.md#liststacksetoperationsoutputpaginatortypedef) 
