...
async with session.client("location") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListGeofencesResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [LocationServiceClient](./client.md)
2. paginator: [ListGeofencesPaginator](./paginators.md#listgeofencespaginator)
3. item: [:material-code-braces: ListGeofencesResponsePaginatorTypeDef](./type_defs.md#listgeofencesresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    CollectionName: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListGeofencesResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListGeofencesResponsePaginatorTypeDef](./type_defs.md#listgeofencesresponsepaginatortypedef) 
...
async with session.client("location") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListKeysResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [LocationServiceClient](./client.md)
2. paginator: [ListKeysPaginator](./paginators.md#listkeyspaginator)
3. item: [:material-code-braces: ListKeysResponsePaginatorTypeDef](./type_defs.md#listkeysresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[ListKeysResponsePaginatorTypeDef]:  # (3)
    ...
```

1. See [:material-code-braces: ApiKeyFilterTypeDef](./type_defs.md#apikeyfiltertypedef) 
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
3. See [:material-code-braces: ListKeysResponsePaginatorTypeDef](./type_defs.md#listkeysresponsepaginatortypedef) 
