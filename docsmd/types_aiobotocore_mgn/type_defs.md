...
```python
# SsmDocumentPaginatorTypeDef definition

class SsmDocumentPaginatorTypeDef(TypedDict):
    actionName: str,
    ssmDocumentName: str,
...
```python
# JobPostLaunchActionsLaunchStatusPaginatorTypeDef definition

class JobPostLaunchActionsLaunchStatusPaginatorTypeDef(TypedDict):
    executionID: NotRequired[str],
    executionStatus: NotRequired[PostLaunchActionExecutionStatusType],  # (1)
    failureReason: NotRequired[str],
    ssmDocument: NotRequired[SsmDocumentPaginatorTypeDef],  # (2)
...
2. See [:material-code-braces: SsmDocumentPaginatorTypeDef](./type_defs.md#ssmdocumentpaginatortypedef) 
3. See [:material-code-brackets: SsmDocumentTypeType](./literals.md#ssmdocumenttypetype) 
## PostLaunchActionsPaginatorTypeDef

```python
# PostLaunchActionsPaginatorTypeDef definition

class PostLaunchActionsPaginatorTypeDef(TypedDict):
    cloudWatchLogGroupName: NotRequired[str],
    deployment: NotRequired[PostLaunchActionsDeploymentTypeType],  # (1)
    s3LogBucket: NotRequired[str],
    s3OutputKeyPrefix: NotRequired[str],
    ssmDocuments: NotRequired[List[SsmDocumentPaginatorTypeDef]],  # (2)
```
...
```python
# PostLaunchActionsStatusPaginatorTypeDef definition

class PostLaunchActionsStatusPaginatorTypeDef(TypedDict):
    postLaunchActionsLaunchStatusList: NotRequired[List[JobPostLaunchActionsLaunchStatusPaginatorTypeDef]],  # (1)
    ssmAgentDiscoveryDatetime: NotRequired[str],
```

1. See [:material-code-braces: JobPostLaunchActionsLaunchStatusPaginatorTypeDef](./type_defs.md#jobpostlaunchactionslaunchstatuspaginatortypedef) 
## LaunchConfigurationTemplatePaginatorTypeDef

```python
# LaunchConfigurationTemplatePaginatorTypeDef definition

class LaunchConfigurationTemplatePaginatorTypeDef(TypedDict):
    launchConfigurationTemplateID: str,
    arn: NotRequired[str],
    ...
    postLaunchActions: NotRequired[PostLaunchActionsPaginatorTypeDef],  # (5)
...
5. See [:material-code-braces: PostLaunchActionsPaginatorTypeDef](./type_defs.md#postlaunchactionspaginatortypedef) 
...
```python
# ParticipatingServerPaginatorTypeDef definition

class ParticipatingServerPaginatorTypeDef(TypedDict):
    sourceServerID: str,
    launchStatus: NotRequired[LaunchStatusType],  # (1)
    launchedEc2InstanceID: NotRequired[str],
    postLaunchActionsStatus: NotRequired[PostLaunchActionsStatusPaginatorTypeDef],  # (2)
```

1. See [:material-code-brackets: LaunchStatusType](./literals.md#launchstatustype) 
2. See [:material-code-braces: PostLaunchActionsStatusPaginatorTypeDef](./type_defs.md#postlaunchactionsstatuspaginatortypedef) 
## DescribeLaunchConfigurationTemplatesResponsePaginatorTypeDef

```python
# DescribeLaunchConfigurationTemplatesResponsePaginatorTypeDef definition

class DescribeLaunchConfigurationTemplatesResponsePaginatorTypeDef(TypedDict):
    items: List[LaunchConfigurationTemplatePaginatorTypeDef],  # (1)
    nextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: LaunchConfigurationTemplatePaginatorTypeDef](./type_defs.md#launchconfigurationtemplatepaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
class JobPaginatorTypeDef(TypedDict):
    ...
    participatingServers: NotRequired[List[ParticipatingServerPaginatorTypeDef]],  # (2)
...
2. See [:material-code-braces: ParticipatingServerPaginatorTypeDef](./type_defs.md#participatingserverpaginatortypedef) 
...
```python
# DescribeJobsResponsePaginatorTypeDef definition

class DescribeJobsResponsePaginatorTypeDef(TypedDict):
    items: List[JobPaginatorTypeDef],  # (1)
    nextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```
