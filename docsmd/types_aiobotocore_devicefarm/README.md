...
Type annotations and code completion for  `#!python session.client("devicefarm")` as [DeviceFarmClient](./client.md)
...
- [CustomerArtifactPathsPaginatorTypeDef](./type_defs.md#customerartifactpathspaginatortypedef)
...
- [DeviceFilterPaginatorTypeDef](./type_defs.md#devicefilterpaginatortypedef)
...
- [DeviceSelectionResultPaginatorTypeDef](./type_defs.md#deviceselectionresultpaginatortypedef)
...
- [ProjectPaginatorTypeDef](./type_defs.md#projectpaginatortypedef)
...
- [RunPaginatorTypeDef](./type_defs.md#runpaginatortypedef)
...
- [ListProjectsResultPaginatorTypeDef](./type_defs.md#listprojectsresultpaginatortypedef)
...
- [RemoteAccessSessionPaginatorTypeDef](./type_defs.md#remoteaccesssessionpaginatortypedef)
- [RemoteAccessSessionTypeDef](./type_defs.md#remoteaccesssessiontypedef)
- [ListRunsResultPaginatorTypeDef](./type_defs.md#listrunsresultpaginatortypedef)
...
- [ListRemoteAccessSessionsResultPaginatorTypeDef](./type_defs.md#listremoteaccesssessionsresultpaginatortypedef)
