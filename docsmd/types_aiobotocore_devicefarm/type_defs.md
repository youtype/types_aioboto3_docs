...
1. See [:material-code-braces: VPCEConfigurationTypeDef](./type_defs.md#vpceconfigurationtypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
## DeviceSelectionResultPaginatorTypeDef

```python
# DeviceSelectionResultPaginatorTypeDef definition

class DeviceSelectionResultPaginatorTypeDef(TypedDict):
    filters: NotRequired[List[DeviceFilterPaginatorTypeDef]],  # (1)
    matchedDevicesCount: NotRequired[int],
    maxDevices: NotRequired[int],
```

1. See [:material-code-braces: DeviceFilterPaginatorTypeDef](./type_defs.md#devicefilterpaginatortypedef) 
...
class ListDevicesRequestListDevicesPaginateTypeDef(TypedDict):
    arn: NotRequired[str],
    filters: NotRequired[Sequence[DeviceFilterPaginatorTypeDef]],  # (1)
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (2)
```
...
```python
# RunPaginatorTypeDef definition

class RunPaginatorTypeDef(TypedDict):
    arn: NotRequired[str],
    name: NotRequired[str],
    type: NotRequired[TestTypeType],  # (1)
    platform: NotRequired[DevicePlatformType],  # (2)
    ...
    customerArtifactPaths: NotRequired[CustomerArtifactPathsPaginatorTypeDef],  # (12)
    webUrl: NotRequired[str],
    skipAppResign: NotRequired[bool],
    testSpecArn: NotRequired[str],
    deviceSelectionResult: NotRequired[DeviceSelectionResultPaginatorTypeDef],  # (13)
    vpcConfig: NotRequired[VpcConfigPaginatorTypeDef],  # (14)
```
...
12. See [:material-code-braces: CustomerArtifactPathsPaginatorTypeDef](./type_defs.md#customerartifactpathspaginatortypedef) 
13. See [:material-code-braces: DeviceSelectionResultPaginatorTypeDef](./type_defs.md#deviceselectionresultpaginatortypedef) 
14. See [:material-code-braces: VpcConfigPaginatorTypeDef](./type_defs.md#vpcconfigpaginatortypedef) 
## RunTypeDef
...
## ListProjectsResultPaginatorTypeDef

```python
# ListProjectsResultPaginatorTypeDef definition

class ListProjectsResultPaginatorTypeDef(TypedDict):
    projects: List[ProjectPaginatorTypeDef],  # (1)
    nextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: ProjectPaginatorTypeDef](./type_defs.md#projectpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
## RemoteAccessSessionPaginatorTypeDef

```python
# RemoteAccessSessionPaginatorTypeDef definition

class RemoteAccessSessionPaginatorTypeDef(TypedDict):
    arn: NotRequired[str],
    name: NotRequired[str],
    created: NotRequired[datetime],
    ...
    skipAppResign: NotRequired[bool],
    vpcConfig: NotRequired[VpcConfigPaginatorTypeDef],  # (7)
```
...
7. See [:material-code-braces: VpcConfigPaginatorTypeDef](./type_defs.md#vpcconfigpaginatortypedef) 
...
## ListRunsResultPaginatorTypeDef

```python
# ListRunsResultPaginatorTypeDef definition

class ListRunsResultPaginatorTypeDef(TypedDict):
    runs: List[RunPaginatorTypeDef],  # (1)
    nextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: RunPaginatorTypeDef](./type_defs.md#runpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
## GetRunResultTypeDef
...
## ListRemoteAccessSessionsResultPaginatorTypeDef

```python
# ListRemoteAccessSessionsResultPaginatorTypeDef definition

class ListRemoteAccessSessionsResultPaginatorTypeDef(TypedDict):
    remoteAccessSessions: List[RemoteAccessSessionPaginatorTypeDef],  # (1)
    nextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: RemoteAccessSessionPaginatorTypeDef](./type_defs.md#remoteaccesssessionpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
