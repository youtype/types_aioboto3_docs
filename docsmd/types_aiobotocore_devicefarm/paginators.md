...
def paginate(
    ...
    *,
    arn: str = ...,
    filters: Sequence[DeviceFilterPaginatorTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
...
async with session.client("devicefarm") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListProjectsResultPaginatorTypeDef
        print(item)  # (3)
```

1. client: [DeviceFarmClient](./client.md)
2. paginator: [ListProjectsPaginator](./paginators.md#listprojectspaginator)
3. item: [:material-code-braces: ListProjectsResultPaginatorTypeDef](./type_defs.md#listprojectsresultpaginatortypedef) 
...
def paginate(
    ...
    *,
    arn: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListProjectsResultPaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListProjectsResultPaginatorTypeDef](./type_defs.md#listprojectsresultpaginatortypedef) 
...
async with session.client("devicefarm") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListRemoteAccessSessionsResultPaginatorTypeDef
        print(item)  # (3)
```

1. client: [DeviceFarmClient](./client.md)
2. paginator: [ListRemoteAccessSessionsPaginator](./paginators.md#listremoteaccesssessionspaginator)
3. item: [:material-code-braces: ListRemoteAccessSessionsResultPaginatorTypeDef](./type_defs.md#listremoteaccesssessionsresultpaginatortypedef) 
...
def paginate(
    ...
    *,
    arn: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListRemoteAccessSessionsResultPaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListRemoteAccessSessionsResultPaginatorTypeDef](./type_defs.md#listremoteaccesssessionsresultpaginatortypedef) 
...
async with session.client("devicefarm") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListRunsResultPaginatorTypeDef
        print(item)  # (3)
```

1. client: [DeviceFarmClient](./client.md)
2. paginator: [ListRunsPaginator](./paginators.md#listrunspaginator)
3. item: [:material-code-braces: ListRunsResultPaginatorTypeDef](./type_defs.md#listrunsresultpaginatortypedef) 
...
def paginate(
    ...
    *,
    arn: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListRunsResultPaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListRunsResultPaginatorTypeDef](./type_defs.md#listrunsresultpaginatortypedef) 
