...
async with session.client("amplify") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListAppsResultPaginatorTypeDef
        print(item)  # (3)
```

1. client: [AmplifyClient](./client.md)
2. paginator: [ListAppsPaginator](./paginators.md#listappspaginator)
3. item: [:material-code-braces: ListAppsResultPaginatorTypeDef](./type_defs.md#listappsresultpaginatortypedef) 
...
) -> AsyncIterator[ListAppsResultPaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListAppsResultPaginatorTypeDef](./type_defs.md#listappsresultpaginatortypedef) 
