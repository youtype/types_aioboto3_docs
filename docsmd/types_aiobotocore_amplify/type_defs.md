...
4. See [:material-code-braces: AutoBranchCreationConfigPaginatorTypeDef](./type_defs.md#autobranchcreationconfigpaginatortypedef) 
...
1. See [:material-code-braces: AppPaginatorTypeDef](./type_defs.md#apppaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
