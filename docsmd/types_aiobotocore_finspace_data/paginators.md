...
async with session.client("finspace-data") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListDataViewsResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [FinSpaceDataClient](./client.md)
2. paginator: [ListDataViewsPaginator](./paginators.md#listdataviewspaginator)
3. item: [:material-code-braces: ListDataViewsResponsePaginatorTypeDef](./type_defs.md#listdataviewsresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    datasetId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListDataViewsResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListDataViewsResponsePaginatorTypeDef](./type_defs.md#listdataviewsresponsepaginatortypedef) 
