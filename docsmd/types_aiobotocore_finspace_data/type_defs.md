...
3. See [:material-code-braces: DataViewDestinationTypeParamsPaginatorTypeDef](./type_defs.md#dataviewdestinationtypeparamspaginatortypedef) 
...
1. See [:material-code-braces: SchemaDefinitionPaginatorTypeDef](./type_defs.md#schemadefinitionpaginatortypedef) 
## SchemaUnionTypeDef
...
1. See [:material-code-braces: DataViewSummaryPaginatorTypeDef](./type_defs.md#dataviewsummarypaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
3. See [:material-code-braces: SchemaUnionPaginatorTypeDef](./type_defs.md#schemaunionpaginatortypedef) 
