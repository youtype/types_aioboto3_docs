...
Type annotations and code completion for `#!python session.client("opensearch").close` method.
...
16. See [:material-code-braces: CreateDomainResponseTypeDef](./type_defs.md#createdomainresponsetypedef) 
...
Type annotations and code completion for `#!python session.client("opensearch").create_vpc_endpoint` method.
...
Type annotations and code completion for `#!python session.client("opensearch").delete_outbound_connection` method.
...
Type annotations and code completion for `#!python session.client("opensearch").list_versions` method.
...
await def update_data_source(
    ...
    *,
    ...
    DataSourceType: DataSourceTypeTypeDef,  # (1)
    Description: str = ...,
) -> UpdateDataSourceResponseTypeDef:  # (2)
    ...
```

1. See [:material-code-braces: DataSourceTypeTypeDef](./type_defs.md#datasourcetypetypedef) 
2. See [:material-code-braces: UpdateDataSourceResponseTypeDef](./type_defs.md#updatedatasourceresponsetypedef) 
...
await def update_domain_config(
    ...
    *,
    ...
    OffPeakWindowOptions: OffPeakWindowOptionsTypeDef = ...,  # (14)
    SoftwareUpdateOptions: SoftwareUpdateOptionsTypeDef = ...,  # (15)
) -> UpdateDomainConfigResponseTypeDef:  # (16)
    ...
```
...
14. See [:material-code-braces: OffPeakWindowOptionsTypeDef](./type_defs.md#offpeakwindowoptionstypedef) 
15. See [:material-code-braces: SoftwareUpdateOptionsTypeDef](./type_defs.md#softwareupdateoptionstypedef) 
16. See [:material-code-braces: UpdateDomainConfigResponseTypeDef](./type_defs.md#updatedomainconfigresponsetypedef) 
