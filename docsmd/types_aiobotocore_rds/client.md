...
Type annotations and code completion for `#!python session.client("rds").close` method.
...
5. See [:material-code-braces: CreateDBClusterResultTypeDef](./type_defs.md#createdbclusterresulttypedef) 
