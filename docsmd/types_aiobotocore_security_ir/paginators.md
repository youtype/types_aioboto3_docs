...
Type annotations and code completion for `#!python session.client("security-ir").get_paginator("list_case_edits")`.
...
Type annotations and code completion for `#!python session.client("security-ir").get_paginator("list_cases")`.
...
Type annotations and code completion for `#!python session.client("security-ir").get_paginator("list_comments")`.
...
Type annotations and code completion for `#!python session.client("security-ir").get_paginator("list_memberships")`.
