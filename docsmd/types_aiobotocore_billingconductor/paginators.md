...
async with session.client("billingconductor") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListCustomLineItemVersionsOutputPaginatorTypeDef
        print(item)  # (3)
```

1. client: [BillingConductorClient](./client.md)
2. paginator: [ListCustomLineItemVersionsPaginator](./paginators.md#listcustomlineitemversionspaginator)
3. item: [:material-code-braces: ListCustomLineItemVersionsOutputPaginatorTypeDef](./type_defs.md#listcustomlineitemversionsoutputpaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[ListCustomLineItemVersionsOutputPaginatorTypeDef]:  # (3)
    ...
```

1. See [:material-code-braces: ListCustomLineItemVersionsFilterTypeDef](./type_defs.md#listcustomlineitemversionsfiltertypedef) 
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
3. See [:material-code-braces: ListCustomLineItemVersionsOutputPaginatorTypeDef](./type_defs.md#listcustomlineitemversionsoutputpaginatortypedef) 
...
async with session.client("billingconductor") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListCustomLineItemsOutputPaginatorTypeDef
        print(item)  # (3)
```

1. client: [BillingConductorClient](./client.md)
2. paginator: [ListCustomLineItemsPaginator](./paginators.md#listcustomlineitemspaginator)
3. item: [:material-code-braces: ListCustomLineItemsOutputPaginatorTypeDef](./type_defs.md#listcustomlineitemsoutputpaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[ListCustomLineItemsOutputPaginatorTypeDef]:  # (3)
    ...
```

1. See [:material-code-braces: ListCustomLineItemsFilterTypeDef](./type_defs.md#listcustomlineitemsfiltertypedef) 
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
3. See [:material-code-braces: ListCustomLineItemsOutputPaginatorTypeDef](./type_defs.md#listcustomlineitemsoutputpaginatortypedef) 
