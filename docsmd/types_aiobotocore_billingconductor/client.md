...
Type annotations and code completion for `#!python session.client("billingconductor").close` method.
...
Type annotations and code completion for `#!python session.client("billingconductor").untag_resource` method.
