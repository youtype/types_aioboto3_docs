...
async with session.client("devops-guru") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListNotificationChannelsResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [DevOpsGuruClient](./client.md)
2. paginator: [ListNotificationChannelsPaginator](./paginators.md#listnotificationchannelspaginator)
3. item: [:material-code-braces: ListNotificationChannelsResponsePaginatorTypeDef](./type_defs.md#listnotificationchannelsresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListNotificationChannelsResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListNotificationChannelsResponsePaginatorTypeDef](./type_defs.md#listnotificationchannelsresponsepaginatortypedef) 
