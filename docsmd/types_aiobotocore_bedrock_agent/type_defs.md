...
class PromptVariantOutputTypeDef(TypedDict):
    ...
    modelId: NotRequired[str],
    templateConfiguration: NotRequired[PromptTemplateConfigurationOutputTypeDef],  # (3)
```
...
class PromptVariantTypeDef(TypedDict):
    ...
    modelId: NotRequired[str],
    templateConfiguration: NotRequired[PromptTemplateConfigurationUnionTypeDef],  # (3)
```
