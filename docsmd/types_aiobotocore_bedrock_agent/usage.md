...
async with session.client("bedrock-agent") as client:  # (1)
    kwargs: AssociateAgentCollaboratorRequestRequestTypeDef = {...}  # (2)
    result: AssociateAgentCollaboratorResponseTypeDef = await client.associate_agent_collaborator(**kwargs)  # (3)
```

1. client: [AgentsforBedrockClient](./client.md)
2. kwargs: [:material-code-braces: AssociateAgentCollaboratorRequestRequestTypeDef](./type_defs.md#associateagentcollaboratorrequestrequesttypedef) 
