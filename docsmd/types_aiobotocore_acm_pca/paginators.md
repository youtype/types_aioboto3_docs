...
async with session.client("acm-pca") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListCertificateAuthoritiesResponsePaginatorTypeDef
        print(item)  # (3)
```
...
3. item: [:material-code-braces: ListCertificateAuthoritiesResponsePaginatorTypeDef](./type_defs.md#listcertificateauthoritiesresponsepaginatortypedef) 
...
) -> AsyncIterator[ListCertificateAuthoritiesResponsePaginatorTypeDef]:  # (3)
    ...
```

1. See [:material-code-brackets: ResourceOwnerType](./literals.md#resourceownertype) 
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
3. See [:material-code-braces: ListCertificateAuthoritiesResponsePaginatorTypeDef](./type_defs.md#listcertificateauthoritiesresponsepaginatortypedef) 
