...
1. See [:material-code-braces: LFTagPaginatorTypeDef](./type_defs.md#lftagpaginatortypedef) 
...
1. See [:material-code-braces: DatabaseLFTagPolicyAndPermissionsPaginatorTypeDef](./type_defs.md#databaselftagpolicyandpermissionspaginatortypedef) 
2. See [:material-code-braces: TableLFTagPolicyAndPermissionsPaginatorTypeDef](./type_defs.md#tablelftagpolicyandpermissionspaginatortypedef) 
...
1. See [:material-code-braces: DatabaseLFTagPolicyPaginatorTypeDef](./type_defs.md#databaselftagpolicypaginatortypedef) 
2. See [:material-code-braces: TableLFTagPolicyPaginatorTypeDef](./type_defs.md#tablelftagpolicypaginatortypedef) 
...
1. See [:material-code-braces: S3DataAccessAssetSourceEntryPaginatorTypeDef](./type_defs.md#s3dataaccessassetsourceentrypaginatortypedef) 
...
2. See [:material-code-braces: LFResourceDetailsPaginatorTypeDef](./type_defs.md#lfresourcedetailspaginatortypedef) 
...
8. See [:material-code-braces: CreateS3DataAccessFromS3BucketResponseDetailsPaginatorTypeDef](./type_defs.md#creates3dataaccessfroms3bucketresponsedetailspaginatortypedef) 
9. See [:material-code-braces: ImportAssetsFromLakeFormationTagPolicyResponseDetailsPaginatorTypeDef](./type_defs.md#importassetsfromlakeformationtagpolicyresponsedetailspaginatortypedef) 
...
1. See [:material-code-braces: LFTagPolicyDetailsPaginatorTypeDef](./type_defs.md#lftagpolicydetailspaginatortypedef) 
...
1. See [:material-code-braces: ResponseDetailsPaginatorTypeDef](./type_defs.md#responsedetailspaginatortypedef) 
...
1. See [:material-code-braces: LakeFormationDataPermissionDetailsPaginatorTypeDef](./type_defs.md#lakeformationdatapermissiondetailspaginatortypedef) 
...
1. See [:material-code-braces: JobEntryPaginatorTypeDef](./type_defs.md#jobentrypaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
5. See [:material-code-braces: LakeFormationDataPermissionAssetPaginatorTypeDef](./type_defs.md#lakeformationdatapermissionassetpaginatortypedef) 
## AssetDetailsTypeDef
...
1. See [:material-code-braces: AssetDetailsPaginatorTypeDef](./type_defs.md#assetdetailspaginatortypedef) 
...
1. See [:material-code-braces: AssetEntryPaginatorTypeDef](./type_defs.md#assetentrypaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
