...
async with session.client("dataexchange") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListRevisionAssetsResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [DataExchangeClient](./client.md)
2. paginator: [ListRevisionAssetsPaginator](./paginators.md#listrevisionassetspaginator)
3. item: [:material-code-braces: ListRevisionAssetsResponsePaginatorTypeDef](./type_defs.md#listrevisionassetsresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    RevisionId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListRevisionAssetsResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListRevisionAssetsResponsePaginatorTypeDef](./type_defs.md#listrevisionassetsresponsepaginatortypedef) 
