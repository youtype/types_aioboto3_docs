...
async with session.client("medialive") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: DescribeScheduleResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [MediaLiveClient](./client.md)
2. paginator: [DescribeSchedulePaginator](./paginators.md#describeschedulepaginator)
3. item: [:material-code-braces: DescribeScheduleResponsePaginatorTypeDef](./type_defs.md#describescheduleresponsepaginatortypedef) 
...
) -> AsyncIterator[DescribeScheduleResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: DescribeScheduleResponsePaginatorTypeDef](./type_defs.md#describescheduleresponsepaginatortypedef) 
