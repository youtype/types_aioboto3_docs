...
client: QAppsClient
async with session.client("qapps") as client:  # (1)
    kwargs: AssociateLibraryItemReviewInputRequestTypeDef = {...}  # (2)
    result: EmptyResponseMetadataTypeDef = await client.associate_library_item_review(**kwargs)  # (3)
```

1. client: [QAppsClient](./client.md)
2. kwargs: [:material-code-braces: AssociateLibraryItemReviewInputRequestTypeDef](./type_defs.md#associatelibraryitemreviewinputrequesttypedef) 
