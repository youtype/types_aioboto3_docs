...
Type annotations and code completion for `#!python session.client("cloudhsmv2").close` method.
...
Type annotations and code completion for `#!python session.client("cloudhsmv2").delete_resource_policy` method.
