...
1. client: [SageMakerMetricsClient](./client.md)
2. kwargs: [:material-code-braces: BatchPutMetricsRequestRequestTypeDef](./type_defs.md#batchputmetricsrequestrequesttypedef) 
3. result: [:material-code-braces: BatchPutMetricsResponseTypeDef](./type_defs.md#batchputmetricsresponsetypedef) 
