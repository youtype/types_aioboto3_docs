...
1. See [:material-code-braces: PermissionPaginatorTypeDef](./type_defs.md#permissionpaginatortypedef) 
...
1. See [:material-code-braces: NotificationsTypeDef](./type_defs.md#notificationstypedef) 
2. See [:material-code-braces: PipelineOutputConfigPaginatorTypeDef](./type_defs.md#pipelineoutputconfigpaginatortypedef) 
3. See [:material-code-braces: PipelineOutputConfigPaginatorTypeDef](./type_defs.md#pipelineoutputconfigpaginatortypedef) 
...
2. See [:material-code-braces: VideoParametersPaginatorTypeDef](./type_defs.md#videoparameterspaginatortypedef) 
...
3. See [:material-code-braces: JobAlbumArtPaginatorTypeDef](./type_defs.md#jobalbumartpaginatortypedef) 
4. See [:material-code-braces: ClipTypeDef](./type_defs.md#cliptypedef) 
5. See [:material-code-braces: CaptionsPaginatorTypeDef](./type_defs.md#captionspaginatortypedef) 
...
3. See [:material-code-braces: InputCaptionsPaginatorTypeDef](./type_defs.md#inputcaptionspaginatortypedef) 
...
1. See [:material-code-braces: PipelinePaginatorTypeDef](./type_defs.md#pipelinepaginatortypedef) 
...
1. See [:material-code-braces: JobInputPaginatorTypeDef](./type_defs.md#jobinputpaginatortypedef) 
2. See [:material-code-braces: JobInputPaginatorTypeDef](./type_defs.md#jobinputpaginatortypedef) 
3. See [:material-code-braces: JobOutputPaginatorTypeDef](./type_defs.md#joboutputpaginatortypedef) 
4. See [:material-code-braces: JobOutputPaginatorTypeDef](./type_defs.md#joboutputpaginatortypedef) 
