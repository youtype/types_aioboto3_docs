...
Type annotations and code completion for `#!python session.client("honeycode").get_paginator("list_table_columns")`.
...
Type annotations and code completion for `#!python session.client("honeycode").get_paginator("list_table_rows")`.
...
Type annotations and code completion for `#!python session.client("honeycode").get_paginator("list_tables")`.
...
Type annotations and code completion for `#!python session.client("honeycode").get_paginator("query_table_rows")`.
