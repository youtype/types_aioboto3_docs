...
3. item: [:material-code-braces: ListLaunchProfilesResponsePaginatorTypeDef](./type_defs.md#listlaunchprofilesresponsepaginatortypedef) 
...
) -> AsyncIterator[ListLaunchProfilesResponsePaginatorTypeDef]:  # (3)
    ...
```

1. See [:material-code-brackets: LaunchProfileStateType](./literals.md#launchprofilestatetype) 
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
3. See [:material-code-braces: ListLaunchProfilesResponsePaginatorTypeDef](./type_defs.md#listlaunchprofilesresponsepaginatortypedef) 
...
Type annotations and code completion for `#!python session.client("nimble").get_paginator("list_streaming_session_backups")`.
...
3. item: [:material-code-braces: ListStudioComponentsResponsePaginatorTypeDef](./type_defs.md#liststudiocomponentsresponsepaginatortypedef) 
...
) -> AsyncIterator[ListStudioComponentsResponsePaginatorTypeDef]:  # (4)
    ...
```
...
4. See [:material-code-braces: ListStudioComponentsResponsePaginatorTypeDef](./type_defs.md#liststudiocomponentsresponsepaginatortypedef) 
