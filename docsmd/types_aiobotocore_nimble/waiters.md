...
Type annotations and code completion for `#!python session.client("nimble").get_waiter("streaming_image_deleted")`.
...
Type annotations and code completion for `#!python session.client("nimble").get_waiter("studio_deleted")`.
