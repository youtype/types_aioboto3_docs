...
```python
# ActiveDirectoryConfigurationUnionTypeDef definition

ActiveDirectoryConfigurationUnionTypeDef = Union[
    ActiveDirectoryConfigurationTypeDef,  # (1)
    ActiveDirectoryConfigurationOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: ActiveDirectoryConfigurationTypeDef](./type_defs.md#activedirectoryconfigurationtypedef) 
2. See [:material-code-braces: ActiveDirectoryConfigurationOutputTypeDef](./type_defs.md#activedirectoryconfigurationoutputtypedef) 

## StreamConfigurationSessionStorageUnionTypeDef

```python
# StreamConfigurationSessionStorageUnionTypeDef definition

StreamConfigurationSessionStorageUnionTypeDef = Union[
    StreamConfigurationSessionStorageTypeDef,  # (1)
    StreamConfigurationSessionStorageOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: StreamConfigurationSessionStorageTypeDef](./type_defs.md#streamconfigurationsessionstoragetypedef) 
2. See [:material-code-braces: StreamConfigurationSessionStorageOutputTypeDef](./type_defs.md#streamconfigurationsessionstorageoutputtypedef) 
...
1. See [:material-code-braces: ActiveDirectoryConfigurationOutputTypeDef](./type_defs.md#activedirectoryconfigurationoutputtypedef) 
...
6. See [:material-code-braces: StreamConfigurationSessionStorageOutputTypeDef](./type_defs.md#streamconfigurationsessionstorageoutputtypedef) 
...
1. See [:material-code-braces: StudioComponentConfigurationOutputTypeDef](./type_defs.md#studiocomponentconfigurationoutputtypedef) 
...
class StudioComponentConfigurationTypeDef(TypedDict):
    activeDirectoryConfiguration: NotRequired[ActiveDirectoryConfigurationUnionTypeDef],  # (1)
    computeFarmConfiguration: NotRequired[ComputeFarmConfigurationTypeDef],  # (2)
    licenseServiceConfiguration: NotRequired[LicenseServiceConfigurationTypeDef],  # (3)
    sharedFileSystemConfiguration: NotRequired[SharedFileSystemConfigurationTypeDef],  # (4)
```

1. See [:material-code-braces: ActiveDirectoryConfigurationTypeDef](./type_defs.md#activedirectoryconfigurationtypedef) [:material-code-braces: ActiveDirectoryConfigurationOutputTypeDef](./type_defs.md#activedirectoryconfigurationoutputtypedef) 
2. See [:material-code-braces: ComputeFarmConfigurationTypeDef](./type_defs.md#computefarmconfigurationtypedef) 
3. See [:material-code-braces: LicenseServiceConfigurationTypeDef](./type_defs.md#licenseserviceconfigurationtypedef) 
4. See [:material-code-braces: SharedFileSystemConfigurationTypeDef](./type_defs.md#sharedfilesystemconfigurationtypedef) 
...
class StreamConfigurationCreateTypeDef(TypedDict):
    ...
    sessionBackup: NotRequired[StreamConfigurationSessionBackupTypeDef],  # (4)
    sessionPersistenceMode: NotRequired[SessionPersistenceModeType],  # (5)
    sessionStorage: NotRequired[StreamConfigurationSessionStorageUnionTypeDef],  # (6)
    volumeConfiguration: NotRequired[VolumeConfigurationTypeDef],  # (7)
```
...
4. See [:material-code-braces: StreamConfigurationSessionBackupTypeDef](./type_defs.md#streamconfigurationsessionbackuptypedef) 
5. See [:material-code-brackets: SessionPersistenceModeType](./literals.md#sessionpersistencemodetype) 
6. See [:material-code-braces: StreamConfigurationSessionStorageTypeDef](./type_defs.md#streamconfigurationsessionstoragetypedef) [:material-code-braces: StreamConfigurationSessionStorageOutputTypeDef](./type_defs.md#streamconfigurationsessionstorageoutputtypedef) 
7. See [:material-code-braces: VolumeConfigurationTypeDef](./type_defs.md#volumeconfigurationtypedef) 
