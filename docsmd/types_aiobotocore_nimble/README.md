...
Type annotations and code completion for  `#!python session.client("nimble")` as [NimbleStudioClient](./client.md)
...
- [ActiveDirectoryConfigurationPaginatorTypeDef](./type_defs.md#activedirectoryconfigurationpaginatortypedef)
...
- [StreamConfigurationSessionStoragePaginatorTypeDef](./type_defs.md#streamconfigurationsessionstoragepaginatortypedef)
...
- [StudioComponentConfigurationPaginatorTypeDef](./type_defs.md#studiocomponentconfigurationpaginatortypedef)
...
- [StreamConfigurationPaginatorTypeDef](./type_defs.md#streamconfigurationpaginatortypedef)
...
- [StudioComponentPaginatorTypeDef](./type_defs.md#studiocomponentpaginatortypedef)
...
- [LaunchProfilePaginatorTypeDef](./type_defs.md#launchprofilepaginatortypedef)
...
- [ListStudioComponentsResponsePaginatorTypeDef](./type_defs.md#liststudiocomponentsresponsepaginatortypedef)
...
- [ListLaunchProfilesResponsePaginatorTypeDef](./type_defs.md#listlaunchprofilesresponsepaginatortypedef)
