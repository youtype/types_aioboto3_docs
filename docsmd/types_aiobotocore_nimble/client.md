...
Type annotations and code completion for `#!python session.client("nimble").close` method.
...
Type annotations and code completion for `#!python session.client("nimble").get_streaming_session_backup` method.
...
Type annotations and code completion for `#!python session.client("nimble").list_streaming_session_backups` method.
...
Type annotations and code completion for `#!python session.client("nimble").list_studios` method.
