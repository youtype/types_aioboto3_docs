...
```python
# DeploymentApplicationConfigPaginatorTypeDef definition

class DeploymentApplicationConfigPaginatorTypeDef(TypedDict):
    application: str,
    applicationVersion: str,
    launchConfig: DeploymentLaunchConfigPaginatorTypeDef,  # (1)
```

1. See [:material-code-braces: DeploymentLaunchConfigPaginatorTypeDef](./type_defs.md#deploymentlaunchconfigpaginatortypedef) 
...
```python
# DeploymentJobPaginatorTypeDef definition

class DeploymentJobPaginatorTypeDef(TypedDict):
    arn: NotRequired[str],
    fleet: NotRequired[str],
    status: NotRequired[DeploymentStatusType],  # (1)
    deploymentApplicationConfigs: NotRequired[List[DeploymentApplicationConfigPaginatorTypeDef]],  # (2)
...
1. See [:material-code-brackets: DeploymentStatusType](./literals.md#deploymentstatustype) 
2. See [:material-code-braces: DeploymentApplicationConfigPaginatorTypeDef](./type_defs.md#deploymentapplicationconfigpaginatortypedef) 
...
```python
# ListDeploymentJobsResponsePaginatorTypeDef definition

class ListDeploymentJobsResponsePaginatorTypeDef(TypedDict):
    deploymentJobs: List[DeploymentJobPaginatorTypeDef],  # (1)
    nextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: DeploymentJobPaginatorTypeDef](./type_defs.md#deploymentjobpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
