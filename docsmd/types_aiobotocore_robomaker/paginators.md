...
async with session.client("robomaker") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListDeploymentJobsResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [RoboMakerClient](./client.md)
2. paginator: [ListDeploymentJobsPaginator](./paginators.md#listdeploymentjobspaginator)
3. item: [:material-code-braces: ListDeploymentJobsResponsePaginatorTypeDef](./type_defs.md#listdeploymentjobsresponsepaginatortypedef) 
...
) -> AsyncIterator[ListDeploymentJobsResponsePaginatorTypeDef]:  # (3)
    ...
```

1. See [:material-code-braces: FilterTypeDef](./type_defs.md#filtertypedef) 
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
3. See [:material-code-braces: ListDeploymentJobsResponsePaginatorTypeDef](./type_defs.md#listdeploymentjobsresponsepaginatortypedef) 
