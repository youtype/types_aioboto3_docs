...
async with session.client("route53") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListHealthChecksResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [Route53Client](./client.md)
2. paginator: [ListHealthChecksPaginator](./paginators.md#listhealthcheckspaginator)
3. item: [:material-code-braces: ListHealthChecksResponsePaginatorTypeDef](./type_defs.md#listhealthchecksresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListHealthChecksResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListHealthChecksResponsePaginatorTypeDef](./type_defs.md#listhealthchecksresponsepaginatortypedef) 
...
async with session.client("route53") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListResourceRecordSetsResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [Route53Client](./client.md)
2. paginator: [ListResourceRecordSetsPaginator](./paginators.md#listresourcerecordsetspaginator)
3. item: [:material-code-braces: ListResourceRecordSetsResponsePaginatorTypeDef](./type_defs.md#listresourcerecordsetsresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    HostedZoneId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListResourceRecordSetsResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListResourceRecordSetsResponsePaginatorTypeDef](./type_defs.md#listresourcerecordsetsresponsepaginatortypedef) 
