...
```python
# HealthCheckConfigPaginatorTypeDef definition

class HealthCheckConfigPaginatorTypeDef(TypedDict):
...
```python
# HealthCheckPaginatorTypeDef definition

class HealthCheckPaginatorTypeDef(TypedDict):
    Id: str,
    CallerReference: str,
    HealthCheckConfig: HealthCheckConfigPaginatorTypeDef,  # (2)
...
2. See [:material-code-braces: HealthCheckConfigPaginatorTypeDef](./type_defs.md#healthcheckconfigpaginatortypedef) 
...
```python
# ResourceRecordSetPaginatorTypeDef definition

class ResourceRecordSetPaginatorTypeDef(TypedDict):
    Name: str,
    Type: RRTypeType,  # (1)
...
```python
# ListHealthChecksResponsePaginatorTypeDef definition

class ListHealthChecksResponsePaginatorTypeDef(TypedDict):
    HealthChecks: List[HealthCheckPaginatorTypeDef],  # (1)
    Marker: str,
    IsTruncated: bool,
    NextMarker: str,
    MaxItems: str,
...
1. See [:material-code-braces: HealthCheckPaginatorTypeDef](./type_defs.md#healthcheckpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
```python
# ListResourceRecordSetsResponsePaginatorTypeDef definition

class ListResourceRecordSetsResponsePaginatorTypeDef(TypedDict):
    ResourceRecordSets: List[ResourceRecordSetPaginatorTypeDef],  # (1)
    IsTruncated: bool,
    NextRecordName: str,
...
1. See [:material-code-braces: ResourceRecordSetPaginatorTypeDef](./type_defs.md#resourcerecordsetpaginatortypedef) 
2. See [:material-code-brackets: RRTypeType](./literals.md#rrtypetype) 
3. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
## ChangeTypeDef
