...
Type annotations and code completion for `#!python session.client("route53").close` method.
...
Type annotations and code completion for `#!python session.client("route53").disable_hosted_zone_dnssec` method.
