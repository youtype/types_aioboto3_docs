...
1. See [:material-code-braces: IamActionDefinitionPaginatorTypeDef](./type_defs.md#iamactiondefinitionpaginatortypedef) 
2. See [:material-code-braces: ScpActionDefinitionPaginatorTypeDef](./type_defs.md#scpactiondefinitionpaginatortypedef) 
3. See [:material-code-braces: SsmActionDefinitionPaginatorTypeDef](./type_defs.md#ssmactiondefinitionpaginatortypedef) 
## DefinitionTypeDef
...
8. See [:material-code-braces: AutoAdjustDataPaginatorTypeDef](./type_defs.md#autoadjustdatapaginatortypedef) 
## BudgetTypeDef
...
class ActionPaginatorTypeDef(TypedDict):
    ...
    Definition: DefinitionPaginatorTypeDef,  # (4)
...
4. See [:material-code-braces: DefinitionPaginatorTypeDef](./type_defs.md#definitionpaginatortypedef) 
...
1. See [:material-code-braces: BudgetPaginatorTypeDef](./type_defs.md#budgetpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
```python
# ActionHistoryDetailsPaginatorTypeDef definition

class ActionHistoryDetailsPaginatorTypeDef(TypedDict):
    Message: str,
    Action: ActionPaginatorTypeDef,  # (1)
```

1. See [:material-code-braces: ActionPaginatorTypeDef](./type_defs.md#actionpaginatortypedef) 
## DescribeBudgetActionsForAccountResponsePaginatorTypeDef

```python
# DescribeBudgetActionsForAccountResponsePaginatorTypeDef definition

class DescribeBudgetActionsForAccountResponsePaginatorTypeDef(TypedDict):
    Actions: List[ActionPaginatorTypeDef],  # (1)
    NextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```
...
```python
# DescribeBudgetActionsForBudgetResponsePaginatorTypeDef definition

class DescribeBudgetActionsForBudgetResponsePaginatorTypeDef(TypedDict):
    Actions: List[ActionPaginatorTypeDef],  # (1)
    NextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```
...
```python
# ActionHistoryPaginatorTypeDef definition

class ActionHistoryPaginatorTypeDef(TypedDict):
    Timestamp: datetime,
    Status: ActionStatusType,  # (1)
    EventType: EventTypeType,  # (2)
    ActionHistoryDetails: ActionHistoryDetailsPaginatorTypeDef,  # (3)
```
...
3. See [:material-code-braces: ActionHistoryDetailsPaginatorTypeDef](./type_defs.md#actionhistorydetailspaginatortypedef) 
...
```python
# DescribeBudgetActionHistoriesResponsePaginatorTypeDef definition

class DescribeBudgetActionHistoriesResponsePaginatorTypeDef(TypedDict):
    ActionHistories: List[ActionHistoryPaginatorTypeDef],  # (1)
    NextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: ActionHistoryPaginatorTypeDef](./type_defs.md#actionhistorypaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
