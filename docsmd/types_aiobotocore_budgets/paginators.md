...
async with session.client("budgets") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: DescribeBudgetActionHistoriesResponsePaginatorTypeDef
        print(item)  # (3)
```
...
3. item: [:material-code-braces: DescribeBudgetActionHistoriesResponsePaginatorTypeDef](./type_defs.md#describebudgetactionhistoriesresponsepaginatortypedef) 
...
) -> AsyncIterator[DescribeBudgetActionHistoriesResponsePaginatorTypeDef]:  # (3)
    ...
```

1. See [:material-code-braces: TimePeriodTypeDef](./type_defs.md#timeperiodtypedef) 
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
3. See [:material-code-braces: DescribeBudgetActionHistoriesResponsePaginatorTypeDef](./type_defs.md#describebudgetactionhistoriesresponsepaginatortypedef) 
...
async with session.client("budgets") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: DescribeBudgetActionsForAccountResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [BudgetsClient](./client.md)
2. paginator: [DescribeBudgetActionsForAccountPaginator](./paginators.md#describebudgetactionsforaccountpaginator)
3. item: [:material-code-braces: DescribeBudgetActionsForAccountResponsePaginatorTypeDef](./type_defs.md#describebudgetactionsforaccountresponsepaginatortypedef) 
...
) -> AsyncIterator[DescribeBudgetActionsForAccountResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: DescribeBudgetActionsForAccountResponsePaginatorTypeDef](./type_defs.md#describebudgetactionsforaccountresponsepaginatortypedef) 
...
async with session.client("budgets") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: DescribeBudgetActionsForBudgetResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [BudgetsClient](./client.md)
2. paginator: [DescribeBudgetActionsForBudgetPaginator](./paginators.md#describebudgetactionsforbudgetpaginator)
3. item: [:material-code-braces: DescribeBudgetActionsForBudgetResponsePaginatorTypeDef](./type_defs.md#describebudgetactionsforbudgetresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    BudgetName: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[DescribeBudgetActionsForBudgetResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: DescribeBudgetActionsForBudgetResponsePaginatorTypeDef](./type_defs.md#describebudgetactionsforbudgetresponsepaginatortypedef) 
...
3. item: [:material-code-braces: DescribeBudgetsResponsePaginatorTypeDef](./type_defs.md#describebudgetsresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    AccountId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[DescribeBudgetsResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: DescribeBudgetsResponsePaginatorTypeDef](./type_defs.md#describebudgetsresponsepaginatortypedef) 
