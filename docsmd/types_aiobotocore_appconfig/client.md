...
Type annotations and code completion for `#!python session.client("appconfig").close` method.
...
Type annotations and code completion for `#!python session.client("appconfig").get_hosted_configuration_version` method.
