...
Type annotations and code completion for `#!python session.client("pinpoint-email")`
...
This class provides code completion for `#!python session.client("pinpoint-email").exceptions` structure.
...
```python
# PinpointEmailClient.exceptions type checking example
...
Type annotations and code completion for `#!python session.client("pinpoint-email").can_paginate` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").close` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").create_configuration_set` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").create_configuration_set_event_destination` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").create_dedicated_ip_pool` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").create_deliverability_test_report` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").create_email_identity` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").delete_configuration_set` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").delete_configuration_set_event_destination` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").delete_dedicated_ip_pool` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").delete_email_identity` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").generate_presigned_url` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").get_account` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").get_blacklist_reports` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").get_configuration_set` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").get_configuration_set_event_destinations` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").get_dedicated_ip` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").get_dedicated_ips` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").get_deliverability_dashboard_options` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").get_deliverability_test_report` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").get_domain_deliverability_campaign` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").get_domain_statistics_report` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").get_email_identity` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").list_configuration_sets` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").list_dedicated_ip_pools` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").list_deliverability_test_reports` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").list_domain_deliverability_campaigns` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").list_email_identities` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").list_tags_for_resource` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").put_account_dedicated_ip_warmup_attributes` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").put_account_sending_attributes` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").put_configuration_set_delivery_options` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").put_configuration_set_reputation_options` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").put_configuration_set_sending_options` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").put_configuration_set_tracking_options` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").put_dedicated_ip_in_pool` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").put_dedicated_ip_warmup_attributes` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").put_deliverability_dashboard_option` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").put_email_identity_dkim_attributes` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").put_email_identity_feedback_attributes` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").put_email_identity_mail_from_attributes` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").send_email` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").tag_resource` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").untag_resource` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").update_configuration_set_event_destination` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").__aenter__` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").__aexit__` method.
...
Type annotations and code completion for `#!python session.client("pinpoint-email").get_paginator` method with overloads.
