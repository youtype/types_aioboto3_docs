...
## AudioChannelTaggingSettingsPaginatorTypeDef

```python
# AudioChannelTaggingSettingsPaginatorTypeDef definition

class AudioChannelTaggingSettingsPaginatorTypeDef(TypedDict):
...
```python
# AudioSelectorGroupPaginatorTypeDef definition

class AudioSelectorGroupPaginatorTypeDef(TypedDict):
...
```python
# TeletextDestinationSettingsPaginatorTypeDef definition

class TeletextDestinationSettingsPaginatorTypeDef(TypedDict):
...
```python
# OutputChannelMappingPaginatorTypeDef definition

class OutputChannelMappingPaginatorTypeDef(TypedDict):
...
```python
# CmafAdditionalManifestPaginatorTypeDef definition

class CmafAdditionalManifestPaginatorTypeDef(TypedDict):
...
```python
# SpekeKeyProviderCmafPaginatorTypeDef definition

class SpekeKeyProviderCmafPaginatorTypeDef(TypedDict):
...
```python
# M3u8SettingsPaginatorTypeDef definition

class M3u8SettingsPaginatorTypeDef(TypedDict):
...
```python
# DashAdditionalManifestPaginatorTypeDef definition

class DashAdditionalManifestPaginatorTypeDef(TypedDict):
    ManifestNameModifier: NotRequired[str],
    SelectedOutputs: NotRequired[List[str]],
```
...
```python
# HlsAdditionalManifestPaginatorTypeDef definition

class HlsAdditionalManifestPaginatorTypeDef(TypedDict):
    ManifestNameModifier: NotRequired[str],
    SelectedOutputs: NotRequired[List[str]],
```
...
```python
# MsSmoothAdditionalManifestPaginatorTypeDef definition

class MsSmoothAdditionalManifestPaginatorTypeDef(TypedDict):
    ManifestNameModifier: NotRequired[str],
    SelectedOutputs: NotRequired[List[str]],
```
...
```python
# AutomatedAbrRulePaginatorTypeDef definition

class AutomatedAbrRulePaginatorTypeDef(TypedDict):
...
```python
# CaptionDestinationSettingsPaginatorTypeDef definition

class CaptionDestinationSettingsPaginatorTypeDef(TypedDict):
    ...
    TeletextDestinationSettings: NotRequired[TeletextDestinationSettingsPaginatorTypeDef],  # (8)
...
8. See [:material-code-braces: TeletextDestinationSettingsPaginatorTypeDef](./type_defs.md#teletextdestinationsettingspaginatortypedef) 
...
```python
# ChannelMappingPaginatorTypeDef definition

class ChannelMappingPaginatorTypeDef(TypedDict):
    OutputChannels: NotRequired[List[OutputChannelMappingPaginatorTypeDef]],  # (1)
```

1. See [:material-code-braces: OutputChannelMappingPaginatorTypeDef](./type_defs.md#outputchannelmappingpaginatortypedef) 
...
```python
# CmafEncryptionSettingsPaginatorTypeDef definition

class CmafEncryptionSettingsPaginatorTypeDef(TypedDict):
    ...
    SpekeKeyProvider: NotRequired[SpekeKeyProviderCmafPaginatorTypeDef],  # (3)
...
3. See [:material-code-braces: SpekeKeyProviderCmafPaginatorTypeDef](./type_defs.md#spekekeyprovidercmafpaginatortypedef) 
...
```python
# DashIsoEncryptionSettingsPaginatorTypeDef definition

class DashIsoEncryptionSettingsPaginatorTypeDef(TypedDict):
    PlaybackDeviceCompatibility: NotRequired[DashIsoPlaybackDeviceCompatibilityType],  # (1)
    SpekeKeyProvider: NotRequired[SpekeKeyProviderPaginatorTypeDef],  # (2)
```

1. See [:material-code-brackets: DashIsoPlaybackDeviceCompatibilityType](./literals.md#dashisoplaybackdevicecompatibilitytype) 
2. See [:material-code-braces: SpekeKeyProviderPaginatorTypeDef](./type_defs.md#spekekeyproviderpaginatortypedef) 
## HlsEncryptionSettingsPaginatorTypeDef

```python
# HlsEncryptionSettingsPaginatorTypeDef definition

class HlsEncryptionSettingsPaginatorTypeDef(TypedDict):
    ConstantInitializationVector: NotRequired[str],
    ...
    SpekeKeyProvider: NotRequired[SpekeKeyProviderPaginatorTypeDef],  # (4)
...
4. See [:material-code-braces: SpekeKeyProviderPaginatorTypeDef](./type_defs.md#spekekeyproviderpaginatortypedef) 
...
```python
# MsSmoothEncryptionSettingsPaginatorTypeDef definition

class MsSmoothEncryptionSettingsPaginatorTypeDef(TypedDict):
    SpekeKeyProvider: NotRequired[SpekeKeyProviderPaginatorTypeDef],  # (1)
```

1. See [:material-code-braces: SpekeKeyProviderPaginatorTypeDef](./type_defs.md#spekekeyproviderpaginatortypedef) 
...
class H264SettingsTypeDef(TypedDict):
    ...
    ScanTypeConversionMode: NotRequired[H264ScanTypeConversionModeType],  # (20)
    SceneChangeDetect: NotRequired[H264SceneChangeDetectType],  # (21)
    Slices: NotRequired[int],
    SlowPal: NotRequired[H264SlowPalType],  # (22)
    Softness: NotRequired[int],
    SpatialAdaptiveQuantization: NotRequired[H264SpatialAdaptiveQuantizationType],  # (23)
    Syntax: NotRequired[H264SyntaxType],  # (24)
    Telecine: NotRequired[H264TelecineType],  # (25)
    TemporalAdaptiveQuantization: NotRequired[H264TemporalAdaptiveQuantizationType],  # (26)
    UnregisteredSeiTimecode: NotRequired[H264UnregisteredSeiTimecodeType],  # (27)
```
...
20. See [:material-code-brackets: H264ScanTypeConversionModeType](./literals.md#h264scantypeconversionmodetype) 
21. See [:material-code-brackets: H264SceneChangeDetectType](./literals.md#h264scenechangedetecttype) 
22. See [:material-code-brackets: H264SlowPalType](./literals.md#h264slowpaltype) 
23. See [:material-code-brackets: H264SpatialAdaptiveQuantizationType](./literals.md#h264spatialadaptivequantizationtype) 
24. See [:material-code-brackets: H264SyntaxType](./literals.md#h264syntaxtype) 
25. See [:material-code-brackets: H264TelecineType](./literals.md#h264telecinetype) 
26. See [:material-code-brackets: H264TemporalAdaptiveQuantizationType](./literals.md#h264temporaladaptivequantizationtype) 
27. See [:material-code-brackets: H264UnregisteredSeiTimecodeType](./literals.md#h264unregisteredseitimecodetype) 
## H265SettingsTypeDef
...
```python
# TimedMetadataInsertionPaginatorTypeDef definition

class TimedMetadataInsertionPaginatorTypeDef(TypedDict):
...
```python
# ImageInserterPaginatorTypeDef definition

class ImageInserterPaginatorTypeDef(TypedDict):
...
```python
# M2tsSettingsPaginatorTypeDef definition

class M2tsSettingsPaginatorTypeDef(TypedDict):
    ...
    ProgramNumber: NotRequired[int],
    PtsOffset: NotRequired[int],
    PtsOffsetMode: NotRequired[TsPtsOffsetType],  # (15)
    RateMode: NotRequired[M2tsRateModeType],  # (16)
    Scte35Esam: NotRequired[M2tsScte35EsamTypeDef],  # (17)
    Scte35Pid: NotRequired[int],
    Scte35Source: NotRequired[M2tsScte35SourceType],  # (18)
    SegmentationMarkers: NotRequired[M2tsSegmentationMarkersType],  # (19)
    SegmentationStyle: NotRequired[M2tsSegmentationStyleType],  # (20)
...
15. See [:material-code-brackets: TsPtsOffsetType](./literals.md#tsptsoffsettype) 
16. See [:material-code-brackets: M2tsRateModeType](./literals.md#m2tsratemodetype) 
17. See [:material-code-braces: M2tsScte35EsamTypeDef](./type_defs.md#m2tsscte35esamtypedef) 
18. See [:material-code-brackets: M2tsScte35SourceType](./literals.md#m2tsscte35sourcetype) 
19. See [:material-code-brackets: M2tsSegmentationMarkersType](./literals.md#m2tssegmentationmarkerstype) 
20. See [:material-code-brackets: M2tsSegmentationStyleType](./literals.md#m2tssegmentationstyletype) 
## M2tsSettingsTypeDef
...
```python
# VideoOverlayInputPaginatorTypeDef definition

class VideoOverlayInputPaginatorTypeDef(TypedDict):
    FileInput: NotRequired[str],
...
```python
# AutomatedAbrSettingsPaginatorTypeDef definition

class AutomatedAbrSettingsPaginatorTypeDef(TypedDict):
    MaxAbrBitrate: NotRequired[int],
    MaxRenditions: NotRequired[int],
    MinAbrBitrate: NotRequired[int],
    Rules: NotRequired[List[AutomatedAbrRulePaginatorTypeDef]],  # (1)
```

1. See [:material-code-braces: AutomatedAbrRulePaginatorTypeDef](./type_defs.md#automatedabrrulepaginatortypedef) 
...
```python
# CaptionDescriptionPaginatorTypeDef definition

class CaptionDescriptionPaginatorTypeDef(TypedDict):
    CaptionSelectorName: NotRequired[str],
    CustomLanguageCode: NotRequired[str],
    DestinationSettings: NotRequired[CaptionDestinationSettingsPaginatorTypeDef],  # (1)
    LanguageCode: NotRequired[LanguageCodeType],  # (2)
    LanguageDescription: NotRequired[str],
```

1. See [:material-code-braces: CaptionDestinationSettingsPaginatorTypeDef](./type_defs.md#captiondestinationsettingspaginatortypedef) 
2. See [:material-code-brackets: LanguageCodeType](./literals.md#languagecodetype) 
## CaptionDescriptionPresetPaginatorTypeDef

```python
# CaptionDescriptionPresetPaginatorTypeDef definition

class CaptionDescriptionPresetPaginatorTypeDef(TypedDict):
    CustomLanguageCode: NotRequired[str],
    DestinationSettings: NotRequired[CaptionDestinationSettingsPaginatorTypeDef],  # (1)
    LanguageCode: NotRequired[LanguageCodeType],  # (2)
    LanguageDescription: NotRequired[str],
...
```python
# RemixSettingsPaginatorTypeDef definition

class RemixSettingsPaginatorTypeDef(TypedDict):
    AudioDescriptionAudioChannel: NotRequired[int],
    AudioDescriptionDataChannel: NotRequired[int],
    ChannelMapping: NotRequired[ChannelMappingPaginatorTypeDef],  # (1)
    ChannelsIn: NotRequired[int],
    ChannelsOut: NotRequired[int],
```

1. See [:material-code-braces: ChannelMappingPaginatorTypeDef](./type_defs.md#channelmappingpaginatortypedef) 
...
```python
# ContainerSettingsPaginatorTypeDef definition

class ContainerSettingsPaginatorTypeDef(TypedDict):
    ...
    M2tsSettings: NotRequired[M2tsSettingsPaginatorTypeDef],  # (4)
    M3u8Settings: NotRequired[M3u8SettingsPaginatorTypeDef],  # (5)
...
4. See [:material-code-braces: M2tsSettingsPaginatorTypeDef](./type_defs.md#m2tssettingspaginatortypedef) 
5. See [:material-code-braces: M3u8SettingsPaginatorTypeDef](./type_defs.md#m3u8settingspaginatortypedef) 
...
```python
# VideoPreprocessorPaginatorTypeDef definition

class VideoPreprocessorPaginatorTypeDef(TypedDict):
    ...
    ImageInserter: NotRequired[ImageInserterPaginatorTypeDef],  # (5)
...
5. See [:material-code-braces: ImageInserterPaginatorTypeDef](./type_defs.md#imageinserterpaginatortypedef) 
...
```python
# VideoOverlayPaginatorTypeDef definition

class VideoOverlayPaginatorTypeDef(TypedDict):
    EndTimecode: NotRequired[str],
    Input: NotRequired[VideoOverlayInputPaginatorTypeDef],  # (1)
    StartTimecode: NotRequired[str],
```

1. See [:material-code-braces: VideoOverlayInputPaginatorTypeDef](./type_defs.md#videooverlayinputpaginatortypedef) 
## VideoOverlayTypeDef
...
class VideoOverlayTypeDef(TypedDict):
    EndTimecode: NotRequired[str],
    Input: NotRequired[VideoOverlayInputTypeDef],  # (1)
    StartTimecode: NotRequired[str],
```
...
```python
# AutomatedEncodingSettingsPaginatorTypeDef definition

class AutomatedEncodingSettingsPaginatorTypeDef(TypedDict):
    AbrSettings: NotRequired[AutomatedAbrSettingsPaginatorTypeDef],  # (1)
```

1. See [:material-code-braces: AutomatedAbrSettingsPaginatorTypeDef](./type_defs.md#automatedabrsettingspaginatortypedef) 
...
```python
# AudioDescriptionPaginatorTypeDef definition

class AudioDescriptionPaginatorTypeDef(TypedDict):
    AudioChannelTaggingSettings: NotRequired[AudioChannelTaggingSettingsPaginatorTypeDef],  # (1)
    ...
    RemixSettings: NotRequired[RemixSettingsPaginatorTypeDef],  # (7)
    StreamName: NotRequired[str],
```

1. See [:material-code-braces: AudioChannelTaggingSettingsPaginatorTypeDef](./type_defs.md#audiochanneltaggingsettingspaginatortypedef) 
...
7. See [:material-code-braces: RemixSettingsPaginatorTypeDef](./type_defs.md#remixsettingspaginatortypedef) 
...
class AudioSelectorPaginatorTypeDef(TypedDict):
    ...
    RemixSettings: NotRequired[RemixSettingsPaginatorTypeDef],  # (5)
...
5. See [:material-code-braces: RemixSettingsPaginatorTypeDef](./type_defs.md#remixsettingspaginatortypedef) 
...
```python
# CmafGroupSettingsPaginatorTypeDef definition

class CmafGroupSettingsPaginatorTypeDef(TypedDict):
    AdditionalManifests: NotRequired[List[CmafAdditionalManifestPaginatorTypeDef]],  # (1)
    ...
    Encryption: NotRequired[CmafEncryptionSettingsPaginatorTypeDef],  # (6)
...
1. See [:material-code-braces: CmafAdditionalManifestPaginatorTypeDef](./type_defs.md#cmafadditionalmanifestpaginatortypedef) 
...
6. See [:material-code-braces: CmafEncryptionSettingsPaginatorTypeDef](./type_defs.md#cmafencryptionsettingspaginatortypedef) 
...
```python
# DashIsoGroupSettingsPaginatorTypeDef definition

class DashIsoGroupSettingsPaginatorTypeDef(TypedDict):
    AdditionalManifests: NotRequired[List[DashAdditionalManifestPaginatorTypeDef]],  # (1)
    ...
    Encryption: NotRequired[DashIsoEncryptionSettingsPaginatorTypeDef],  # (5)
    FragmentLength: NotRequired[int],
...
1. See [:material-code-braces: DashAdditionalManifestPaginatorTypeDef](./type_defs.md#dashadditionalmanifestpaginatortypedef) 
...
5. See [:material-code-braces: DashIsoEncryptionSettingsPaginatorTypeDef](./type_defs.md#dashisoencryptionsettingspaginatortypedef) 
...
```python
# HlsGroupSettingsPaginatorTypeDef definition

class HlsGroupSettingsPaginatorTypeDef(TypedDict):
    AdMarkers: NotRequired[List[HlsAdMarkersType]],  # (1)
    AdditionalManifests: NotRequired[List[HlsAdditionalManifestPaginatorTypeDef]],  # (2)
    ...
    Encryption: NotRequired[HlsEncryptionSettingsPaginatorTypeDef],  # (11)
...
2. See [:material-code-braces: HlsAdditionalManifestPaginatorTypeDef](./type_defs.md#hlsadditionalmanifestpaginatortypedef) 
...
11. See [:material-code-braces: HlsEncryptionSettingsPaginatorTypeDef](./type_defs.md#hlsencryptionsettingspaginatortypedef) 
...
```python
# MsSmoothGroupSettingsPaginatorTypeDef definition

class MsSmoothGroupSettingsPaginatorTypeDef(TypedDict):
    AdditionalManifests: NotRequired[List[MsSmoothAdditionalManifestPaginatorTypeDef]],  # (1)
    ...
    Encryption: NotRequired[MsSmoothEncryptionSettingsPaginatorTypeDef],  # (4)
    FragmentLength: NotRequired[int],
...
1. See [:material-code-braces: MsSmoothAdditionalManifestPaginatorTypeDef](./type_defs.md#mssmoothadditionalmanifestpaginatortypedef) 
...
4. See [:material-code-braces: MsSmoothEncryptionSettingsPaginatorTypeDef](./type_defs.md#mssmoothencryptionsettingspaginatortypedef) 
...
```python
# VideoDescriptionPaginatorTypeDef definition

class VideoDescriptionPaginatorTypeDef(TypedDict):
    ...
    VideoPreprocessors: NotRequired[VideoPreprocessorPaginatorTypeDef],  # (11)
    Width: NotRequired[int],
```
...
11. See [:material-code-braces: VideoPreprocessorPaginatorTypeDef](./type_defs.md#videopreprocessorpaginatortypedef) 
...
```python
# InputPaginatorTypeDef definition

class InputPaginatorTypeDef(TypedDict):
    ...
    AudioSelectorGroups: NotRequired[Dict[str, AudioSelectorGroupPaginatorTypeDef]],  # (3)
    AudioSelectors: NotRequired[Dict[str, AudioSelectorPaginatorTypeDef]],  # (4)
    ...
    ImageInserter: NotRequired[ImageInserterPaginatorTypeDef],  # (11)
    ...
    VideoOverlays: NotRequired[List[VideoOverlayPaginatorTypeDef]],  # (18)
...
3. See [:material-code-braces: AudioSelectorGroupPaginatorTypeDef](./type_defs.md#audioselectorgrouppaginatortypedef) 
4. See [:material-code-braces: AudioSelectorPaginatorTypeDef](./type_defs.md#audioselectorpaginatortypedef) 
...
11. See [:material-code-braces: ImageInserterPaginatorTypeDef](./type_defs.md#imageinserterpaginatortypedef) 
...
18. See [:material-code-braces: VideoOverlayPaginatorTypeDef](./type_defs.md#videooverlaypaginatortypedef) 
19. See [:material-code-braces: VideoSelectorTypeDef](./type_defs.md#videoselectortypedef) 
## InputTemplatePaginatorTypeDef

```python
# InputTemplatePaginatorTypeDef definition

class InputTemplatePaginatorTypeDef(TypedDict):
    AdvancedInputFilter: NotRequired[AdvancedInputFilterType],  # (1)
    AdvancedInputFilterSettings: NotRequired[AdvancedInputFilterSettingsTypeDef],  # (2)
    AudioSelectorGroups: NotRequired[Dict[str, AudioSelectorGroupPaginatorTypeDef]],  # (3)
    AudioSelectors: NotRequired[Dict[str, AudioSelectorPaginatorTypeDef]],  # (4)
    ...
    FilterStrength: NotRequired[int],
    ImageInserter: NotRequired[ImageInserterPaginatorTypeDef],  # (10)
    ...
    TimecodeStart: NotRequired[str],
    VideoOverlays: NotRequired[List[VideoOverlayPaginatorTypeDef]],  # (16)
...
10. See [:material-code-braces: ImageInserterPaginatorTypeDef](./type_defs.md#imageinserterpaginatortypedef) 
...
16. See [:material-code-braces: VideoOverlayPaginatorTypeDef](./type_defs.md#videooverlaypaginatortypedef) 
...
class InputTemplateTypeDef(TypedDict):
    ...
    TimecodeSource: NotRequired[InputTimecodeSourceType],  # (15)
    TimecodeStart: NotRequired[str],
    VideoOverlays: NotRequired[Sequence[VideoOverlayTypeDef]],  # (16)
    VideoSelector: NotRequired[VideoSelectorTypeDef],  # (17)
```
...
14. See [:material-code-brackets: InputPsiControlType](./literals.md#inputpsicontroltype) 
15. See [:material-code-brackets: InputTimecodeSourceType](./literals.md#inputtimecodesourcetype) 
16. See [:material-code-braces: VideoOverlayTypeDef](./type_defs.md#videooverlaytypedef) 
17. See [:material-code-braces: VideoSelectorTypeDef](./type_defs.md#videoselectortypedef) 
## InputTypeDef
...
16. See [:material-code-brackets: InputTimecodeSourceType](./literals.md#inputtimecodesourcetype) 
17. See [:material-code-braces: InputVideoGeneratorTypeDef](./type_defs.md#inputvideogeneratortypedef) 
18. See [:material-code-braces: VideoOverlayTypeDef](./type_defs.md#videooverlaytypedef) 
19. See [:material-code-braces: VideoSelectorTypeDef](./type_defs.md#videoselectortypedef) 
## OutputGroupSettingsPaginatorTypeDef

```python
# OutputGroupSettingsPaginatorTypeDef definition

class OutputGroupSettingsPaginatorTypeDef(TypedDict):
    CmafGroupSettings: NotRequired[CmafGroupSettingsPaginatorTypeDef],  # (1)
    DashIsoGroupSettings: NotRequired[DashIsoGroupSettingsPaginatorTypeDef],  # (2)
    FileGroupSettings: NotRequired[FileGroupSettingsTypeDef],  # (3)
    HlsGroupSettings: NotRequired[HlsGroupSettingsPaginatorTypeDef],  # (4)
    MsSmoothGroupSettings: NotRequired[MsSmoothGroupSettingsPaginatorTypeDef],  # (5)
    Type: NotRequired[OutputGroupTypeType],  # (6)
```

1. See [:material-code-braces: CmafGroupSettingsPaginatorTypeDef](./type_defs.md#cmafgroupsettingspaginatortypedef) 
2. See [:material-code-braces: DashIsoGroupSettingsPaginatorTypeDef](./type_defs.md#dashisogroupsettingspaginatortypedef) 
3. See [:material-code-braces: FileGroupSettingsTypeDef](./type_defs.md#filegroupsettingstypedef) 
4. See [:material-code-braces: HlsGroupSettingsPaginatorTypeDef](./type_defs.md#hlsgroupsettingspaginatortypedef) 
5. See [:material-code-braces: MsSmoothGroupSettingsPaginatorTypeDef](./type_defs.md#mssmoothgroupsettingspaginatortypedef) 
...
```python
# OutputPaginatorTypeDef definition

class OutputPaginatorTypeDef(TypedDict):
    AudioDescriptions: NotRequired[List[AudioDescriptionPaginatorTypeDef]],  # (1)
    CaptionDescriptions: NotRequired[List[CaptionDescriptionPaginatorTypeDef]],  # (2)
    ContainerSettings: NotRequired[ContainerSettingsPaginatorTypeDef],  # (3)
    Extension: NotRequired[str],
    NameModifier: NotRequired[str],
    OutputSettings: NotRequired[OutputSettingsTypeDef],  # (4)
    Preset: NotRequired[str],
    VideoDescription: NotRequired[VideoDescriptionPaginatorTypeDef],  # (5)
```

1. See [:material-code-braces: AudioDescriptionPaginatorTypeDef](./type_defs.md#audiodescriptionpaginatortypedef) 
2. See [:material-code-braces: CaptionDescriptionPaginatorTypeDef](./type_defs.md#captiondescriptionpaginatortypedef) 
3. See [:material-code-braces: ContainerSettingsPaginatorTypeDef](./type_defs.md#containersettingspaginatortypedef) 
4. See [:material-code-braces: OutputSettingsTypeDef](./type_defs.md#outputsettingstypedef) 
5. See [:material-code-braces: VideoDescriptionPaginatorTypeDef](./type_defs.md#videodescriptionpaginatortypedef) 
## PresetSettingsPaginatorTypeDef

```python
# PresetSettingsPaginatorTypeDef definition

class PresetSettingsPaginatorTypeDef(TypedDict):
    AudioDescriptions: NotRequired[List[AudioDescriptionPaginatorTypeDef]],  # (1)
    CaptionDescriptions: NotRequired[List[CaptionDescriptionPresetPaginatorTypeDef]],  # (2)
    ContainerSettings: NotRequired[ContainerSettingsPaginatorTypeDef],  # (3)
    VideoDescription: NotRequired[VideoDescriptionPaginatorTypeDef],  # (4)
```

1. See [:material-code-braces: AudioDescriptionPaginatorTypeDef](./type_defs.md#audiodescriptionpaginatortypedef) 
2. See [:material-code-braces: CaptionDescriptionPresetPaginatorTypeDef](./type_defs.md#captiondescriptionpresetpaginatortypedef) 
3. See [:material-code-braces: ContainerSettingsPaginatorTypeDef](./type_defs.md#containersettingspaginatortypedef) 
4. See [:material-code-braces: VideoDescriptionPaginatorTypeDef](./type_defs.md#videodescriptionpaginatortypedef) 
## OutputTypeDef
...
```python
# OutputGroupPaginatorTypeDef definition

class OutputGroupPaginatorTypeDef(TypedDict):
    AutomatedEncodingSettings: NotRequired[AutomatedEncodingSettingsPaginatorTypeDef],  # (1)
    CustomName: NotRequired[str],
    Name: NotRequired[str],
    OutputGroupSettings: NotRequired[OutputGroupSettingsPaginatorTypeDef],  # (2)
    Outputs: NotRequired[List[OutputPaginatorTypeDef]],  # (3)
```

1. See [:material-code-braces: AutomatedEncodingSettingsPaginatorTypeDef](./type_defs.md#automatedencodingsettingspaginatortypedef) 
2. See [:material-code-braces: OutputGroupSettingsPaginatorTypeDef](./type_defs.md#outputgroupsettingspaginatortypedef) 
3. See [:material-code-braces: OutputPaginatorTypeDef](./type_defs.md#outputpaginatortypedef) 
...
class PresetPaginatorTypeDef(TypedDict):
    Name: str,
    Settings: PresetSettingsPaginatorTypeDef,  # (1)
    Arn: NotRequired[str],
    Category: NotRequired[str],
    CreatedAt: NotRequired[datetime],
    Description: NotRequired[str],
...
1. See [:material-code-braces: PresetSettingsPaginatorTypeDef](./type_defs.md#presetsettingspaginatortypedef) 
...
```python
# JobSettingsPaginatorTypeDef definition

class JobSettingsPaginatorTypeDef(TypedDict):
    ...
    Inputs: NotRequired[List[InputPaginatorTypeDef]],  # (5)
    ...
    OutputGroups: NotRequired[List[OutputGroupPaginatorTypeDef]],  # (10)
    TimecodeConfig: NotRequired[TimecodeConfigTypeDef],  # (11)
    TimedMetadataInsertion: NotRequired[TimedMetadataInsertionPaginatorTypeDef],  # (12)
```
...
5. See [:material-code-braces: InputPaginatorTypeDef](./type_defs.md#inputpaginatortypedef) 
...
10. See [:material-code-braces: OutputGroupPaginatorTypeDef](./type_defs.md#outputgrouppaginatortypedef) 
11. See [:material-code-braces: TimecodeConfigTypeDef](./type_defs.md#timecodeconfigtypedef) 
12. See [:material-code-braces: TimedMetadataInsertionPaginatorTypeDef](./type_defs.md#timedmetadatainsertionpaginatortypedef) 
## JobTemplateSettingsPaginatorTypeDef

```python
# JobTemplateSettingsPaginatorTypeDef definition

class JobTemplateSettingsPaginatorTypeDef(TypedDict):
    AdAvailOffset: NotRequired[int],
    AvailBlanking: NotRequired[AvailBlankingTypeDef],  # (1)
    ColorConversion3DLUTSettings: NotRequired[List[ColorConversion3DLUTSettingTypeDef]],  # (2)
    Esam: NotRequired[EsamSettingsTypeDef],  # (3)
    ExtendedDataServices: NotRequired[ExtendedDataServicesTypeDef],  # (4)
    FollowSource: NotRequired[int],
    Inputs: NotRequired[List[InputTemplatePaginatorTypeDef]],  # (5)
    KantarWatermark: NotRequired[KantarWatermarkSettingsTypeDef],  # (6)
    MotionImageInserter: NotRequired[MotionImageInserterTypeDef],  # (7)
    NielsenConfiguration: NotRequired[NielsenConfigurationTypeDef],  # (8)
    NielsenNonLinearWatermark: NotRequired[NielsenNonLinearWatermarkSettingsTypeDef],  # (9)
...
3. See [:material-code-braces: EsamSettingsTypeDef](./type_defs.md#esamsettingstypedef) 
4. See [:material-code-braces: ExtendedDataServicesTypeDef](./type_defs.md#extendeddataservicestypedef) 
5. See [:material-code-braces: InputTemplatePaginatorTypeDef](./type_defs.md#inputtemplatepaginatortypedef) 
6. See [:material-code-braces: KantarWatermarkSettingsTypeDef](./type_defs.md#kantarwatermarksettingstypedef) 
7. See [:material-code-braces: MotionImageInserterTypeDef](./type_defs.md#motionimageinsertertypedef) 
8. See [:material-code-braces: NielsenConfigurationTypeDef](./type_defs.md#nielsenconfigurationtypedef) 
9. See [:material-code-braces: NielsenNonLinearWatermarkSettingsTypeDef](./type_defs.md#nielsennonlinearwatermarksettingstypedef) 
...
1. See [:material-code-braces: PresetPaginatorTypeDef](./type_defs.md#presetpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
## JobSettingsTypeDef
...
class JobPaginatorTypeDef(TypedDict):
    Role: str,
    Settings: JobSettingsPaginatorTypeDef,  # (9)
...
9. See [:material-code-braces: JobSettingsPaginatorTypeDef](./type_defs.md#jobsettingspaginatortypedef) 
...
class JobTemplatePaginatorTypeDef(TypedDict):
    Name: str,
    Settings: JobTemplateSettingsPaginatorTypeDef,  # (3)
    AccelerationSettings: NotRequired[AccelerationSettingsTypeDef],  # (1)
    Arn: NotRequired[str],
    Category: NotRequired[str],
    CreatedAt: NotRequired[datetime],
...
3. See [:material-code-braces: JobTemplateSettingsPaginatorTypeDef](./type_defs.md#jobtemplatesettingspaginatortypedef) 
...
class ListJobTemplatesResponsePaginatorTypeDef(TypedDict):
    JobTemplates: List[JobTemplatePaginatorTypeDef],  # (1)
    NextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```
