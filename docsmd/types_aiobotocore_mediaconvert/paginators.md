...
) -> AsyncIterator[ListJobTemplatesResponsePaginatorTypeDef]:  # (4)
    ...
```
...
4. See [:material-code-braces: ListJobTemplatesResponsePaginatorTypeDef](./type_defs.md#listjobtemplatesresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> AsyncIterator[ListJobsResponsePaginatorTypeDef]:  # (4)
    ...
```
...
3. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
4. See [:material-code-braces: ListJobsResponsePaginatorTypeDef](./type_defs.md#listjobsresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    Order: OrderType = ...,  # (2)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> AsyncIterator[ListPresetsResponsePaginatorTypeDef]:  # (4)
    ...
```
...
2. See [:material-code-brackets: OrderType](./literals.md#ordertype) 
3. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
4. See [:material-code-braces: ListPresetsResponsePaginatorTypeDef](./type_defs.md#listpresetsresponsepaginatortypedef) 
