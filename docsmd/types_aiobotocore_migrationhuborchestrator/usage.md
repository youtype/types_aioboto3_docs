...
async with session.client("migrationhuborchestrator") as client:  # (1)
    kwargs: CreateMigrationWorkflowRequestRequestTypeDef = {...}  # (2)
    result: CreateMigrationWorkflowResponseTypeDef = await client.create_workflow(**kwargs)  # (3)
```

1. client: [MigrationHubOrchestratorClient](./client.md)
2. kwargs: [:material-code-braces: CreateMigrationWorkflowRequestRequestTypeDef](./type_defs.md#createmigrationworkflowrequestrequesttypedef) 
3. result: [:material-code-braces: CreateMigrationWorkflowResponseTypeDef](./type_defs.md#createmigrationworkflowresponsetypedef) 
