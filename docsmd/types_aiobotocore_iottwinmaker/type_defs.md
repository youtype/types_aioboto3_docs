...
class DataTypeTypeDef(TypedDict):
    ...
    allowedValues: NotRequired[Sequence[DataValueTypeDef]],  # (2)
...
class SourceConfigurationTypeDef(TypedDict):
    ...
    iotSiteWiseConfiguration: NotRequired[IotSiteWiseSourceConfigurationTypeDef],  # (3)
    iotTwinMakerConfiguration: NotRequired[IotTwinMakerSourceConfigurationTypeDef],  # (4)
```

1. See [:material-code-brackets: SourceTypeType](./literals.md#sourcetypetype) 
2. See [:material-code-braces: S3SourceConfigurationTypeDef](./type_defs.md#s3sourceconfigurationtypedef) 
3. See [:material-code-braces: IotSiteWiseSourceConfigurationTypeDef](./type_defs.md#iotsitewisesourceconfigurationtypedef) 
4. See [:material-code-braces: IotTwinMakerSourceConfigurationTypeDef](./type_defs.md#iottwinmakersourceconfigurationtypedef) 
...
class GetMetadataTransferJobResponseTypeDef(TypedDict):
    ...
    arn: str,
    description: str,
    sources: List[SourceConfigurationTypeDef],  # (1)
    destination: DestinationConfigurationTypeDef,  # (2)
