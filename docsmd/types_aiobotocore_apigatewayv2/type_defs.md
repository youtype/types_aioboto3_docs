...
```python
# ApiPaginatorTypeDef definition

class ApiPaginatorTypeDef(TypedDict):
    Name: str,
    ...
    CorsConfiguration: NotRequired[CorsPaginatorTypeDef],  # (1)
    CreatedDate: NotRequired[datetime],
    Description: NotRequired[str],
...
```python
# AuthorizerPaginatorTypeDef definition

class AuthorizerPaginatorTypeDef(TypedDict):
    Name: str,
    ...
    JwtConfiguration: NotRequired[JWTConfigurationPaginatorTypeDef],  # (2)
```

1. See [:material-code-brackets: AuthorizerTypeType](./literals.md#authorizertypetype) 
2. See [:material-code-braces: JWTConfigurationPaginatorTypeDef](./type_defs.md#jwtconfigurationpaginatortypedef) 
## AuthorizerTypeDef
...
class DomainNamePaginatorTypeDef(TypedDict):
    ...
    DomainNameConfigurations: NotRequired[List[DomainNameConfigurationPaginatorTypeDef]],  # (1)
    MutualTlsAuthentication: NotRequired[MutualTlsAuthenticationTypeDef],  # (2)
    Tags: NotRequired[Dict[str, str]],
```

1. See [:material-code-braces: DomainNameConfigurationPaginatorTypeDef](./type_defs.md#domainnameconfigurationpaginatortypedef) 
...
```python
# GetApisResponsePaginatorTypeDef definition

class GetApisResponsePaginatorTypeDef(TypedDict):
    Items: List[ApiPaginatorTypeDef],  # (1)
    NextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: ApiPaginatorTypeDef](./type_defs.md#apipaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
```python
# GetAuthorizersResponsePaginatorTypeDef definition

class GetAuthorizersResponsePaginatorTypeDef(TypedDict):
    Items: List[AuthorizerPaginatorTypeDef],  # (1)
    NextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: AuthorizerPaginatorTypeDef](./type_defs.md#authorizerpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
```python
# GetDomainNamesResponsePaginatorTypeDef definition

class GetDomainNamesResponsePaginatorTypeDef(TypedDict):
    Items: List[DomainNamePaginatorTypeDef],  # (1)
    NextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: DomainNamePaginatorTypeDef](./type_defs.md#domainnamepaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
