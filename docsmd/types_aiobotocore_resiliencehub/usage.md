...
async with session.client("resiliencehub") as client:  # (1)
    kwargs: AcceptResourceGroupingRecommendationsRequestRequestTypeDef = {...}  # (2)
...
1. client: [ResilienceHubClient](./client.md)
2. kwargs: [:material-code-braces: AcceptResourceGroupingRecommendationsRequestRequestTypeDef](./type_defs.md#acceptresourcegroupingrecommendationsrequestrequesttypedef) 
