...
class CreateKxDataviewRequestRequestTypeDef(TypedDict):
    ...
    availabilityZoneId: NotRequired[str],
    changesetId: NotRequired[str],
    segmentConfigurations: NotRequired[Sequence[KxDataviewSegmentConfigurationTypeDef]],  # (2)
...
2. See [:material-code-braces: KxDataviewSegmentConfigurationTypeDef](./type_defs.md#kxdataviewsegmentconfigurationtypedef) 
...
class CreateKxDataviewResponseTypeDef(TypedDict):
    ...
    availabilityZoneId: str,
    changesetId: str,
    segmentConfigurations: List[KxDataviewSegmentConfigurationTypeDef],  # (2)
    description: str,
    autoUpdate: bool,
    createdTimestamp: datetime,
    lastModifiedTimestamp: datetime,
...
class KxDataviewActiveVersionTypeDef(TypedDict):
    changesetId: NotRequired[str],
    segmentConfigurations: NotRequired[List[KxDataviewSegmentConfigurationTypeDef]],  # (1)
...
class KxDataviewListEntryTypeDef(TypedDict):
    ...
    availabilityZoneId: NotRequired[str],
    changesetId: NotRequired[str],
    segmentConfigurations: NotRequired[List[KxDataviewSegmentConfigurationTypeDef]],  # (2)
...
class KxDatabaseConfigurationTypeDef(TypedDict):
    ...
    changesetId: NotRequired[str],
    dataviewName: NotRequired[str],
    dataviewConfiguration: NotRequired[KxDataviewConfigurationTypeDef],  # (2)
```

1. See [:material-code-braces: KxDatabaseCacheConfigurationTypeDef](./type_defs.md#kxdatabasecacheconfigurationtypedef) 
2. See [:material-code-braces: KxDataviewConfigurationTypeDef](./type_defs.md#kxdataviewconfigurationtypedef) 
...
class CreateKxClusterRequestRequestTypeDef(TypedDict):
    ...
    databases: NotRequired[Sequence[KxDatabaseConfigurationTypeDef]],  # (5)
...
5. See [:material-code-braces: KxDatabaseConfigurationTypeDef](./type_defs.md#kxdatabaseconfigurationtypedef) 
...
class CreateKxClusterResponseTypeDef(TypedDict):
    ...
    tickerplantLogConfiguration: TickerplantLogConfigurationTypeDef,  # (3)
    volumes: List[VolumeTypeDef],  # (4)
    databases: List[KxDatabaseConfigurationTypeDef],  # (5)
    ...
    releaseLabel: str,
    vpcConfiguration: VpcConfigurationTypeDef,  # (9)
...
1. See [:material-code-brackets: KxClusterStatusType](./literals.md#kxclusterstatustype) 
2. See [:material-code-brackets: KxClusterTypeType](./literals.md#kxclustertypetype) 
3. See [:material-code-braces: TickerplantLogConfigurationTypeDef](./type_defs.md#tickerplantlogconfigurationtypedef) 
