...
async with session.client("kafka") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListClusterOperationsResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [KafkaClient](./client.md)
2. paginator: [ListClusterOperationsPaginator](./paginators.md#listclusteroperationspaginator)
3. item: [:material-code-braces: ListClusterOperationsResponsePaginatorTypeDef](./type_defs.md#listclusteroperationsresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    ClusterArn: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListClusterOperationsResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListClusterOperationsResponsePaginatorTypeDef](./type_defs.md#listclusteroperationsresponsepaginatortypedef) 
...
async with session.client("kafka") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListClustersResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [KafkaClient](./client.md)
2. paginator: [ListClustersPaginator](./paginators.md#listclusterspaginator)
3. item: [:material-code-braces: ListClustersResponsePaginatorTypeDef](./type_defs.md#listclustersresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListClustersResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListClustersResponsePaginatorTypeDef](./type_defs.md#listclustersresponsepaginatortypedef) 
...
async with session.client("kafka") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListClustersV2ResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [KafkaClient](./client.md)
2. paginator: [ListClustersV2Paginator](./paginators.md#listclustersv2paginator)
3. item: [:material-code-braces: ListClustersV2ResponsePaginatorTypeDef](./type_defs.md#listclustersv2responsepaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListClustersV2ResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListClustersV2ResponsePaginatorTypeDef](./type_defs.md#listclustersv2responsepaginatortypedef) 
