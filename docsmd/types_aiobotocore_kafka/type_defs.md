...
class KafkaClusterDescriptionTypeDef(TypedDict):
    AmazonMskCluster: NotRequired[AmazonMskClusterTypeDef],  # (1)
    KafkaClusterAlias: NotRequired[str],
    VpcConfig: NotRequired[KafkaClusterClientVpcConfigTypeDef],  # (2)
```

1. See [:material-code-braces: AmazonMskClusterTypeDef](./type_defs.md#amazonmskclustertypedef) 
2. See [:material-code-braces: KafkaClusterClientVpcConfigTypeDef](./type_defs.md#kafkaclusterclientvpcconfigtypedef) 
## KafkaClusterTypeDef
...
class KafkaClusterTypeDef(TypedDict):
    ...
    VpcConfig: KafkaClusterClientVpcConfigTypeDef,  # (2)
```
...
class ReplicationInfoDescriptionTypeDef(TypedDict):
    ConsumerGroupReplication: NotRequired[ConsumerGroupReplicationTypeDef],  # (1)
    SourceKafkaClusterAlias: NotRequired[str],
    TargetCompressionType: NotRequired[TargetCompressionTypeType],  # (2)
    TargetKafkaClusterAlias: NotRequired[str],
    TopicReplication: NotRequired[TopicReplicationTypeDef],  # (3)
```
...
3. See [:material-code-braces: TopicReplicationTypeDef](./type_defs.md#topicreplicationtypedef) 
...
class ReplicationInfoTypeDef(TypedDict):
    ConsumerGroupReplication: ConsumerGroupReplicationTypeDef,  # (1)
    SourceKafkaClusterArn: str,
    TargetCompressionType: TargetCompressionTypeType,  # (2)
    TargetKafkaClusterArn: str,
    TopicReplication: TopicReplicationTypeDef,  # (3)
```
...
```python
# ClientAuthenticationPaginatorTypeDef definition

class ClientAuthenticationPaginatorTypeDef(TypedDict):
    Sasl: NotRequired[SaslTypeDef],  # (1)
    Tls: NotRequired[TlsPaginatorTypeDef],  # (2)
    Unauthenticated: NotRequired[UnauthenticatedTypeDef],  # (3)
```

1. See [:material-code-braces: SaslTypeDef](./type_defs.md#sasltypedef) 
2. See [:material-code-braces: TlsPaginatorTypeDef](./type_defs.md#tlspaginatortypedef) 
...
```python
# ServerlessPaginatorTypeDef definition

class ServerlessPaginatorTypeDef(TypedDict):
    VpcConfigs: List[VpcConfigPaginatorTypeDef],  # (1)
...
```python
# BrokerNodeGroupInfoPaginatorTypeDef definition

class BrokerNodeGroupInfoPaginatorTypeDef(TypedDict):
    ClientSubnets: List[str],
    InstanceType: str,
...
```python
# MutableClusterInfoPaginatorTypeDef definition

class MutableClusterInfoPaginatorTypeDef(TypedDict):
    ...
    InstanceType: NotRequired[str],
    ClientAuthentication: NotRequired[ClientAuthenticationPaginatorTypeDef],  # (6)
...
6. See [:material-code-braces: ClientAuthenticationPaginatorTypeDef](./type_defs.md#clientauthenticationpaginatortypedef) 
...
```python
# ClusterInfoPaginatorTypeDef definition

class ClusterInfoPaginatorTypeDef(TypedDict):
    ActiveOperationArn: NotRequired[str],
    BrokerNodeGroupInfo: NotRequired[BrokerNodeGroupInfoPaginatorTypeDef],  # (1)
    ClientAuthentication: NotRequired[ClientAuthenticationPaginatorTypeDef],  # (2)
    ClusterArn: NotRequired[str],
...
1. See [:material-code-braces: BrokerNodeGroupInfoPaginatorTypeDef](./type_defs.md#brokernodegroupinfopaginatortypedef) 
2. See [:material-code-braces: ClientAuthenticationPaginatorTypeDef](./type_defs.md#clientauthenticationpaginatortypedef) 
...
```python
# ProvisionedPaginatorTypeDef definition

class ProvisionedPaginatorTypeDef(TypedDict):
    BrokerNodeGroupInfo: BrokerNodeGroupInfoPaginatorTypeDef,  # (1)
    NumberOfBrokerNodes: int,
    CurrentBrokerSoftwareInfo: NotRequired[BrokerSoftwareInfoTypeDef],  # (2)
    ClientAuthentication: NotRequired[ClientAuthenticationPaginatorTypeDef],  # (3)
    EncryptionInfo: NotRequired[EncryptionInfoTypeDef],  # (4)
    EnhancedMonitoring: NotRequired[EnhancedMonitoringType],  # (5)
...
3. See [:material-code-braces: ClientAuthenticationPaginatorTypeDef](./type_defs.md#clientauthenticationpaginatortypedef) 
4. See [:material-code-braces: EncryptionInfoTypeDef](./type_defs.md#encryptioninfotypedef) 
5. See [:material-code-brackets: EnhancedMonitoringType](./literals.md#enhancedmonitoringtype) 
...
```python
# ClusterOperationInfoPaginatorTypeDef definition

class ClusterOperationInfoPaginatorTypeDef(TypedDict):
    ...
    OperationType: NotRequired[str],
    SourceClusterInfo: NotRequired[MutableClusterInfoPaginatorTypeDef],  # (3)
    TargetClusterInfo: NotRequired[MutableClusterInfoPaginatorTypeDef],  # (3)
...
3. See [:material-code-braces: MutableClusterInfoPaginatorTypeDef](./type_defs.md#mutableclusterinfopaginatortypedef) 
4. See [:material-code-braces: MutableClusterInfoPaginatorTypeDef](./type_defs.md#mutableclusterinfopaginatortypedef) 
...
```python
# ListClustersResponsePaginatorTypeDef definition

class ListClustersResponsePaginatorTypeDef(TypedDict):
    ClusterInfoList: List[ClusterInfoPaginatorTypeDef],  # (1)
    NextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: ClusterInfoPaginatorTypeDef](./type_defs.md#clusterinfopaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
## ClusterPaginatorTypeDef

```python
# ClusterPaginatorTypeDef definition

class ClusterPaginatorTypeDef(TypedDict):
    ActiveOperationArn: NotRequired[str],
    ClusterType: NotRequired[ClusterTypeType],  # (1)
    ClusterArn: NotRequired[str],
    ClusterName: NotRequired[str],
    ...
    Tags: NotRequired[Dict[str, str]],
    Provisioned: NotRequired[ProvisionedPaginatorTypeDef],  # (4)
    Serverless: NotRequired[ServerlessPaginatorTypeDef],  # (5)
```
...
4. See [:material-code-braces: ProvisionedPaginatorTypeDef](./type_defs.md#provisionedpaginatortypedef) 
5. See [:material-code-braces: ServerlessPaginatorTypeDef](./type_defs.md#serverlesspaginatortypedef) 
...
```python
# ListClusterOperationsResponsePaginatorTypeDef definition

class ListClusterOperationsResponsePaginatorTypeDef(TypedDict):
    ClusterOperationInfoList: List[ClusterOperationInfoPaginatorTypeDef],  # (1)
    NextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: ClusterOperationInfoPaginatorTypeDef](./type_defs.md#clusteroperationinfopaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
```python
# ListClustersV2ResponsePaginatorTypeDef definition

class ListClustersV2ResponsePaginatorTypeDef(TypedDict):
    ClusterInfoList: List[ClusterPaginatorTypeDef],  # (1)
    NextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: ClusterPaginatorTypeDef](./type_defs.md#clusterpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
