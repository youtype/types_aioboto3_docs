...
Type annotations and code completion for `#!python session.client("inspector2").close` method.
...
1. See [:material-code-braces: GetCisScanReportResponseTypeDef](./type_defs.md#getcisscanreportresponsetypedef) 
