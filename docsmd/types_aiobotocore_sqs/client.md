...
Type annotations and code completion for `#!python session.client("sqs").delete_message_batch` method.
...
Type annotations and code completion for `#!python session.client("sqs").get_paginator` method with overloads.
