...
3. item: [:material-code-braces: ListActiveViolationsResponsePaginatorTypeDef](./type_defs.md#listactiveviolationsresponsepaginatortypedef) 
...
) -> AsyncIterator[ListActiveViolationsResponsePaginatorTypeDef]:  # (4)
    ...
```
...
4. See [:material-code-braces: ListActiveViolationsResponsePaginatorTypeDef](./type_defs.md#listactiveviolationsresponsepaginatortypedef) 
...
async with session.client("iot") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListDetectMitigationActionsTasksResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [IoTClient](./client.md)
2. paginator: [ListDetectMitigationActionsTasksPaginator](./paginators.md#listdetectmitigationactionstaskspaginator)
3. item: [:material-code-braces: ListDetectMitigationActionsTasksResponsePaginatorTypeDef](./type_defs.md#listdetectmitigationactionstasksresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    endTime: Union[datetime, str],
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListDetectMitigationActionsTasksResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListDetectMitigationActionsTasksResponsePaginatorTypeDef](./type_defs.md#listdetectmitigationactionstasksresponsepaginatortypedef) 
...
async with session.client("iot") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListMetricValuesResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [IoTClient](./client.md)
2. paginator: [ListMetricValuesPaginator](./paginators.md#listmetricvaluespaginator)
3. item: [:material-code-braces: ListMetricValuesResponsePaginatorTypeDef](./type_defs.md#listmetricvaluesresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[ListMetricValuesResponsePaginatorTypeDef]:  # (3)
    ...
```

1. See [:material-code-brackets: DimensionValueOperatorType](./literals.md#dimensionvalueoperatortype) 
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
3. See [:material-code-braces: ListMetricValuesResponsePaginatorTypeDef](./type_defs.md#listmetricvaluesresponsepaginatortypedef) 
...
Type annotations and code completion for `#!python session.client("iot").get_paginator("list_thing_groups")`.
...
Type annotations and code completion for `#!python session.client("iot").get_paginator("list_thing_groups_for_thing")`.
...
Type annotations and code completion for `#!python session.client("iot").get_paginator("list_thing_principals")`.
...
Type annotations and code completion for `#!python session.client("iot").get_paginator("list_thing_registration_task_reports")`.
...
Type annotations and code completion for `#!python session.client("iot").get_paginator("list_thing_registration_tasks")`.
...
Type annotations and code completion for `#!python session.client("iot").get_paginator("list_thing_types")`.
...
async with session.client("iot") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListThingTypesResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [IoTClient](./client.md)
2. paginator: [ListThingTypesPaginator](./paginators.md#listthingtypespaginator)
3. item: [:material-code-braces: ListThingTypesResponsePaginatorTypeDef](./type_defs.md#listthingtypesresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    thingTypeName: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListThingTypesResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListThingTypesResponsePaginatorTypeDef](./type_defs.md#listthingtypesresponsepaginatortypedef) 
...
Type annotations and code completion for `#!python session.client("iot").get_paginator("list_things")`.
...
Type annotations and code completion for `#!python session.client("iot").get_paginator("list_things_in_billing_group")`.
...
Type annotations and code completion for `#!python session.client("iot").get_paginator("list_things_in_thing_group")`.
...
Type annotations and code completion for `#!python session.client("iot").get_paginator("list_topic_rule_destinations")`.
...
Type annotations and code completion for `#!python session.client("iot").get_paginator("list_topic_rules")`.
...
Type annotations and code completion for `#!python session.client("iot").get_paginator("list_v2_logging_levels")`.
...
Type annotations and code completion for `#!python session.client("iot").get_paginator("list_violation_events")`.
...
async with session.client("iot") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListViolationEventsResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [IoTClient](./client.md)
2. paginator: [ListViolationEventsPaginator](./paginators.md#listviolationeventspaginator)
3. item: [:material-code-braces: ListViolationEventsResponsePaginatorTypeDef](./type_defs.md#listviolationeventsresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    verificationState: VerificationStateType = ...,  # (2)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> AsyncIterator[ListViolationEventsResponsePaginatorTypeDef]:  # (4)
    ...
```
...
2. See [:material-code-brackets: VerificationStateType](./literals.md#verificationstatetype) 
3. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
4. See [:material-code-braces: ListViolationEventsResponsePaginatorTypeDef](./type_defs.md#listviolationeventsresponsepaginatortypedef) 
