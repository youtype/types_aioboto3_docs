...
Install `types-aioboto3` for `IoT` service.

```bash
# install with aioboto3 type annotations
python -m pip install 'types-aioboto3[iot]'


# Lite version does not provide session.client/resource overloads
# it is more RAM-friendly, but requires explicit type annotations
python -m pip install 'types-aioboto3-lite[iot]'
...
Type annotations and code completion for  `#!python session.client("iot")` as [IoTClient](./client.md)
...
from `#!python session.client("iot").get_paginator("...")`.
...
- [MetricValuePaginatorTypeDef](./type_defs.md#metricvaluepaginatortypedef)
...
- [AddThingsToThingGroupParamsPaginatorTypeDef](./type_defs.md#addthingstothinggroupparamspaginatortypedef)
...
- [ThingTypePropertiesPaginatorTypeDef](./type_defs.md#thingtypepropertiespaginatortypedef)
...
- [MetricDatumPaginatorTypeDef](./type_defs.md#metricdatumpaginatortypedef)
...
- [BehaviorCriteriaPaginatorTypeDef](./type_defs.md#behaviorcriteriapaginatortypedef)
...
- [MitigationActionParamsPaginatorTypeDef](./type_defs.md#mitigationactionparamspaginatortypedef)
...
- [ThingTypeDefinitionPaginatorTypeDef](./type_defs.md#thingtypedefinitionpaginatortypedef)
...
- [ListMetricValuesResponsePaginatorTypeDef](./type_defs.md#listmetricvaluesresponsepaginatortypedef)
...
- [BehaviorPaginatorTypeDef](./type_defs.md#behaviorpaginatortypedef)
...
- [MitigationActionPaginatorTypeDef](./type_defs.md#mitigationactionpaginatortypedef)
...
- [ListThingTypesResponsePaginatorTypeDef](./type_defs.md#listthingtypesresponsepaginatortypedef)
...
- [ActiveViolationPaginatorTypeDef](./type_defs.md#activeviolationpaginatortypedef)
- [ViolationEventPaginatorTypeDef](./type_defs.md#violationeventpaginatortypedef)
...
- [DetectMitigationActionsTaskSummaryPaginatorTypeDef](./type_defs.md#detectmitigationactionstasksummarypaginatortypedef)
...
- [ListActiveViolationsResponsePaginatorTypeDef](./type_defs.md#listactiveviolationsresponsepaginatortypedef)
- [ListViolationEventsResponsePaginatorTypeDef](./type_defs.md#listviolationeventsresponsepaginatortypedef)
...
- [ListDetectMitigationActionsTasksResponsePaginatorTypeDef](./type_defs.md#listdetectmitigationactionstasksresponsepaginatortypedef)
