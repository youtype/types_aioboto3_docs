...
client: EKSClient
async with session.client("eks") as client:  # (1)
    kwargs: AssociateAccessPolicyRequestRequestTypeDef = {...}  # (2)
    result: AssociateAccessPolicyResponseTypeDef = await client.associate_access_policy(**kwargs)  # (3)
```

1. client: [EKSClient](./client.md)
2. kwargs: [:material-code-braces: AssociateAccessPolicyRequestRequestTypeDef](./type_defs.md#associateaccesspolicyrequestrequesttypedef) 
