...
1. See [:material-code-braces: AccessScopePaginatorTypeDef](./type_defs.md#accessscopepaginatortypedef) 
...
1. See [:material-code-braces: AssociatedAccessPolicyPaginatorTypeDef](./type_defs.md#associatedaccesspolicypaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
