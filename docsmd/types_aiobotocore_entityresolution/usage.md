...
async with session.client("entityresolution") as client:  # (1)
    result = await client.create_id_mapping_workflow()  # (2)
```

1. client: [EntityResolutionClient](./client.md)
2. result: [:material-code-braces: CreateIdMappingWorkflowOutputTypeDef](./type_defs.md#createidmappingworkflowoutputtypedef) 
...
from types_aiobotocore_entityresolution.type_defs import CreateIdMappingWorkflowInputRequestTypeDef
...
async with session.client("entityresolution") as client:  # (1)
    kwargs: CreateIdMappingWorkflowInputRequestTypeDef = {...}  # (2)
    result: CreateIdMappingWorkflowOutputTypeDef = await client.create_id_mapping_workflow(**kwargs)  # (3)
```

1. client: [EntityResolutionClient](./client.md)
2. kwargs: [:material-code-braces: CreateIdMappingWorkflowInputRequestTypeDef](./type_defs.md#createidmappingworkflowinputrequesttypedef) 
3. result: [:material-code-braces: CreateIdMappingWorkflowOutputTypeDef](./type_defs.md#createidmappingworkflowoutputtypedef) 
