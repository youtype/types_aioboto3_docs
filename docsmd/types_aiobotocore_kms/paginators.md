...
async with session.client("kms") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListGrantsResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [KMSClient](./client.md)
2. paginator: [ListGrantsPaginator](./paginators.md#listgrantspaginator)
3. item: [:material-code-braces: ListGrantsResponsePaginatorTypeDef](./type_defs.md#listgrantsresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListGrantsResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListGrantsResponsePaginatorTypeDef](./type_defs.md#listgrantsresponsepaginatortypedef) 
