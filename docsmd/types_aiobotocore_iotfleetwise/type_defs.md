...
1. See [:material-code-braces: StructuredMessageTypeDef](./type_defs.md#structuredmessagetypedef) 
2. See [:material-code-brackets: StructuredMessageListTypeType](./literals.md#structuredmessagelisttypetype) 
...
2. See [:material-code-braces: SensorPaginatorTypeDef](./type_defs.md#sensorpaginatortypedef) 
3. See [:material-code-braces: ActuatorPaginatorTypeDef](./type_defs.md#actuatorpaginatortypedef) 
4. See [:material-code-braces: AttributePaginatorTypeDef](./type_defs.md#attributepaginatortypedef) 
...
2. See [:material-code-braces: CanSignalTypeDef](./type_defs.md#cansignaltypedef) 
3. See [:material-code-braces: ObdSignalTypeDef](./type_defs.md#obdsignaltypedef) 
4. See [:material-code-braces: MessageSignalTypeDef](./type_defs.md#messagesignaltypedef) 
...
1. See [:material-code-braces: NodePaginatorTypeDef](./type_defs.md#nodepaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
2. See [:material-code-braces: StructuredMessageListDefinitionTypeDef](./type_defs.md#structuredmessagelistdefinitiontypedef) 
3. See [:material-code-braces: StructuredMessageFieldNameAndDataTypePairTypeDef](./type_defs.md#structuredmessagefieldnameanddatatypepairtypedef) 
