...
async with session.client("amp") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListScrapersResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [PrometheusServiceClient](./client.md)
2. paginator: [ListScrapersPaginator](./paginators.md#listscraperspaginator)
3. item: [:material-code-braces: ListScrapersResponsePaginatorTypeDef](./type_defs.md#listscrapersresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListScrapersResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListScrapersResponsePaginatorTypeDef](./type_defs.md#listscrapersresponsepaginatortypedef) 
