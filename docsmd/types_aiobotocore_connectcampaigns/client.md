...
Type annotations and code completion for `#!python session.client("connectcampaigns")`
...
This class provides code completion for `#!python session.client("connectcampaigns").exceptions` structure.
...
```python
# ConnectCampaignServiceClient.exceptions type checking example
...
Type annotations and code completion for `#!python session.client("connectcampaigns").can_paginate` method.
...
Type annotations and code completion for `#!python session.client("connectcampaigns").close` method.
...
Type annotations and code completion for `#!python session.client("connectcampaigns").create_campaign` method.
...
Type annotations and code completion for `#!python session.client("connectcampaigns").delete_campaign` method.
...
Type annotations and code completion for `#!python session.client("connectcampaigns").delete_connect_instance_config` method.
...
Type annotations and code completion for `#!python session.client("connectcampaigns").delete_instance_onboarding_job` method.
...
Type annotations and code completion for `#!python session.client("connectcampaigns").describe_campaign` method.
...
Type annotations and code completion for `#!python session.client("connectcampaigns").generate_presigned_url` method.
...
Type annotations and code completion for `#!python session.client("connectcampaigns").get_campaign_state` method.
...
Type annotations and code completion for `#!python session.client("connectcampaigns").get_campaign_state_batch` method.
...
Type annotations and code completion for `#!python session.client("connectcampaigns").get_connect_instance_config` method.
...
Type annotations and code completion for `#!python session.client("connectcampaigns").get_instance_onboarding_job_status` method.
...
Type annotations and code completion for `#!python session.client("connectcampaigns").list_campaigns` method.
...
Type annotations and code completion for `#!python session.client("connectcampaigns").list_tags_for_resource` method.
...
Type annotations and code completion for `#!python session.client("connectcampaigns").pause_campaign` method.
...
Type annotations and code completion for `#!python session.client("connectcampaigns").put_dial_request_batch` method.
...
Type annotations and code completion for `#!python session.client("connectcampaigns").resume_campaign` method.
...
Type annotations and code completion for `#!python session.client("connectcampaigns").start_campaign` method.
...
Type annotations and code completion for `#!python session.client("connectcampaigns").start_instance_onboarding_job` method.
...
Type annotations and code completion for `#!python session.client("connectcampaigns").stop_campaign` method.
...
Type annotations and code completion for `#!python session.client("connectcampaigns").tag_resource` method.
...
Type annotations and code completion for `#!python session.client("connectcampaigns").untag_resource` method.
...
Type annotations and code completion for `#!python session.client("connectcampaigns").update_campaign_dialer_config` method.
...
Type annotations and code completion for `#!python session.client("connectcampaigns").update_campaign_name` method.
...
Type annotations and code completion for `#!python session.client("connectcampaigns").update_campaign_outbound_call_config` method.
...
Type annotations and code completion for `#!python session.client("connectcampaigns").__aenter__` method.
...
Type annotations and code completion for `#!python session.client("connectcampaigns").__aexit__` method.
...
Type annotations and code completion for `#!python session.client("connectcampaigns").get_paginator` method with overloads.
