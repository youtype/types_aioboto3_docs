...
Type annotations and code completion for `#!python session.client("timestream-write").close` method.
...
Type annotations and code completion for `#!python session.client("timestream-write").update_table` method.
