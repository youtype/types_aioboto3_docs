...
Type annotations and code completion for `#!python session.client("mwaa").close` method.
...
await def create_environment(
    ...
    *,
    ...
    AirflowVersion: str = ...,
    EndpointManagement: EndpointManagementType = ...,  # (2)
    EnvironmentClass: str = ...,
    KmsKey: str = ...,
    LoggingConfiguration: LoggingConfigurationInputTypeDef = ...,  # (3)
    MaxWorkers: int = ...,
    MinWorkers: int = ...,
