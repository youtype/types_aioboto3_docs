...
2. See [:material-code-brackets: EndpointManagementType](./literals.md#endpointmanagementtype) 
3. See [:material-code-braces: LoggingConfigurationInputTypeDef](./type_defs.md#loggingconfigurationinputtypedef) 
...
1. See [:material-code-brackets: EndpointManagementType](./literals.md#endpointmanagementtype) 
...
5. See [:material-code-brackets: EnvironmentStatusType](./literals.md#environmentstatustype) 
6. See [:material-code-brackets: WebserverAccessModeType](./literals.md#webserveraccessmodetype) 
