...
client: SsmSapClient
async with session.client("ssm-sap") as client:  # (1)
    kwargs: DeleteResourcePermissionInputRequestTypeDef = {...}  # (2)
    result: DeleteResourcePermissionOutputTypeDef = await client.delete_resource_permission(**kwargs)  # (3)
```

1. client: [SsmSapClient](./client.md)
2. kwargs: [:material-code-braces: DeleteResourcePermissionInputRequestTypeDef](./type_defs.md#deleteresourcepermissioninputrequesttypedef) 
