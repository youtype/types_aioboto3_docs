...
Type annotations and code completion for  `#!python session.client("apigateway")` as [APIGatewayClient](./client.md)
...
- [EndpointConfigurationPaginatorTypeDef](./type_defs.md#endpointconfigurationpaginatortypedef)
...
- [ApiStagePaginatorTypeDef](./type_defs.md#apistagepaginatortypedef)
...
- [RestApiPaginatorTypeDef](./type_defs.md#restapipaginatortypedef)
...
- [UsagePlanPaginatorTypeDef](./type_defs.md#usageplanpaginatortypedef)
...
- [RestApisPaginatorTypeDef](./type_defs.md#restapispaginatortypedef)
- [DomainNamesPaginatorTypeDef](./type_defs.md#domainnamespaginatortypedef)
...
- [UsagePlansPaginatorTypeDef](./type_defs.md#usageplanspaginatortypedef)
