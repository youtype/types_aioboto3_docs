...
async with session.client("apigateway") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: DomainNamesPaginatorTypeDef
        print(item)  # (3)
```

1. client: [APIGatewayClient](./client.md)
2. paginator: [GetDomainNamesPaginator](./paginators.md#getdomainnamespaginator)
3. item: [:material-code-braces: DomainNamesPaginatorTypeDef](./type_defs.md#domainnamespaginatortypedef) 
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[DomainNamesPaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: DomainNamesPaginatorTypeDef](./type_defs.md#domainnamespaginatortypedef) 
...
async with session.client("apigateway") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: RestApisPaginatorTypeDef
        print(item)  # (3)
```

1. client: [APIGatewayClient](./client.md)
2. paginator: [GetRestApisPaginator](./paginators.md#getrestapispaginator)
3. item: [:material-code-braces: RestApisPaginatorTypeDef](./type_defs.md#restapispaginatortypedef) 
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[RestApisPaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: RestApisPaginatorTypeDef](./type_defs.md#restapispaginatortypedef) 
...
async with session.client("apigateway") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: UsagePlansPaginatorTypeDef
        print(item)  # (3)
```

1. client: [APIGatewayClient](./client.md)
2. paginator: [GetUsagePlansPaginator](./paginators.md#getusageplanspaginator)
3. item: [:material-code-braces: UsagePlansPaginatorTypeDef](./type_defs.md#usageplanspaginatortypedef) 
...
def paginate(
    ...
    *,
    keyId: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[UsagePlansPaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: UsagePlansPaginatorTypeDef](./type_defs.md#usageplanspaginatortypedef) 
