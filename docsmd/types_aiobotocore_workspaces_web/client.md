...
) -> CreateUserSettingsResponseTypeDef:  # (8)
    ...
```
...
8. See [:material-code-braces: CreateUserSettingsResponseTypeDef](./type_defs.md#createusersettingsresponsetypedef) 
...
) -> UpdateUserSettingsResponseTypeDef:  # (7)
    ...
```
...
7. See [:material-code-braces: UpdateUserSettingsResponseTypeDef](./type_defs.md#updateusersettingsresponsetypedef) 
