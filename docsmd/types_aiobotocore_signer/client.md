...
Type annotations and code completion for `#!python session.client("signer").close` method.
...
Type annotations and code completion for `#!python session.client("signer").get_revocation_status` method.
