...
) -> StartAssetBundleExportJobResponseTypeDef:  # (4)
    ...
```
...
4. See [:material-code-braces: StartAssetBundleExportJobResponseTypeDef](./type_defs.md#startassetbundleexportjobresponsetypedef) 
