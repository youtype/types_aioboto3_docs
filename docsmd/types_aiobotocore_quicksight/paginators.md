...
Type annotations and code completion for `#!python session.client("quicksight").get_paginator("describe_folder_permissions")`.
...
) -> AsyncIterator[DescribeFolderPermissionsResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: DescribeFolderPermissionsResponsePaginatorTypeDef](./type_defs.md#describefolderpermissionsresponsepaginatortypedef) 
...
Type annotations and code completion for `#!python session.client("quicksight").get_paginator("describe_folder_resolved_permissions")`.
...
async with session.client("quicksight") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: DescribeFolderResolvedPermissionsResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [QuickSightClient](./client.md)
2. paginator: [DescribeFolderResolvedPermissionsPaginator](./paginators.md#describefolderresolvedpermissionspaginator)
3. item: [:material-code-braces: DescribeFolderResolvedPermissionsResponsePaginatorTypeDef](./type_defs.md#describefolderresolvedpermissionsresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    Namespace: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[DescribeFolderResolvedPermissionsResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: DescribeFolderResolvedPermissionsResponsePaginatorTypeDef](./type_defs.md#describefolderresolvedpermissionsresponsepaginatortypedef) 
...
Type annotations and code completion for `#!python session.client("quicksight").get_paginator("list_asset_bundle_export_jobs")`.
...
Type annotations and code completion for `#!python session.client("quicksight").get_paginator("list_asset_bundle_import_jobs")`.
...
async with session.client("quicksight") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListDataSourcesResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [QuickSightClient](./client.md)
2. paginator: [ListDataSourcesPaginator](./paginators.md#listdatasourcespaginator)
3. item: [:material-code-braces: ListDataSourcesResponsePaginatorTypeDef](./type_defs.md#listdatasourcesresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    AwsAccountId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListDataSourcesResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListDataSourcesResponsePaginatorTypeDef](./type_defs.md#listdatasourcesresponsepaginatortypedef) 
...
Type annotations and code completion for `#!python session.client("quicksight").get_paginator("list_folder_members")`.
...
Type annotations and code completion for `#!python session.client("quicksight").get_paginator("list_folders")`.
...
Type annotations and code completion for `#!python session.client("quicksight").get_paginator("list_group_memberships")`.
...
Type annotations and code completion for `#!python session.client("quicksight").get_paginator("list_groups")`.
...
Type annotations and code completion for `#!python session.client("quicksight").get_paginator("list_iam_policy_assignments")`.
...
Type annotations and code completion for `#!python session.client("quicksight").get_paginator("list_iam_policy_assignments_for_user")`.
...
Type annotations and code completion for `#!python session.client("quicksight").get_paginator("list_role_memberships")`.
...
Type annotations and code completion for `#!python session.client("quicksight").get_paginator("list_user_groups")`.
...
Type annotations and code completion for `#!python session.client("quicksight").get_paginator("list_users")`.
...
Type annotations and code completion for `#!python session.client("quicksight").get_paginator("search_data_sets")`.
...
Type annotations and code completion for `#!python session.client("quicksight").get_paginator("search_data_sources")`.
...
Type annotations and code completion for `#!python session.client("quicksight").get_paginator("search_folders")`.
...
Type annotations and code completion for `#!python session.client("quicksight").get_paginator("search_groups")`.
