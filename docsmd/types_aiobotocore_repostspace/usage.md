...
2. result: [:material-code-braces: CreateSpaceOutputTypeDef](./type_defs.md#createspaceoutputtypedef) 
...
1. client: [rePostPrivateClient](./client.md)
2. kwargs: [:material-code-braces: CreateSpaceInputRequestTypeDef](./type_defs.md#createspaceinputrequesttypedef) 
3. result: [:material-code-braces: CreateSpaceOutputTypeDef](./type_defs.md#createspaceoutputtypedef) 
