...
async with session.client("elbv2") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: DescribeListenersOutputPaginatorTypeDef
        print(item)  # (3)
```

1. client: [ElasticLoadBalancingv2Client](./client.md)
2. paginator: [DescribeListenersPaginator](./paginators.md#describelistenerspaginator)
3. item: [:material-code-braces: DescribeListenersOutputPaginatorTypeDef](./type_defs.md#describelistenersoutputpaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[DescribeListenersOutputPaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: DescribeListenersOutputPaginatorTypeDef](./type_defs.md#describelistenersoutputpaginatortypedef) 
...
async with session.client("elbv2") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: DescribeRulesOutputPaginatorTypeDef
        print(item)  # (3)
```

1. client: [ElasticLoadBalancingv2Client](./client.md)
2. paginator: [DescribeRulesPaginator](./paginators.md#describerulespaginator)
3. item: [:material-code-braces: DescribeRulesOutputPaginatorTypeDef](./type_defs.md#describerulesoutputpaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[DescribeRulesOutputPaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: DescribeRulesOutputPaginatorTypeDef](./type_defs.md#describerulesoutputpaginatortypedef) 
