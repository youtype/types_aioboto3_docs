...
Type annotations and code completion for `#!python session.client("b2bi").close` method.
...
2. See [:material-code-braces: CreatePartnershipResponseTypeDef](./type_defs.md#createpartnershipresponsetypedef) 
...
4. See [:material-code-braces: CreateTransformerResponseTypeDef](./type_defs.md#createtransformerresponsetypedef) 
...
Type annotations and code completion for `#!python session.client("b2bi").delete_transformer` method.
...
Type annotations and code completion for `#!python session.client("b2bi").get_partnership` method.
...
1. See [:material-code-braces: UpdatePartnershipResponseTypeDef](./type_defs.md#updatepartnershipresponsetypedef) 
...
3. See [:material-code-braces: EdiTypeTypeDef](./type_defs.md#editypetypedef) 
4. See [:material-code-braces: UpdateTransformerResponseTypeDef](./type_defs.md#updatetransformerresponsetypedef) 
