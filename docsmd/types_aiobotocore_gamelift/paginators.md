...
3. item: [:material-code-braces: DescribeGameSessionQueuesOutputPaginatorTypeDef](./type_defs.md#describegamesessionqueuesoutputpaginatortypedef) 
...
def paginate(
    ...
    *,
    Names: Sequence[str] = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[DescribeGameSessionQueuesOutputPaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: DescribeGameSessionQueuesOutputPaginatorTypeDef](./type_defs.md#describegamesessionqueuesoutputpaginatortypedef) 
