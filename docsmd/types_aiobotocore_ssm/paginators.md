...
3. item: [:material-code-braces: DescribeAssociationExecutionsResultPaginatorTypeDef](./type_defs.md#describeassociationexecutionsresultpaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[DescribeAssociationExecutionsResultPaginatorTypeDef]:  # (3)
    ...
```

1. See [:material-code-braces: AssociationExecutionFilterTypeDef](./type_defs.md#associationexecutionfiltertypedef) 
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
3. See [:material-code-braces: DescribeAssociationExecutionsResultPaginatorTypeDef](./type_defs.md#describeassociationexecutionsresultpaginatortypedef) 
...
3. item: [:material-code-braces: DescribeAutomationExecutionsResultPaginatorTypeDef](./type_defs.md#describeautomationexecutionsresultpaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[DescribeAutomationExecutionsResultPaginatorTypeDef]:  # (3)
    ...
```

1. See [:material-code-braces: AutomationExecutionFilterTypeDef](./type_defs.md#automationexecutionfiltertypedef) 
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
3. See [:material-code-braces: DescribeAutomationExecutionsResultPaginatorTypeDef](./type_defs.md#describeautomationexecutionsresultpaginatortypedef) 
...
3. item: [:material-code-braces: DescribeAutomationStepExecutionsResultPaginatorTypeDef](./type_defs.md#describeautomationstepexecutionsresultpaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    ReverseOrder: bool = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[DescribeAutomationStepExecutionsResultPaginatorTypeDef]:  # (3)
    ...
```

1. See [:material-code-braces: StepExecutionFilterTypeDef](./type_defs.md#stepexecutionfiltertypedef) 
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
3. See [:material-code-braces: DescribeAutomationStepExecutionsResultPaginatorTypeDef](./type_defs.md#describeautomationstepexecutionsresultpaginatortypedef) 
...
async with session.client("ssm") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: DescribeMaintenanceWindowExecutionTasksResultPaginatorTypeDef
        print(item)  # (3)
```
...
3. item: [:material-code-braces: DescribeMaintenanceWindowExecutionTasksResultPaginatorTypeDef](./type_defs.md#describemaintenancewindowexecutiontasksresultpaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    Filters: Sequence[MaintenanceWindowFilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[DescribeMaintenanceWindowExecutionTasksResultPaginatorTypeDef]:  # (3)
    ...
```

1. See [:material-code-braces: MaintenanceWindowFilterTypeDef](./type_defs.md#maintenancewindowfiltertypedef) 
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
3. See [:material-code-braces: DescribeMaintenanceWindowExecutionTasksResultPaginatorTypeDef](./type_defs.md#describemaintenancewindowexecutiontasksresultpaginatortypedef) 
...
1. See [:material-code-braces: TargetPaginatorTypeDef](./type_defs.md#targetpaginatortypedef) 
...
async with session.client("ssm") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: DescribeMaintenanceWindowTargetsResultPaginatorTypeDef
        print(item)  # (3)
```

1. client: [SSMClient](./client.md)
2. paginator: [DescribeMaintenanceWindowTargetsPaginator](./paginators.md#describemaintenancewindowtargetspaginator)
3. item: [:material-code-braces: DescribeMaintenanceWindowTargetsResultPaginatorTypeDef](./type_defs.md#describemaintenancewindowtargetsresultpaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    Filters: Sequence[MaintenanceWindowFilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[DescribeMaintenanceWindowTargetsResultPaginatorTypeDef]:  # (3)
    ...
```

1. See [:material-code-braces: MaintenanceWindowFilterTypeDef](./type_defs.md#maintenancewindowfiltertypedef) 
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
3. See [:material-code-braces: DescribeMaintenanceWindowTargetsResultPaginatorTypeDef](./type_defs.md#describemaintenancewindowtargetsresultpaginatortypedef) 
...
async with session.client("ssm") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: DescribeMaintenanceWindowTasksResultPaginatorTypeDef
        print(item)  # (3)
```

1. client: [SSMClient](./client.md)
2. paginator: [DescribeMaintenanceWindowTasksPaginator](./paginators.md#describemaintenancewindowtaskspaginator)
3. item: [:material-code-braces: DescribeMaintenanceWindowTasksResultPaginatorTypeDef](./type_defs.md#describemaintenancewindowtasksresultpaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    Filters: Sequence[MaintenanceWindowFilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[DescribeMaintenanceWindowTasksResultPaginatorTypeDef]:  # (3)
    ...
```

1. See [:material-code-braces: MaintenanceWindowFilterTypeDef](./type_defs.md#maintenancewindowfiltertypedef) 
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
3. See [:material-code-braces: DescribeMaintenanceWindowTasksResultPaginatorTypeDef](./type_defs.md#describemaintenancewindowtasksresultpaginatortypedef) 
...
async with session.client("ssm") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListAssociationVersionsResultPaginatorTypeDef
        print(item)  # (3)
```

1. client: [SSMClient](./client.md)
2. paginator: [ListAssociationVersionsPaginator](./paginators.md#listassociationversionspaginator)
3. item: [:material-code-braces: ListAssociationVersionsResultPaginatorTypeDef](./type_defs.md#listassociationversionsresultpaginatortypedef) 
...
def paginate(
    ...
    *,
    AssociationId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListAssociationVersionsResultPaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListAssociationVersionsResultPaginatorTypeDef](./type_defs.md#listassociationversionsresultpaginatortypedef) 
...
async with session.client("ssm") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListAssociationsResultPaginatorTypeDef
        print(item)  # (3)
```

1. client: [SSMClient](./client.md)
2. paginator: [ListAssociationsPaginator](./paginators.md#listassociationspaginator)
3. item: [:material-code-braces: ListAssociationsResultPaginatorTypeDef](./type_defs.md#listassociationsresultpaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[ListAssociationsResultPaginatorTypeDef]:  # (3)
    ...
```

1. See [:material-code-braces: AssociationFilterTypeDef](./type_defs.md#associationfiltertypedef) 
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
3. See [:material-code-braces: ListAssociationsResultPaginatorTypeDef](./type_defs.md#listassociationsresultpaginatortypedef) 
...
async with session.client("ssm") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListCommandsResultPaginatorTypeDef
        print(item)  # (3)
```

1. client: [SSMClient](./client.md)
2. paginator: [ListCommandsPaginator](./paginators.md#listcommandspaginator)
3. item: [:material-code-braces: ListCommandsResultPaginatorTypeDef](./type_defs.md#listcommandsresultpaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    Filters: Sequence[CommandFilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[ListCommandsResultPaginatorTypeDef]:  # (3)
    ...
```

1. See [:material-code-braces: CommandFilterTypeDef](./type_defs.md#commandfiltertypedef) 
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
3. See [:material-code-braces: ListCommandsResultPaginatorTypeDef](./type_defs.md#listcommandsresultpaginatortypedef) 
...
Type annotations and code completion for `#!python session.client("ssm").get_paginator("list_resource_compliance_summaries")`.
...
Type annotations and code completion for `#!python session.client("ssm").get_paginator("list_resource_data_sync")`.
...
async with session.client("ssm") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListResourceDataSyncResultPaginatorTypeDef
        print(item)  # (3)
```

1. client: [SSMClient](./client.md)
2. paginator: [ListResourceDataSyncPaginator](./paginators.md#listresourcedatasyncpaginator)
3. item: [:material-code-braces: ListResourceDataSyncResultPaginatorTypeDef](./type_defs.md#listresourcedatasyncresultpaginatortypedef) 
...
def paginate(
    ...
    *,
    SyncType: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListResourceDataSyncResultPaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListResourceDataSyncResultPaginatorTypeDef](./type_defs.md#listresourcedatasyncresultpaginatortypedef) 
