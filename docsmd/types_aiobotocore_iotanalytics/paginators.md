...
async with session.client("iotanalytics") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListDatastoresResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [IoTAnalyticsClient](./client.md)
2. paginator: [ListDatastoresPaginator](./paginators.md#listdatastorespaginator)
3. item: [:material-code-braces: ListDatastoresResponsePaginatorTypeDef](./type_defs.md#listdatastoresresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListDatastoresResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListDatastoresResponsePaginatorTypeDef](./type_defs.md#listdatastoresresponsepaginatortypedef) 
