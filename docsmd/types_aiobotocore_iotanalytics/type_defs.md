...
4. See [:material-code-braces: DatastorePartitionsPaginatorTypeDef](./type_defs.md#datastorepartitionspaginatortypedef) 
...
1. See [:material-code-braces: DatastoreSummaryPaginatorTypeDef](./type_defs.md#datastoresummarypaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
