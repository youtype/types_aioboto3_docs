...
Type annotations and code completion for `#!python session.client("medical-imaging").close` method.
...
Type annotations and code completion for `#!python session.client("medical-imaging").delete_image_set` method.
