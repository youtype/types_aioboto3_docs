...
```python
# CodeBuildClient.exceptions type checking example
...
Type annotations and code completion for `#!python session.client("codebuild").batch_get_fleets` method.
...
Type annotations and code completion for `#!python session.client("codebuild").close` method.
...
Type annotations and code completion for `#!python session.client("codebuild").create_fleet` method.
...
7. See [:material-code-braces: CreateFleetOutputTypeDef](./type_defs.md#createfleetoutputtypedef) 
...
Type annotations and code completion for `#!python session.client("codebuild").delete_fleet` method.
...
Type annotations and code completion for `#!python session.client("codebuild").list_fleets` method.
...
Type annotations and code completion for `#!python session.client("codebuild").list_reports` method.
...
Type annotations and code completion for `#!python session.client("codebuild").list_shared_report_groups` method.
...
Type annotations and code completion for `#!python session.client("codebuild").update_fleet` method.
...
5. See [:material-code-braces: VpcConfigTypeDef](./type_defs.md#vpcconfigtypedef) 
6. See [:material-code-braces: TagTypeDef](./type_defs.md#tagtypedef) 
7. See [:material-code-braces: UpdateFleetOutputTypeDef](./type_defs.md#updatefleetoutputtypedef) 
