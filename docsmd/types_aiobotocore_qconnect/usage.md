...
async with session.client("qconnect") as client:  # (1)
    kwargs: CreateAIAgentRequestRequestTypeDef = {...}  # (2)
    result: CreateAIAgentResponseTypeDef = await client.create_ai_agent(**kwargs)  # (3)
```

1. client: [QConnectClient](./client.md)
2. kwargs: [:material-code-braces: CreateAIAgentRequestRequestTypeDef](./type_defs.md#createaiagentrequestrequesttypedef) 
3. result: [:material-code-braces: CreateAIAgentResponseTypeDef](./type_defs.md#createaiagentresponsetypedef) 
