...
async with session.client("qconnect") as client:  # (1)
    kwargs: ActivateMessageTemplateRequestRequestTypeDef = {...}  # (2)
    result: ActivateMessageTemplateResponseTypeDef = await client.activate_message_template(**kwargs)  # (3)
```

1. client: [QConnectClient](./client.md)
2. kwargs: [:material-code-braces: ActivateMessageTemplateRequestRequestTypeDef](./type_defs.md#activatemessagetemplaterequestrequesttypedef) 
