...
```python
# SourceConfigurationPaginatorTypeDef definition

class SourceConfigurationPaginatorTypeDef(TypedDict):
    appIntegrations: NotRequired[AppIntegrationsConfigurationPaginatorTypeDef],  # (1)
```

1. See [:material-code-braces: AppIntegrationsConfigurationPaginatorTypeDef](./type_defs.md#appintegrationsconfigurationpaginatortypedef) 
...
class AssistantDataTypeDef(TypedDict):
    ...
    assistantId: str,
    name: str,
    status: AssistantStatusType,  # (4)
    type: AssistantTypeType,  # (5)
    capabilityConfiguration: NotRequired[AssistantCapabilityConfigurationTypeDef],  # (1)
    description: NotRequired[str],
    integrationConfiguration: NotRequired[AssistantIntegrationConfigurationTypeDef],  # (2)
    serverSideEncryptionConfiguration: NotRequired[ServerSideEncryptionConfigurationTypeDef],  # (3)
    tags: NotRequired[Dict[str, str]],
```

1. See [:material-code-braces: AssistantCapabilityConfigurationTypeDef](./type_defs.md#assistantcapabilityconfigurationtypedef) 
2. See [:material-code-braces: AssistantIntegrationConfigurationTypeDef](./type_defs.md#assistantintegrationconfigurationtypedef) 
...
4. See [:material-code-brackets: AssistantStatusType](./literals.md#assistantstatustype) 
5. See [:material-code-brackets: AssistantTypeType](./literals.md#assistanttypetype) 
...
```python
# KnowledgeBaseSummaryPaginatorTypeDef definition

class KnowledgeBaseSummaryPaginatorTypeDef(TypedDict):
    knowledgeBaseArn: str,
    knowledgeBaseId: str,
    ...
    serverSideEncryptionConfiguration: NotRequired[ServerSideEncryptionConfigurationTypeDef],  # (3)
    sourceConfiguration: NotRequired[SourceConfigurationPaginatorTypeDef],  # (4)
    tags: NotRequired[Dict[str, str]],
```
...
3. See [:material-code-braces: ServerSideEncryptionConfigurationTypeDef](./type_defs.md#serversideencryptionconfigurationtypedef) 
4. See [:material-code-braces: SourceConfigurationPaginatorTypeDef](./type_defs.md#sourceconfigurationpaginatortypedef) 
...
1. See [:material-code-braces: QueryConditionTypeDef](./type_defs.md#queryconditiontypedef) 
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
...
```python
# QuickResponseSearchResultDataPaginatorTypeDef definition

class QuickResponseSearchResultDataPaginatorTypeDef(TypedDict):
    contentType: str,
    ...
    channels: NotRequired[List[str]],
    description: NotRequired[str],
    groupingConfiguration: NotRequired[GroupingConfigurationPaginatorTypeDef],  # (2)
    language: NotRequired[str],
    lastModifiedBy: NotRequired[str],
    shortcutKey: NotRequired[str],
    tags: NotRequired[Dict[str, str]],
...
1. See [:material-code-braces: QuickResponseContentsTypeDef](./type_defs.md#quickresponsecontentstypedef) 
2. See [:material-code-braces: GroupingConfigurationPaginatorTypeDef](./type_defs.md#groupingconfigurationpaginatortypedef) 
3. See [:material-code-brackets: QuickResponseStatusType](./literals.md#quickresponsestatustype) 
...
```python
# ListKnowledgeBasesResponsePaginatorTypeDef definition

class ListKnowledgeBasesResponsePaginatorTypeDef(TypedDict):
    knowledgeBaseSummaries: List[KnowledgeBaseSummaryPaginatorTypeDef],  # (1)
    nextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: KnowledgeBaseSummaryPaginatorTypeDef](./type_defs.md#knowledgebasesummarypaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
class SourceContentDataDetailsTypeDef(TypedDict):
    ...
    rankingData: RankingDataTypeDef,  # (1)
    textData: TextDataTypeDef,  # (2)
    type: SourceContentTypeType,  # (3)
```

1. See [:material-code-braces: RankingDataTypeDef](./type_defs.md#rankingdatatypedef) 
2. See [:material-code-braces: TextDataTypeDef](./type_defs.md#textdatatypedef) 
3. See [:material-code-brackets: SourceContentTypeType](./literals.md#sourcecontenttypetype) 
...
```python
# SearchQuickResponsesResponsePaginatorTypeDef definition

class SearchQuickResponsesResponsePaginatorTypeDef(TypedDict):
    nextToken: str,
    results: List[QuickResponseSearchResultDataPaginatorTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: QuickResponseSearchResultDataPaginatorTypeDef](./type_defs.md#quickresponsesearchresultdatapaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
class DataDetailsTypeDef(TypedDict):
    ...
    sourceContentData: NotRequired[SourceContentDataDetailsTypeDef],  # (3)
```
...
3. See [:material-code-braces: SourceContentDataDetailsTypeDef](./type_defs.md#sourcecontentdatadetailstypedef) 
