...
1. See [:material-code-braces: CmafEncryptionPaginatorTypeDef](./type_defs.md#cmafencryptionpaginatortypedef) 
...
3. See [:material-code-braces: DashEncryptionPaginatorTypeDef](./type_defs.md#dashencryptionpaginatortypedef) 
...
2. See [:material-code-brackets: AdTriggersElementType](./literals.md#adtriggerselementtype) 
3. See [:material-code-brackets: AdsOnDeliveryRestrictionsType](./literals.md#adsondeliveryrestrictionstype) 
4. See [:material-code-braces: HlsEncryptionPaginatorTypeDef](./type_defs.md#hlsencryptionpaginatortypedef) 
...
1. See [:material-code-braces: MssEncryptionPaginatorTypeDef](./type_defs.md#mssencryptionpaginatortypedef) 
...
```python
# OriginEndpointPaginatorTypeDef definition

class OriginEndpointPaginatorTypeDef(TypedDict):
    Arn: NotRequired[str],
    Authorization: NotRequired[AuthorizationTypeDef],  # (1)
    ChannelId: NotRequired[str],
    CmafPackage: NotRequired[CmafPackagePaginatorTypeDef],  # (2)
    CreatedAt: NotRequired[str],
    DashPackage: NotRequired[DashPackagePaginatorTypeDef],  # (3)
    Description: NotRequired[str],
    HlsPackage: NotRequired[HlsPackagePaginatorTypeDef],  # (4)
    Id: NotRequired[str],
    ManifestName: NotRequired[str],
    MssPackage: NotRequired[MssPackagePaginatorTypeDef],  # (5)
...
2. See [:material-code-braces: CmafPackagePaginatorTypeDef](./type_defs.md#cmafpackagepaginatortypedef) 
3. See [:material-code-braces: DashPackagePaginatorTypeDef](./type_defs.md#dashpackagepaginatortypedef) 
4. See [:material-code-braces: HlsPackagePaginatorTypeDef](./type_defs.md#hlspackagepaginatortypedef) 
5. See [:material-code-braces: MssPackagePaginatorTypeDef](./type_defs.md#msspackagepaginatortypedef) 
...
```python
# ListOriginEndpointsResponsePaginatorTypeDef definition

class ListOriginEndpointsResponsePaginatorTypeDef(TypedDict):
    NextToken: str,
    OriginEndpoints: List[OriginEndpointPaginatorTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: OriginEndpointPaginatorTypeDef](./type_defs.md#originendpointpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
