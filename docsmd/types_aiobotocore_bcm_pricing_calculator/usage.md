...
async with session.client("bcm-pricing-calculator") as client:  # (1)
    kwargs: BatchCreateBillScenarioCommitmentModificationRequestRequestTypeDef = {...}  # (2)
...
1. client: [BillingandCostManagementPricingCalculatorClient](./client.md)
2. kwargs: [:material-code-braces: BatchCreateBillScenarioCommitmentModificationRequestRequestTypeDef](./type_defs.md#batchcreatebillscenariocommitmentmodificationrequestrequesttypedef) 
