...
async with session.client("cloudwatch") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: DescribeAlarmsOutputPaginatorTypeDef
        print(item)  # (3)
```

1. client: [CloudWatchClient](./client.md)
2. paginator: [DescribeAlarmsPaginator](./paginators.md#describealarmspaginator)
3. item: [:material-code-braces: DescribeAlarmsOutputPaginatorTypeDef](./type_defs.md#describealarmsoutputpaginatortypedef) 
...
) -> AsyncIterator[DescribeAlarmsOutputPaginatorTypeDef]:  # (4)
    ...
```
...
4. See [:material-code-braces: DescribeAlarmsOutputPaginatorTypeDef](./type_defs.md#describealarmsoutputpaginatortypedef) 
...
async with session.client("cloudwatch") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: DescribeAnomalyDetectorsOutputPaginatorTypeDef
        print(item)  # (3)
```

1. client: [CloudWatchClient](./client.md)
2. paginator: [DescribeAnomalyDetectorsPaginator](./paginators.md#describeanomalydetectorspaginator)
3. item: [:material-code-braces: DescribeAnomalyDetectorsOutputPaginatorTypeDef](./type_defs.md#describeanomalydetectorsoutputpaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> AsyncIterator[DescribeAnomalyDetectorsOutputPaginatorTypeDef]:  # (4)
    ...
```
...
3. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
4. See [:material-code-braces: DescribeAnomalyDetectorsOutputPaginatorTypeDef](./type_defs.md#describeanomalydetectorsoutputpaginatortypedef) 
...
async with session.client("cloudwatch") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListMetricsOutputPaginatorTypeDef
        print(item)  # (3)
```

1. client: [CloudWatchClient](./client.md)
2. paginator: [ListMetricsPaginator](./paginators.md#listmetricspaginator)
3. item: [:material-code-braces: ListMetricsOutputPaginatorTypeDef](./type_defs.md#listmetricsoutputpaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    OwningAccount: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> AsyncIterator[ListMetricsOutputPaginatorTypeDef]:  # (4)
    ...
```
...
3. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
4. See [:material-code-braces: ListMetricsOutputPaginatorTypeDef](./type_defs.md#listmetricsoutputpaginatortypedef) 
