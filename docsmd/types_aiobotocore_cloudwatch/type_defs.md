...
```python
# ListMetricsOutputPaginatorTypeDef definition

class ListMetricsOutputPaginatorTypeDef(TypedDict):
    Metrics: List[MetricPaginatorTypeDef],  # (1)
    NextToken: str,
    OwningAccounts: List[str],
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: MetricPaginatorTypeDef](./type_defs.md#metricpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
## MetricStatPaginatorTypeDef

```python
# MetricStatPaginatorTypeDef definition

class MetricStatPaginatorTypeDef(TypedDict):
    Metric: MetricPaginatorTypeDef,  # (1)
    Period: int,
    Stat: str,
...
```python
# MetricDataQueryPaginatorTypeDef definition

class MetricDataQueryPaginatorTypeDef(TypedDict):
    Id: str,
    MetricStat: NotRequired[MetricStatPaginatorTypeDef],  # (1)
    Expression: NotRequired[str],
    Label: NotRequired[str],
...
1. See [:material-code-braces: MetricStatPaginatorTypeDef](./type_defs.md#metricstatpaginatortypedef) 
...
class GetMetricDataInputGetMetricDataPaginateTypeDef(TypedDict):
    MetricDataQueries: Sequence[MetricDataQueryPaginatorTypeDef],  # (1)
    StartTime: Union[datetime, str],
    EndTime: Union[datetime, str],
...
1. See [:material-code-braces: MetricDataQueryPaginatorTypeDef](./type_defs.md#metricdataquerypaginatortypedef) 
...
```python
# MetricAlarmPaginatorTypeDef definition

class MetricAlarmPaginatorTypeDef(TypedDict):
    AlarmName: NotRequired[str],
    AlarmArn: NotRequired[str],
    AlarmDescription: NotRequired[str],
    AlarmConfigurationUpdatedTimestamp: NotRequired[datetime],
    ...
    Metrics: NotRequired[List[MetricDataQueryPaginatorTypeDef]],  # (6)
...
6. See [:material-code-braces: MetricDataQueryPaginatorTypeDef](./type_defs.md#metricdataquerypaginatortypedef) 
...
```python
# MetricMathAnomalyDetectorPaginatorTypeDef definition

class MetricMathAnomalyDetectorPaginatorTypeDef(TypedDict):
    MetricDataQueries: NotRequired[List[MetricDataQueryPaginatorTypeDef]],  # (1)
```
...
```python
# DescribeAlarmsOutputPaginatorTypeDef definition

class DescribeAlarmsOutputPaginatorTypeDef(TypedDict):
    CompositeAlarms: List[CompositeAlarmTypeDef],  # (1)
    MetricAlarms: List[MetricAlarmPaginatorTypeDef],  # (2)
    NextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (3)
```

1. See [:material-code-braces: CompositeAlarmTypeDef](./type_defs.md#compositealarmtypedef) 
2. See [:material-code-braces: MetricAlarmPaginatorTypeDef](./type_defs.md#metricalarmpaginatortypedef) 
3. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
## AnomalyDetectorPaginatorTypeDef

```python
# AnomalyDetectorPaginatorTypeDef definition

class AnomalyDetectorPaginatorTypeDef(TypedDict):
    Namespace: NotRequired[str],
    MetricName: NotRequired[str],
    Dimensions: NotRequired[List[DimensionTypeDef]],  # (1)
    Stat: NotRequired[str],
    ...
    SingleMetricAnomalyDetector: NotRequired[SingleMetricAnomalyDetectorPaginatorTypeDef],  # (4)
    MetricMathAnomalyDetector: NotRequired[MetricMathAnomalyDetectorPaginatorTypeDef],  # (5)
```
...
4. See [:material-code-braces: SingleMetricAnomalyDetectorPaginatorTypeDef](./type_defs.md#singlemetricanomalydetectorpaginatortypedef) 
5. See [:material-code-braces: MetricMathAnomalyDetectorPaginatorTypeDef](./type_defs.md#metricmathanomalydetectorpaginatortypedef) 
...
```python
# DescribeAnomalyDetectorsOutputPaginatorTypeDef definition

class DescribeAnomalyDetectorsOutputPaginatorTypeDef(TypedDict):
    AnomalyDetectors: List[AnomalyDetectorPaginatorTypeDef],  # (1)
    NextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: AnomalyDetectorPaginatorTypeDef](./type_defs.md#anomalydetectorpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
