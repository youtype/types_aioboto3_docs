...
```python
# DataPipelineClient.exceptions type checking example
...
Type annotations and code completion for `#!python session.client("datapipeline").get_paginator` method with overloads.
