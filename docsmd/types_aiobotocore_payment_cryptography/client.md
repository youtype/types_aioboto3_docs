...
Type annotations and code completion for `#!python session.client("payment-cryptography").close` method.
...
Type annotations and code completion for `#!python session.client("payment-cryptography").delete_key` method.
