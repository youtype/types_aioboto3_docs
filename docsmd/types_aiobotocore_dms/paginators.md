...
async with session.client("dms") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: DescribeEndpointsResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [DatabaseMigrationServiceClient](./client.md)
2. paginator: [DescribeEndpointsPaginator](./paginators.md#describeendpointspaginator)
3. item: [:material-code-braces: DescribeEndpointsResponsePaginatorTypeDef](./type_defs.md#describeendpointsresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[DescribeEndpointsResponsePaginatorTypeDef]:  # (3)
    ...
```

1. See [:material-code-braces: FilterTypeDef](./type_defs.md#filtertypedef) 
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
3. See [:material-code-braces: DescribeEndpointsResponsePaginatorTypeDef](./type_defs.md#describeendpointsresponsepaginatortypedef) 
