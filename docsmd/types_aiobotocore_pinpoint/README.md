...
Install `types-aioboto3` for `Pinpoint` service.

```bash
# install with aioboto3 type annotations
python -m pip install 'types-aioboto3[pinpoint]'

# Lite version does not provide session.client/resource overloads
# it is more RAM-friendly, but requires explicit type annotations
python -m pip install 'types-aioboto3-lite[pinpoint]'
...
Type annotations and code completion for  `#!python session.client("pinpoint")` as [PinpointClient](./client.md)
