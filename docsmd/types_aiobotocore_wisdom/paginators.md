...
Type annotations and code completion for `#!python session.client("wisdom").get_paginator("list_import_jobs")`.
...
3. item: [:material-code-braces: ListKnowledgeBasesResponsePaginatorTypeDef](./type_defs.md#listknowledgebasesresponsepaginatortypedef) 
...
1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListKnowledgeBasesResponsePaginatorTypeDef](./type_defs.md#listknowledgebasesresponsepaginatortypedef) 
...
Type annotations and code completion for `#!python session.client("wisdom").get_paginator("list_quick_responses")`.
...
Type annotations and code completion for `#!python session.client("wisdom").get_paginator("search_quick_responses")`.
...
3. item: [:material-code-braces: SearchQuickResponsesResponsePaginatorTypeDef](./type_defs.md#searchquickresponsesresponsepaginatortypedef) 
...
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
3. See [:material-code-braces: SearchQuickResponsesResponsePaginatorTypeDef](./type_defs.md#searchquickresponsesresponsepaginatortypedef) 
