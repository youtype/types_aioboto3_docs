...
3. item: [:material-code-braces: ExecuteQueryResponseTypeDef](./type_defs.md#executequeryresponsetypedef) 
...
2. See [:material-code-braces: ExecuteQueryResponseTypeDef](./type_defs.md#executequeryresponsetypedef) 
...
3. item: [:material-code-braces: ListAssetModelPropertiesResponsePaginatorTypeDef](./type_defs.md#listassetmodelpropertiesresponsepaginatortypedef) 
...
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
3. See [:material-code-braces: ListAssetModelPropertiesResponsePaginatorTypeDef](./type_defs.md#listassetmodelpropertiesresponsepaginatortypedef) 
