...
```python
# VariableValuePaginatorTypeDef definition

class VariableValuePaginatorTypeDef(TypedDict):
    propertyId: NotRequired[str],
    hierarchyId: NotRequired[str],
...
```python
# ExpressionVariablePaginatorTypeDef definition

class ExpressionVariablePaginatorTypeDef(TypedDict):
    name: str,
    value: VariableValuePaginatorTypeDef,  # (1)
```

1. See [:material-code-braces: VariableValuePaginatorTypeDef](./type_defs.md#variablevaluepaginatortypedef) 
...
class MetricPaginatorTypeDef(TypedDict):
    expression: str,
    variables: List[ExpressionVariablePaginatorTypeDef],  # (1)
    window: MetricWindowTypeDef,  # (2)
    processingConfig: NotRequired[MetricProcessingConfigTypeDef],  # (3)
```

1. See [:material-code-braces: ExpressionVariablePaginatorTypeDef](./type_defs.md#expressionvariablepaginatortypedef) 
...
```python
# TransformPaginatorTypeDef definition

class TransformPaginatorTypeDef(TypedDict):
    expression: str,
    variables: List[ExpressionVariablePaginatorTypeDef],  # (1)
...
class AssetModelSummaryTypeDef(TypedDict):
    ...
    assetModelType: NotRequired[AssetModelTypeType],  # (2)
    externalId: NotRequired[str],
```

1. See [:material-code-braces: AssetModelStatusTypeDef](./type_defs.md#assetmodelstatustypedef) 
2. See [:material-code-brackets: AssetModelTypeType](./literals.md#assetmodeltypetype) 
...
```python
# PropertyTypePaginatorTypeDef definition

class PropertyTypePaginatorTypeDef(TypedDict):
    attribute: NotRequired[AttributeTypeDef],  # (1)
    measurement: NotRequired[MeasurementTypeDef],  # (2)
    transform: NotRequired[TransformPaginatorTypeDef],  # (3)
    metric: NotRequired[MetricPaginatorTypeDef],  # (4)
```

1. See [:material-code-braces: AttributeTypeDef](./type_defs.md#attributetypedef) 
2. See [:material-code-braces: MeasurementTypeDef](./type_defs.md#measurementtypedef) 
3. See [:material-code-braces: TransformPaginatorTypeDef](./type_defs.md#transformpaginatortypedef) 
4. See [:material-code-braces: MetricPaginatorTypeDef](./type_defs.md#metricpaginatortypedef) 
## PropertyTypeTypeDef
...
```python
# AssetModelPropertySummaryPaginatorTypeDef definition

class AssetModelPropertySummaryPaginatorTypeDef(TypedDict):
    name: str,
    dataType: PropertyDataTypeType,  # (1)
    type: PropertyTypePaginatorTypeDef,  # (2)
    id: NotRequired[str],
    dataTypeSpec: NotRequired[str],
    unit: NotRequired[str],
...
1. See [:material-code-brackets: PropertyDataTypeType](./literals.md#propertydatatypetype) 
2. See [:material-code-braces: PropertyTypePaginatorTypeDef](./type_defs.md#propertytypepaginatortypedef) 
...
```python
# ListAssetModelPropertiesResponsePaginatorTypeDef definition

class ListAssetModelPropertiesResponsePaginatorTypeDef(TypedDict):
    assetModelPropertySummaries: List[AssetModelPropertySummaryPaginatorTypeDef],  # (1)
    nextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: AssetModelPropertySummaryPaginatorTypeDef](./type_defs.md#assetmodelpropertysummarypaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
class DescribeAssetModelCompositeModelResponseTypeDef(TypedDict):
    ...
    assetModelCompositeModelType: str,
    assetModelCompositeModelProperties: List[AssetModelPropertyTypeDef],  # (2)
...
1. See [:material-code-braces: AssetModelCompositeModelPathSegmentTypeDef](./type_defs.md#assetmodelcompositemodelpathsegmenttypedef) 
2. See [:material-code-braces: AssetModelPropertyTypeDef](./type_defs.md#assetmodelpropertytypedef) 
...
class CreateAssetModelRequestRequestTypeDef(TypedDict):
    ...
    assetModelType: NotRequired[AssetModelTypeType],  # (4)
```
...
4. See [:material-code-brackets: AssetModelTypeType](./literals.md#assetmodeltypetype) 
...
class DescribeAssetModelResponseTypeDef(TypedDict):
    ...
    assetModelType: AssetModelTypeType,  # (5)
    assetModelCompositeModelSummaries: List[AssetModelCompositeModelSummaryTypeDef],  # (6)
...
5. See [:material-code-brackets: AssetModelTypeType](./literals.md#assetmodeltypetype) 
6. See [:material-code-braces: AssetModelCompositeModelSummaryTypeDef](./type_defs.md#assetmodelcompositemodelsummarytypedef) 
