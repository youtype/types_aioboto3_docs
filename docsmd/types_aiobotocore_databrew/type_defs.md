...
```python
# DatasetParameterPaginatorTypeDef definition

class DatasetParameterPaginatorTypeDef(TypedDict):
    Name: str,
    Type: ParameterTypeType,  # (1)
    DatetimeOptions: NotRequired[DatetimeOptionsTypeDef],  # (2)
    CreateColumn: NotRequired[bool],
    Filter: NotRequired[FilterExpressionPaginatorTypeDef],  # (3)
```
...
3. See [:material-code-braces: FilterExpressionPaginatorTypeDef](./type_defs.md#filterexpressionpaginatortypedef) 
...
```python
# FormatOptionsPaginatorTypeDef definition

class FormatOptionsPaginatorTypeDef(TypedDict):
    Json: NotRequired[JsonOptionsTypeDef],  # (1)
    Excel: NotRequired[ExcelOptionsPaginatorTypeDef],  # (2)
    Csv: NotRequired[CsvOptionsTypeDef],  # (3)
```

1. See [:material-code-braces: JsonOptionsTypeDef](./type_defs.md#jsonoptionstypedef) 
2. See [:material-code-braces: ExcelOptionsPaginatorTypeDef](./type_defs.md#exceloptionspaginatortypedef) 
...
```python
# RecipeStepPaginatorTypeDef definition

class RecipeStepPaginatorTypeDef(TypedDict):
    Action: RecipeActionPaginatorTypeDef,  # (1)
    ConditionExpressions: NotRequired[List[ConditionExpressionTypeDef]],  # (2)
```

1. See [:material-code-braces: RecipeActionPaginatorTypeDef](./type_defs.md#recipeactionpaginatortypedef) 
...
```python
# PathOptionsPaginatorTypeDef definition

class PathOptionsPaginatorTypeDef(TypedDict):
    LastModifiedDateCondition: NotRequired[FilterExpressionPaginatorTypeDef],  # (1)
    FilesLimit: NotRequired[FilesLimitTypeDef],  # (2)
    Parameters: NotRequired[Dict[str, DatasetParameterPaginatorTypeDef]],  # (3)
```

1. See [:material-code-braces: FilterExpressionPaginatorTypeDef](./type_defs.md#filterexpressionpaginatortypedef) 
2. See [:material-code-braces: FilesLimitTypeDef](./type_defs.md#fileslimittypedef) 
3. See [:material-code-braces: DatasetParameterPaginatorTypeDef](./type_defs.md#datasetparameterpaginatortypedef) 
## PathOptionsTypeDef
...
```python
# RecipePaginatorTypeDef definition

class RecipePaginatorTypeDef(TypedDict):
    Name: str,
    CreatedBy: NotRequired[str],
    CreateDate: NotRequired[datetime],
    LastModifiedBy: NotRequired[str],
    ...
    Description: NotRequired[str],
    ResourceArn: NotRequired[str],
    Steps: NotRequired[List[RecipeStepPaginatorTypeDef]],  # (1)
    Tags: NotRequired[Dict[str, str]],
    RecipeVersion: NotRequired[str],
```

1. See [:material-code-braces: RecipeStepPaginatorTypeDef](./type_defs.md#recipesteppaginatortypedef) 
...
class JobPaginatorTypeDef(TypedDict):
    ...
    Outputs: NotRequired[List[OutputPaginatorTypeDef]],  # (4)
...
4. See [:material-code-braces: OutputPaginatorTypeDef](./type_defs.md#outputpaginatortypedef) 
...
class DatasetPaginatorTypeDef(TypedDict):
    ...
    FormatOptions: NotRequired[FormatOptionsPaginatorTypeDef],  # (2)
    LastModifiedDate: NotRequired[datetime],
    LastModifiedBy: NotRequired[str],
    Source: NotRequired[SourceType],  # (4)
    PathOptions: NotRequired[PathOptionsPaginatorTypeDef],  # (5)
    Tags: NotRequired[Dict[str, str]],
    ResourceArn: NotRequired[str],
```

1. See [:material-code-brackets: InputFormatType](./literals.md#inputformattype) 
2. See [:material-code-braces: FormatOptionsPaginatorTypeDef](./type_defs.md#formatoptionspaginatortypedef) 
...
5. See [:material-code-braces: PathOptionsPaginatorTypeDef](./type_defs.md#pathoptionspaginatortypedef) 
...
```python
# ListRecipeVersionsResponsePaginatorTypeDef definition

class ListRecipeVersionsResponsePaginatorTypeDef(TypedDict):
    NextToken: str,
    Recipes: List[RecipePaginatorTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: RecipePaginatorTypeDef](./type_defs.md#recipepaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
## ListRecipesResponsePaginatorTypeDef

```python
# ListRecipesResponsePaginatorTypeDef definition

class ListRecipesResponsePaginatorTypeDef(TypedDict):
    Recipes: List[RecipePaginatorTypeDef],  # (1)
    NextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```
...
1. See [:material-code-braces: DatasetPaginatorTypeDef](./type_defs.md#datasetpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
