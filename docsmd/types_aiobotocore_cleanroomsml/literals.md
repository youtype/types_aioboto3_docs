...
```python
# AudienceModelMetricTypeType usage example

from types_aiobotocore_cleanroomsml.literals import AudienceModelMetricTypeType

def get_value() -> AudienceModelMetricTypeType:
    return "MEAN_RECIPROCAL_RANK"
```

```python
# AudienceModelMetricTypeType definition
