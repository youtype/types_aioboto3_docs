...
3. item: [:material-code-braces: ListMessagesResponsePaginatorTypeDef](./type_defs.md#listmessagesresponsepaginatortypedef) 
...
1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListMessagesResponsePaginatorTypeDef](./type_defs.md#listmessagesresponsepaginatortypedef) 
