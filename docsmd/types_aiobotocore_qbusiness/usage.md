...
async with session.client("qbusiness") as client:  # (1)
    kwargs: AssociatePermissionRequestRequestTypeDef = {...}  # (2)
    result: AssociatePermissionResponseTypeDef = await client.associate_permission(**kwargs)  # (3)
```

1. client: [QBusinessClient](./client.md)
2. kwargs: [:material-code-braces: AssociatePermissionRequestRequestTypeDef](./type_defs.md#associatepermissionrequestrequesttypedef) 
