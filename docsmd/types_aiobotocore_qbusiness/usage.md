...
async with session.client("qbusiness") as client:  # (1)
    kwargs: BatchDeleteDocumentRequestRequestTypeDef = {...}  # (2)
    result: BatchDeleteDocumentResponseTypeDef = await client.batch_delete_document(**kwargs)  # (3)
```

1. client: [QBusinessClient](./client.md)
2. kwargs: [:material-code-braces: BatchDeleteDocumentRequestRequestTypeDef](./type_defs.md#batchdeletedocumentrequestrequesttypedef) 
3. result: [:material-code-braces: BatchDeleteDocumentResponseTypeDef](./type_defs.md#batchdeletedocumentresponsetypedef) 
