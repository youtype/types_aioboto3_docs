...
4. See [:material-code-braces: ChatSyncOutputTypeDef](./type_defs.md#chatsyncoutputtypedef) 
...
Type annotations and code completion for `#!python session.client("qbusiness").close` method.
...
3. See [:material-code-braces: TagTypeDef](./type_defs.md#tagtypedef) 
4. See [:material-code-braces: CreatePluginResponseTypeDef](./type_defs.md#createpluginresponsetypedef) 
...
2. See [:material-code-braces: TagTypeDef](./type_defs.md#tagtypedef) 
3. See [:material-code-braces: CreateWebExperienceResponseTypeDef](./type_defs.md#createwebexperienceresponsetypedef) 
...
Type annotations and code completion for `#!python session.client("qbusiness").delete_group` method.
...
Type annotations and code completion for `#!python session.client("qbusiness").list_web_experiences` method.
...
await def update_chat_controls_configuration(
    ...
    *,
    ...
    topicConfigurationsToCreateOrUpdate: Sequence[TopicConfigurationTypeDef] = ...,  # (3)
    topicConfigurationsToDelete: Sequence[TopicConfigurationTypeDef] = ...,  # (3)
) -> Dict[str, Any]:
    ...
```
