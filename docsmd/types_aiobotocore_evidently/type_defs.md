...
1. See [:material-code-braces: SegmentOverridePaginatorTypeDef](./type_defs.md#segmentoverridepaginatortypedef) 
...
1. See [:material-code-braces: ScheduledSplitPaginatorTypeDef](./type_defs.md#scheduledsplitpaginatortypedef) 
...
2. See [:material-code-braces: LaunchGroupTypeDef](./type_defs.md#launchgrouptypedef) 
3. See [:material-code-braces: MetricMonitorTypeDef](./type_defs.md#metricmonitortypedef) 
4. See [:material-code-braces: ScheduledSplitsLaunchDefinitionPaginatorTypeDef](./type_defs.md#scheduledsplitslaunchdefinitionpaginatortypedef) 
5. See [:material-code-brackets: LaunchStatusType](./literals.md#launchstatustype) 
6. See [:material-code-brackets: LaunchTypeType](./literals.md#launchtypetype) 
...
1. See [:material-code-braces: LaunchPaginatorTypeDef](./type_defs.md#launchpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
