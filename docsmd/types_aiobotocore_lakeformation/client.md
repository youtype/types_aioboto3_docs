...
2. See [:material-code-braces: CreateLakeFormationIdentityCenterConfigurationResponseTypeDef](./type_defs.md#createlakeformationidentitycenterconfigurationresponsetypedef) 
...
await def update_lake_formation_identity_center_configuration(
    ...
    *,
    ...
    ExternalFiltering: ExternalFilteringConfigurationTypeDef = ...,  # (2)
) -> Dict[str, Any]:
    ...
```
