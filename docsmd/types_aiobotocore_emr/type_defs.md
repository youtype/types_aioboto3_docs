...
1. See [:material-code-braces: CloudWatchAlarmDefinitionPaginatorTypeDef](./type_defs.md#cloudwatchalarmdefinitionpaginatortypedef) 
...
2. See [:material-code-braces: ScalingTriggerPaginatorTypeDef](./type_defs.md#scalingtriggerpaginatortypedef) 
## ScalingRuleTypeDef
...
3. See [:material-code-braces: ScalingRulePaginatorTypeDef](./type_defs.md#scalingrulepaginatortypedef) 
...
8. See [:material-code-braces: AutoScalingPolicyDescriptionPaginatorTypeDef](./type_defs.md#autoscalingpolicydescriptionpaginatortypedef) 
