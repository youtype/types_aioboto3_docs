...
class ServiceManagedEBSVolumeConfigurationTypeDef(TypedDict):
    ...
    tagSpecifications: NotRequired[Sequence[EBSTagSpecificationTypeDef]],  # (1)
...
class ServiceVolumeConfigurationTypeDef(TypedDict):
    name: str,
    managedEBSVolume: NotRequired[ServiceManagedEBSVolumeConfigurationTypeDef],  # (1)
```
...
class CreateServiceRequestRequestTypeDef(TypedDict):
    ...
    volumeConfigurations: NotRequired[Sequence[ServiceVolumeConfigurationTypeDef]],  # (14)
```
...
14. See [:material-code-braces: ServiceVolumeConfigurationTypeDef](./type_defs.md#servicevolumeconfigurationtypedef) 
## DeploymentTypeDef
...
class DeploymentTypeDef(TypedDict):
    ...
    volumeConfigurations: NotRequired[List[ServiceVolumeConfigurationTypeDef]],  # (7)
```
...
7. See [:material-code-braces: ServiceVolumeConfigurationTypeDef](./type_defs.md#servicevolumeconfigurationtypedef) 
