...
class CreateSessionOutputTypeDef(TypedDict):
    Credentials: SessionCredentialsTypeDef,  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: SessionCredentialsTypeDef](./type_defs.md#sessioncredentialstypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
```python
# TargetObjectKeyFormatBucketLoggingTypeDef definition

class TargetObjectKeyFormatBucketLoggingTypeDef(TypedDict):
...
class LoggingEnabledBucketLoggingTypeDef(TypedDict):
    ...
    TargetObjectKeyFormat: NotRequired[TargetObjectKeyFormatBucketLoggingTypeDef],  # (2)
```

1. See [:material-code-braces: TargetGrantTypeDef](./type_defs.md#targetgranttypedef) 
2. See [:material-code-braces: TargetObjectKeyFormatBucketLoggingTypeDef](./type_defs.md#targetobjectkeyformatbucketloggingtypedef) 
...
class LoggingEnabledResponseTypeDef(TypedDict):
    ...
    TargetPrefix: str,
    TargetObjectKeyFormat: TargetObjectKeyFormatBucketLoggingTypeDef,  # (2)
    ResponseMetadata: ResponseMetadataTypeDef,  # (3)
```
