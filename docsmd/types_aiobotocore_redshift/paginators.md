...
async with session.client("redshift") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: DescribeRedshiftIdcApplicationsResultPaginatorTypeDef
        print(item)  # (3)
```

1. client: [RedshiftClient](./client.md)
2. paginator: [DescribeRedshiftIdcApplicationsPaginator](./paginators.md#describeredshiftidcapplicationspaginator)
3. item: [:material-code-braces: DescribeRedshiftIdcApplicationsResultPaginatorTypeDef](./type_defs.md#describeredshiftidcapplicationsresultpaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[DescribeRedshiftIdcApplicationsResultPaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: DescribeRedshiftIdcApplicationsResultPaginatorTypeDef](./type_defs.md#describeredshiftidcapplicationsresultpaginatortypedef) 
