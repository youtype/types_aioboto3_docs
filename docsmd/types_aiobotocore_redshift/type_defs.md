...
```python
# AuthorizedTokenIssuerPaginatorTypeDef definition

class AuthorizedTokenIssuerPaginatorTypeDef(TypedDict):
...
```python
# ServiceIntegrationsUnionPaginatorTypeDef definition

class ServiceIntegrationsUnionPaginatorTypeDef(TypedDict):
...
```python
# RedshiftIdcApplicationPaginatorTypeDef definition

class RedshiftIdcApplicationPaginatorTypeDef(TypedDict):
    ...
    AuthorizedTokenIssuerList: NotRequired[List[AuthorizedTokenIssuerPaginatorTypeDef]],  # (1)
    ServiceIntegrations: NotRequired[List[ServiceIntegrationsUnionPaginatorTypeDef]],  # (2)
```

1. See [:material-code-braces: AuthorizedTokenIssuerPaginatorTypeDef](./type_defs.md#authorizedtokenissuerpaginatortypedef) 
2. See [:material-code-braces: ServiceIntegrationsUnionPaginatorTypeDef](./type_defs.md#serviceintegrationsunionpaginatortypedef) 
...
class RedshiftIdcApplicationTypeDef(TypedDict):
    ...
    IdcManagedApplicationArn: NotRequired[str],
    IdcOnboardStatus: NotRequired[str],
    AuthorizedTokenIssuerList: NotRequired[List[AuthorizedTokenIssuerTypeDef]],  # (1)
    ServiceIntegrations: NotRequired[List[ServiceIntegrationsUnionTypeDef]],  # (2)
```
...
```python
# DescribeRedshiftIdcApplicationsResultPaginatorTypeDef definition

class DescribeRedshiftIdcApplicationsResultPaginatorTypeDef(TypedDict):
    RedshiftIdcApplications: List[RedshiftIdcApplicationPaginatorTypeDef],  # (1)
    Marker: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: RedshiftIdcApplicationPaginatorTypeDef](./type_defs.md#redshiftidcapplicationpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
