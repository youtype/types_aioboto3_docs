...
async with session.client("autoscaling") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: AutoScalingGroupsTypePaginatorTypeDef
        print(item)  # (3)
```
...
3. item: [:material-code-braces: AutoScalingGroupsTypePaginatorTypeDef](./type_defs.md#autoscalinggroupstypepaginatortypedef) 
...
) -> AsyncIterator[AutoScalingGroupsTypePaginatorTypeDef]:  # (3)
    ...
```

1. See [:material-code-braces: FilterTypeDef](./type_defs.md#filtertypedef) 
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
3. See [:material-code-braces: AutoScalingGroupsTypePaginatorTypeDef](./type_defs.md#autoscalinggroupstypepaginatortypedef) 
