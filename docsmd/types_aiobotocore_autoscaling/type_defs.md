...
## InstanceRequirementsPaginatorTypeDef

```python
# InstanceRequirementsPaginatorTypeDef definition

class InstanceRequirementsPaginatorTypeDef(TypedDict):
...
## LaunchTemplateOverridesPaginatorTypeDef

```python
# LaunchTemplateOverridesPaginatorTypeDef definition

class LaunchTemplateOverridesPaginatorTypeDef(TypedDict):
    InstanceType: NotRequired[str],
    WeightedCapacity: NotRequired[str],
    LaunchTemplateSpecification: NotRequired[LaunchTemplateSpecificationTypeDef],  # (1)
    InstanceRequirements: NotRequired[InstanceRequirementsPaginatorTypeDef],  # (2)
```

1. See [:material-code-braces: LaunchTemplateSpecificationTypeDef](./type_defs.md#launchtemplatespecificationtypedef) 
2. See [:material-code-braces: InstanceRequirementsPaginatorTypeDef](./type_defs.md#instancerequirementspaginatortypedef) 
...
## LaunchTemplatePaginatorTypeDef

```python
# LaunchTemplatePaginatorTypeDef definition

class LaunchTemplatePaginatorTypeDef(TypedDict):
    LaunchTemplateSpecification: NotRequired[LaunchTemplateSpecificationTypeDef],  # (1)
    Overrides: NotRequired[List[LaunchTemplateOverridesPaginatorTypeDef]],  # (2)
```

1. See [:material-code-braces: LaunchTemplateSpecificationTypeDef](./type_defs.md#launchtemplatespecificationtypedef) 
2. See [:material-code-braces: LaunchTemplateOverridesPaginatorTypeDef](./type_defs.md#launchtemplateoverridespaginatortypedef) 
...
## MixedInstancesPolicyPaginatorTypeDef

```python
# MixedInstancesPolicyPaginatorTypeDef definition

class MixedInstancesPolicyPaginatorTypeDef(TypedDict):
    LaunchTemplate: NotRequired[LaunchTemplatePaginatorTypeDef],  # (1)
    InstancesDistribution: NotRequired[InstancesDistributionTypeDef],  # (2)
```

1. See [:material-code-braces: LaunchTemplatePaginatorTypeDef](./type_defs.md#launchtemplatepaginatortypedef) 
...
```python
# AutoScalingGroupPaginatorTypeDef definition

class AutoScalingGroupPaginatorTypeDef(TypedDict):
    AutoScalingGroupName: str,
    MinSize: int,
    MaxSize: int,
    DesiredCapacity: int,
    ...
    LaunchConfigurationName: NotRequired[str],
    LaunchTemplate: NotRequired[LaunchTemplateSpecificationTypeDef],  # (1)
    MixedInstancesPolicy: NotRequired[MixedInstancesPolicyPaginatorTypeDef],  # (2)
...
1. See [:material-code-braces: LaunchTemplateSpecificationTypeDef](./type_defs.md#launchtemplatespecificationtypedef) 
2. See [:material-code-braces: MixedInstancesPolicyPaginatorTypeDef](./type_defs.md#mixedinstancespolicypaginatortypedef) 
...
## AutoScalingGroupsTypePaginatorTypeDef

```python
# AutoScalingGroupsTypePaginatorTypeDef definition

class AutoScalingGroupsTypePaginatorTypeDef(TypedDict):
    AutoScalingGroups: List[AutoScalingGroupPaginatorTypeDef],  # (1)
    NextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: AutoScalingGroupPaginatorTypeDef](./type_defs.md#autoscalinggrouppaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
