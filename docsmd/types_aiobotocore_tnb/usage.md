...
async with session.client("tnb") as client:  # (1)
    kwargs: CancelSolNetworkOperationInputRequestTypeDef = {...}  # (2)
    result: EmptyResponseMetadataTypeDef = await client.cancel_sol_network_operation(**kwargs)  # (3)
```

1. client: [TelcoNetworkBuilderClient](./client.md)
2. kwargs: [:material-code-braces: CancelSolNetworkOperationInputRequestTypeDef](./type_defs.md#cancelsolnetworkoperationinputrequesttypedef) 
