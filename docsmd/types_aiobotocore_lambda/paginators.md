...
async with session.client("lambda") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListAliasesResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [LambdaClient](./client.md)
2. paginator: [ListAliasesPaginator](./paginators.md#listaliasespaginator)
3. item: [:material-code-braces: ListAliasesResponsePaginatorTypeDef](./type_defs.md#listaliasesresponsepaginatortypedef) 
...
) -> AsyncIterator[ListAliasesResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListAliasesResponsePaginatorTypeDef](./type_defs.md#listaliasesresponsepaginatortypedef) 
...
async with session.client("lambda") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListCodeSigningConfigsResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [LambdaClient](./client.md)
2. paginator: [ListCodeSigningConfigsPaginator](./paginators.md#listcodesigningconfigspaginator)
3. item: [:material-code-braces: ListCodeSigningConfigsResponsePaginatorTypeDef](./type_defs.md#listcodesigningconfigsresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListCodeSigningConfigsResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListCodeSigningConfigsResponsePaginatorTypeDef](./type_defs.md#listcodesigningconfigsresponsepaginatortypedef) 
...
async with session.client("lambda") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListEventSourceMappingsResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [LambdaClient](./client.md)
2. paginator: [ListEventSourceMappingsPaginator](./paginators.md#listeventsourcemappingspaginator)
3. item: [:material-code-braces: ListEventSourceMappingsResponsePaginatorTypeDef](./type_defs.md#listeventsourcemappingsresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    FunctionName: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListEventSourceMappingsResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListEventSourceMappingsResponsePaginatorTypeDef](./type_defs.md#listeventsourcemappingsresponsepaginatortypedef) 
...
async with session.client("lambda") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListFunctionUrlConfigsResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [LambdaClient](./client.md)
2. paginator: [ListFunctionUrlConfigsPaginator](./paginators.md#listfunctionurlconfigspaginator)
3. item: [:material-code-braces: ListFunctionUrlConfigsResponsePaginatorTypeDef](./type_defs.md#listfunctionurlconfigsresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    FunctionName: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListFunctionUrlConfigsResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListFunctionUrlConfigsResponsePaginatorTypeDef](./type_defs.md#listfunctionurlconfigsresponsepaginatortypedef) 
...
async with session.client("lambda") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListFunctionsResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [LambdaClient](./client.md)
2. paginator: [ListFunctionsPaginator](./paginators.md#listfunctionspaginator)
3. item: [:material-code-braces: ListFunctionsResponsePaginatorTypeDef](./type_defs.md#listfunctionsresponsepaginatortypedef) 
...
) -> AsyncIterator[ListFunctionsResponsePaginatorTypeDef]:  # (3)
    ...
```

1. See [:material-code-brackets: FunctionVersionType](./literals.md#functionversiontype) 
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
3. See [:material-code-braces: ListFunctionsResponsePaginatorTypeDef](./type_defs.md#listfunctionsresponsepaginatortypedef) 
...
async with session.client("lambda") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListVersionsByFunctionResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [LambdaClient](./client.md)
2. paginator: [ListVersionsByFunctionPaginator](./paginators.md#listversionsbyfunctionpaginator)
3. item: [:material-code-braces: ListVersionsByFunctionResponsePaginatorTypeDef](./type_defs.md#listversionsbyfunctionresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    FunctionName: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListVersionsByFunctionResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListVersionsByFunctionResponsePaginatorTypeDef](./type_defs.md#listversionsbyfunctionresponsepaginatortypedef) 
