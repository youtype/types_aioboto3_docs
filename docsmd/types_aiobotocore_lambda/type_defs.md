...
```python
# SelfManagedEventSourcePaginatorTypeDef definition

class SelfManagedEventSourcePaginatorTypeDef(TypedDict):
...
```python
# ImageConfigPaginatorTypeDef definition

class ImageConfigPaginatorTypeDef(TypedDict):
...
```python
# AliasConfigurationPaginatorTypeDef definition

class AliasConfigurationPaginatorTypeDef(TypedDict):
    AliasArn: NotRequired[str],
    Name: NotRequired[str],
    FunctionVersion: NotRequired[str],
    Description: NotRequired[str],
    RoutingConfig: NotRequired[AliasRoutingConfigurationPaginatorTypeDef],  # (1)
    RevisionId: NotRequired[str],
```

1. See [:material-code-braces: AliasRoutingConfigurationPaginatorTypeDef](./type_defs.md#aliasroutingconfigurationpaginatortypedef) 
...
```python
# CodeSigningConfigPaginatorTypeDef definition

class CodeSigningConfigPaginatorTypeDef(TypedDict):
    CodeSigningConfigId: str,
    CodeSigningConfigArn: str,
    AllowedPublishers: AllowedPublishersPaginatorTypeDef,  # (1)
    CodeSigningPolicies: CodeSigningPoliciesTypeDef,  # (2)
    LastModified: str,
    Description: NotRequired[str],
```

1. See [:material-code-braces: AllowedPublishersPaginatorTypeDef](./type_defs.md#allowedpublisherspaginatortypedef) 
...
```python
# FunctionUrlConfigPaginatorTypeDef definition

class FunctionUrlConfigPaginatorTypeDef(TypedDict):
    FunctionUrl: str,
    FunctionArn: str,
    CreationTime: str,
    LastModifiedTime: str,
    AuthType: FunctionUrlAuthTypeType,  # (2)
    Cors: NotRequired[CorsPaginatorTypeDef],  # (1)
    InvokeMode: NotRequired[InvokeModeType],  # (3)
```

1. See [:material-code-braces: CorsPaginatorTypeDef](./type_defs.md#corspaginatortypedef) 
...
```python
# ImageConfigResponsePaginatorTypeDef definition

class ImageConfigResponsePaginatorTypeDef(TypedDict):
    ImageConfig: NotRequired[ImageConfigPaginatorTypeDef],  # (1)
    Error: NotRequired[ImageConfigErrorTypeDef],  # (2)
```

1. See [:material-code-braces: ImageConfigPaginatorTypeDef](./type_defs.md#imageconfigpaginatortypedef) 
2. See [:material-code-braces: ImageConfigErrorTypeDef](./type_defs.md#imageconfigerrortypedef) 
...
```python
# ListAliasesResponsePaginatorTypeDef definition

class ListAliasesResponsePaginatorTypeDef(TypedDict):
    NextMarker: str,
    Aliases: List[AliasConfigurationPaginatorTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: AliasConfigurationPaginatorTypeDef](./type_defs.md#aliasconfigurationpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
```python
# ListCodeSigningConfigsResponsePaginatorTypeDef definition

class ListCodeSigningConfigsResponsePaginatorTypeDef(TypedDict):
    NextMarker: str,
    CodeSigningConfigs: List[CodeSigningConfigPaginatorTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: CodeSigningConfigPaginatorTypeDef](./type_defs.md#codesigningconfigpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
```python
# ListFunctionUrlConfigsResponsePaginatorTypeDef definition

class ListFunctionUrlConfigsResponsePaginatorTypeDef(TypedDict):
    FunctionUrlConfigs: List[FunctionUrlConfigPaginatorTypeDef],  # (1)
    NextMarker: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: FunctionUrlConfigPaginatorTypeDef](./type_defs.md#functionurlconfigpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
```python
# EventSourceMappingConfigurationPaginatorTypeDef definition

class EventSourceMappingConfigurationPaginatorTypeDef(TypedDict):
    ...
    EventSourceArn: NotRequired[str],
    FilterCriteria: NotRequired[FilterCriteriaPaginatorTypeDef],  # (2)
    FunctionArn: NotRequired[str],
    LastModified: NotRequired[datetime],
    ...
    SelfManagedEventSource: NotRequired[SelfManagedEventSourcePaginatorTypeDef],  # (5)
...
2. See [:material-code-braces: FilterCriteriaPaginatorTypeDef](./type_defs.md#filtercriteriapaginatortypedef) 
...
5. See [:material-code-braces: SelfManagedEventSourcePaginatorTypeDef](./type_defs.md#selfmanagedeventsourcepaginatortypedef) 
...
```python
# FunctionConfigurationPaginatorTypeDef definition

class FunctionConfigurationPaginatorTypeDef(TypedDict):
    FunctionName: NotRequired[str],
    FunctionArn: NotRequired[str],
    ...
    ImageConfigResponse: NotRequired[ImageConfigResponsePaginatorTypeDef],  # (13)
    SigningProfileVersionArn: NotRequired[str],
    SigningJobArn: NotRequired[str],
...
13. See [:material-code-braces: ImageConfigResponsePaginatorTypeDef](./type_defs.md#imageconfigresponsepaginatortypedef) 
...
```python
# ListEventSourceMappingsResponsePaginatorTypeDef definition

class ListEventSourceMappingsResponsePaginatorTypeDef(TypedDict):
    NextMarker: str,
    EventSourceMappings: List[EventSourceMappingConfigurationPaginatorTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: EventSourceMappingConfigurationPaginatorTypeDef](./type_defs.md#eventsourcemappingconfigurationpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
```python
# ListFunctionsResponsePaginatorTypeDef definition

class ListFunctionsResponsePaginatorTypeDef(TypedDict):
    NextMarker: str,
    Functions: List[FunctionConfigurationPaginatorTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: FunctionConfigurationPaginatorTypeDef](./type_defs.md#functionconfigurationpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
## ListVersionsByFunctionResponsePaginatorTypeDef

```python
# ListVersionsByFunctionResponsePaginatorTypeDef definition

class ListVersionsByFunctionResponsePaginatorTypeDef(TypedDict):
    NextMarker: str,
    Versions: List[FunctionConfigurationPaginatorTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```
