...
async with session.client("ds") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: DescribeRegionsResultPaginatorTypeDef
        print(item)  # (3)
```

1. client: [DirectoryServiceClient](./client.md)
2. paginator: [DescribeRegionsPaginator](./paginators.md#describeregionspaginator)
3. item: [:material-code-braces: DescribeRegionsResultPaginatorTypeDef](./type_defs.md#describeregionsresultpaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    RegionName: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[DescribeRegionsResultPaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: DescribeRegionsResultPaginatorTypeDef](./type_defs.md#describeregionsresultpaginatortypedef) 
