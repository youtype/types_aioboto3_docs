...
## DirectoryVpcSettingsPaginatorTypeDef

```python
# DirectoryVpcSettingsPaginatorTypeDef definition

class DirectoryVpcSettingsPaginatorTypeDef(TypedDict):
    VpcId: str,
    SubnetIds: List[str],
```
...
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
## RegionDescriptionPaginatorTypeDef

```python
# RegionDescriptionPaginatorTypeDef definition

class RegionDescriptionPaginatorTypeDef(TypedDict):
    DirectoryId: NotRequired[str],
    RegionName: NotRequired[str],
    RegionType: NotRequired[RegionTypeType],  # (1)
    Status: NotRequired[DirectoryStageType],  # (2)
    VpcSettings: NotRequired[DirectoryVpcSettingsPaginatorTypeDef],  # (3)
    DesiredNumberOfDomainControllers: NotRequired[int],
    LaunchTime: NotRequired[datetime],
    StatusLastUpdatedDateTime: NotRequired[datetime],
    LastUpdatedDateTime: NotRequired[datetime],
...
1. See [:material-code-brackets: RegionTypeType](./literals.md#regiontypetype) 
2. See [:material-code-brackets: DirectoryStageType](./literals.md#directorystagetype) 
3. See [:material-code-braces: DirectoryVpcSettingsPaginatorTypeDef](./type_defs.md#directoryvpcsettingspaginatortypedef) 
...
## DescribeRegionsResultPaginatorTypeDef

```python
# DescribeRegionsResultPaginatorTypeDef definition

class DescribeRegionsResultPaginatorTypeDef(TypedDict):
    RegionsDescription: List[RegionDescriptionPaginatorTypeDef],  # (1)
    NextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: RegionDescriptionPaginatorTypeDef](./type_defs.md#regiondescriptionpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
