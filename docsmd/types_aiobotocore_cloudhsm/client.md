...
```python
# CloudHSMClient.exceptions type checking example
...
Type annotations and code completion for `#!python session.client("cloudhsm").close` method.
...
Type annotations and code completion for `#!python session.client("cloudhsm").create_hapg` method.
