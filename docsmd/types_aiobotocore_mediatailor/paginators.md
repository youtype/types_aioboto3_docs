...
async with session.client("mediatailor") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListChannelsResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [MediaTailorClient](./client.md)
2. paginator: [ListChannelsPaginator](./paginators.md#listchannelspaginator)
3. item: [:material-code-braces: ListChannelsResponsePaginatorTypeDef](./type_defs.md#listchannelsresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListChannelsResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListChannelsResponsePaginatorTypeDef](./type_defs.md#listchannelsresponsepaginatortypedef) 
...
async with session.client("mediatailor") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListPrefetchSchedulesResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [MediaTailorClient](./client.md)
2. paginator: [ListPrefetchSchedulesPaginator](./paginators.md#listprefetchschedulespaginator)
3. item: [:material-code-braces: ListPrefetchSchedulesResponsePaginatorTypeDef](./type_defs.md#listprefetchschedulesresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    StreamId: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListPrefetchSchedulesResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListPrefetchSchedulesResponsePaginatorTypeDef](./type_defs.md#listprefetchschedulesresponsepaginatortypedef) 
