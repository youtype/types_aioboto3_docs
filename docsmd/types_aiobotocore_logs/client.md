...
Type annotations and code completion for `#!python session.client("logs").close` method.
...
1. See [:material-code-braces: CreateDeliveryResponseTypeDef](./type_defs.md#createdeliveryresponsetypedef) 
