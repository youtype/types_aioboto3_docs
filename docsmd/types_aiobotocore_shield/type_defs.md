...
```python
# TimeRangePaginatorTypeDef definition

class TimeRangePaginatorTypeDef(TypedDict):
    FromInclusive: NotRequired[Union[datetime, str]],
    ToExclusive: NotRequired[Union[datetime, str]],
```
...
class ListAttacksRequestListAttacksPaginateTypeDef(TypedDict):
    ResourceArns: NotRequired[Sequence[str]],
    StartTime: NotRequired[TimeRangePaginatorTypeDef],  # (1)
    EndTime: NotRequired[TimeRangePaginatorTypeDef],  # (1)
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (3)
```

1. See [:material-code-braces: TimeRangePaginatorTypeDef](./type_defs.md#timerangepaginatortypedef) 
2. See [:material-code-braces: TimeRangePaginatorTypeDef](./type_defs.md#timerangepaginatortypedef) 
