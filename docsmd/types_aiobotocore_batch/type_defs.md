...
4. See [:material-code-braces: ComputeResourcePaginatorTypeDef](./type_defs.md#computeresourcepaginatortypedef) 
...
1. See [:material-code-braces: ComputeEnvironmentDetailPaginatorTypeDef](./type_defs.md#computeenvironmentdetailpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
