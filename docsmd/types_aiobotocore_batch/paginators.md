...
async with session.client("batch") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: DescribeComputeEnvironmentsResponsePaginatorTypeDef
        print(item)  # (3)
```
...
3. item: [:material-code-braces: DescribeComputeEnvironmentsResponsePaginatorTypeDef](./type_defs.md#describecomputeenvironmentsresponsepaginatortypedef) 
...
) -> AsyncIterator[DescribeComputeEnvironmentsResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: DescribeComputeEnvironmentsResponsePaginatorTypeDef](./type_defs.md#describecomputeenvironmentsresponsepaginatortypedef) 
