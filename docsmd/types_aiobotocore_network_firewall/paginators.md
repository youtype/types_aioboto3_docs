...
Type annotations and code completion for `#!python session.client("network-firewall").get_paginator("get_analysis_report_results")`.
...
Type annotations and code completion for `#!python session.client("network-firewall").get_paginator("list_analysis_reports")`.
