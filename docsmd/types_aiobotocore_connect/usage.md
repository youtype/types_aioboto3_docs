...
async with session.client("connect") as client:  # (1)
    kwargs: ActivateEvaluationFormRequestRequestTypeDef = {...}  # (2)
    result: ActivateEvaluationFormResponseTypeDef = await client.activate_evaluation_form(**kwargs)  # (3)
```

1. client: [ConnectClient](./client.md)
2. kwargs: [:material-code-braces: ActivateEvaluationFormRequestRequestTypeDef](./type_defs.md#activateevaluationformrequestrequesttypedef) 
