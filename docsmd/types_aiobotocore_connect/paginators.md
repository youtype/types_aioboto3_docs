...
async with session.client("connect") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: ListSecurityProfileApplicationsResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [ConnectClient](./client.md)
2. paginator: [ListSecurityProfileApplicationsPaginator](./paginators.md#listsecurityprofileapplicationspaginator)
3. item: [:material-code-braces: ListSecurityProfileApplicationsResponsePaginatorTypeDef](./type_defs.md#listsecurityprofileapplicationsresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    InstanceId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListSecurityProfileApplicationsResponsePaginatorTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListSecurityProfileApplicationsResponsePaginatorTypeDef](./type_defs.md#listsecurityprofileapplicationsresponsepaginatortypedef) 
...
Type annotations and code completion for `#!python session.client("connect").get_paginator("search_hours_of_operations")`.
...
Type annotations and code completion for `#!python session.client("connect").get_paginator("search_predefined_attributes")`.
...
async with session.client("connect") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: SearchPredefinedAttributesResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [ConnectClient](./client.md)
2. paginator: [SearchPredefinedAttributesPaginator](./paginators.md#searchpredefinedattributespaginator)
3. item: [:material-code-braces: SearchPredefinedAttributesResponsePaginatorTypeDef](./type_defs.md#searchpredefinedattributesresponsepaginatortypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[SearchPredefinedAttributesResponsePaginatorTypeDef]:  # (3)
    ...
```
...
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
3. See [:material-code-braces: SearchPredefinedAttributesResponsePaginatorTypeDef](./type_defs.md#searchpredefinedattributesresponsepaginatortypedef) 
...
Type annotations and code completion for `#!python session.client("connect").get_paginator("search_prompts")`.
...
Type annotations and code completion for `#!python session.client("connect").get_paginator("search_queues")`.
...
Type annotations and code completion for `#!python session.client("connect").get_paginator("search_quick_connects")`.
...
Type annotations and code completion for `#!python session.client("connect").get_paginator("search_resource_tags")`.
...
Type annotations and code completion for `#!python session.client("connect").get_paginator("search_routing_profiles")`.
...
Type annotations and code completion for `#!python session.client("connect").get_paginator("search_security_profiles")`.
...
Type annotations and code completion for `#!python session.client("connect").get_paginator("search_users")`.
...
Type annotations and code completion for `#!python session.client("connect").get_paginator("search_vocabularies")`.
