...
Type annotations and code completion for `#!python session.client("migrationhubstrategy").close` method.
...
await def start_assessment(
    ...
    *,
    ...
    assessmentTargets: Sequence[AssessmentTargetTypeDef] = ...,  # (2)
...
2. See [:material-code-braces: AssessmentTargetTypeDef](./type_defs.md#assessmenttargettypedef) 
