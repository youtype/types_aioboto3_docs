...
```python
# WAFClient.exceptions type checking example
...
Type annotations and code completion for `#!python session.client("waf").close` method.
...
Type annotations and code completion for `#!python session.client("waf").update_sql_injection_match_set` method.
