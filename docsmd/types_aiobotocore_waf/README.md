...
1. Run mypy-boto3-builder in your package root directory: `uvx --with 'aioboto3==14.0.0' mypy-boto3-builder`
...
Install `types-aioboto3` for `WAF` service.

```bash
# install with aioboto3 type annotations
python -m pip install 'types-aioboto3[waf]'

# Lite version does not provide session.client/resource overloads
# it is more RAM-friendly, but requires explicit type annotations
python -m pip install 'types-aioboto3-lite[waf]'
...
Type annotations and code completion for  `#!python session.client("waf")` as [WAFClient](./client.md)
...
from `#!python session.client("waf").get_paginator("...")`.
