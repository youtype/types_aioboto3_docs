...
3. item: [:material-code-braces: ListConnectorsResponsePaginatorTypeDef](./type_defs.md#listconnectorsresponsepaginatortypedef) 
...
2. See [:material-code-braces: ListConnectorsResponsePaginatorTypeDef](./type_defs.md#listconnectorsresponsepaginatortypedef) 
...
3. item: [:material-code-braces: ListTemplatesResponsePaginatorTypeDef](./type_defs.md#listtemplatesresponsepaginatortypedef) 
...
1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: ListTemplatesResponsePaginatorTypeDef](./type_defs.md#listtemplatesresponsepaginatortypedef) 
