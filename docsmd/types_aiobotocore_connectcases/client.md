...
Type annotations and code completion for `#!python session.client("connectcases").close` method.
...
Type annotations and code completion for `#!python session.client("connectcases").list_tags_for_resource` method.
