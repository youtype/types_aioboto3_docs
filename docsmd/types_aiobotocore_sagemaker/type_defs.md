...
1. See [:material-code-braces: CollectionConfigurationPaginatorTypeDef](./type_defs.md#collectionconfigurationpaginatortypedef) 
...
1. See [:material-code-braces: S3DataSourcePaginatorTypeDef](./type_defs.md#s3datasourcepaginatortypedef) 
...
2. See [:material-code-braces: ContainerConfigPaginatorTypeDef](./type_defs.md#containerconfigpaginatortypedef) 
...
1. See [:material-code-braces: FileSystemConfigTypeDef](./type_defs.md#filesystemconfigtypedef) 
2. See [:material-code-braces: ContainerConfigTypeDef](./type_defs.md#containerconfigtypedef) 
...
1. See [:material-code-braces: VpcConfigPaginatorTypeDef](./type_defs.md#vpcconfigpaginatortypedef) 
...
1. See [:material-code-brackets: InferenceExperimentTypeType](./literals.md#inferenceexperimenttypetype) 
2. See [:material-code-braces: InferenceExperimentSchedulePaginatorTypeDef](./type_defs.md#inferenceexperimentschedulepaginatortypedef) 
...
3. See [:material-code-braces: CategoricalParameterRangePaginatorTypeDef](./type_defs.md#categoricalparameterrangepaginatortypedef) 
...
2. See [:material-code-braces: OidcMemberDefinitionPaginatorTypeDef](./type_defs.md#oidcmemberdefinitionpaginatortypedef) 
...
class ModelPackageContainerDefinitionTypeDef(TypedDict):
    ...
    AdditionalS3DataSource: NotRequired[AdditionalS3DataSourceTypeDef],  # (2)
```

1. See [:material-code-braces: ModelInputTypeDef](./type_defs.md#modelinputtypedef) 
2. See [:material-code-braces: AdditionalS3DataSourceTypeDef](./type_defs.md#additionals3datasourcetypedef) 
...
1. See [:material-code-braces: SourceIpConfigPaginatorTypeDef](./type_defs.md#sourceipconfigpaginatortypedef) 
...
3. See [:material-code-braces: DockerSettingsTypeDef](./type_defs.md#dockersettingstypedef) 
...
1. See [:material-code-braces: ArtifactSourcePaginatorTypeDef](./type_defs.md#artifactsourcepaginatortypedef) 
...
3. See [:material-code-braces: AutoMLCandidateGenerationConfigTypeDef](./type_defs.md#automlcandidategenerationconfigtypedef) 
...
1. See [:material-code-brackets: ProductionVariantInstanceTypeType](./literals.md#productionvariantinstancetypetype) 
2. See [:material-code-braces: ProductionVariantServerlessConfigTypeDef](./type_defs.md#productionvariantserverlessconfigtypedef) 
3. See [:material-code-braces: EnvironmentParameterRangesTypeDef](./type_defs.md#environmentparameterrangestypedef) 
...
1. See [:material-code-braces: DataSourcePaginatorTypeDef](./type_defs.md#datasourcepaginatortypedef) 
2. See [:material-code-brackets: CompressionTypeType](./literals.md#compressiontypetype) 
...
8. See [:material-code-braces: CodeEditorAppSettingsTypeDef](./type_defs.md#codeeditorappsettingstypedef) 
9. See [:material-code-braces: JupyterLabAppSettingsTypeDef](./type_defs.md#jupyterlabappsettingstypedef) 
...
4. See [:material-code-braces: SpaceJupyterLabAppSettingsTypeDef](./type_defs.md#spacejupyterlabappsettingstypedef) 
...
1. See [:material-code-braces: InferenceExperimentSummaryPaginatorTypeDef](./type_defs.md#inferenceexperimentsummarypaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
5. See [:material-code-braces: ParameterRangesPaginatorTypeDef](./type_defs.md#parameterrangespaginatortypedef) 
...
1. See [:material-code-braces: KernelGatewayImageConfigPaginatorTypeDef](./type_defs.md#kernelgatewayimageconfigpaginatortypedef) 
2. See [:material-code-braces: JupyterLabAppImageConfigPaginatorTypeDef](./type_defs.md#jupyterlabappimageconfigpaginatortypedef) 
...
2. See [:material-code-braces: LabelingJobDataAttributesPaginatorTypeDef](./type_defs.md#labelingjobdataattributespaginatortypedef) 
...
1. See [:material-code-braces: MemberDefinitionPaginatorTypeDef](./type_defs.md#memberdefinitionpaginatortypedef) 
...
1. See [:material-code-braces: MonitoringDatasetFormatPaginatorTypeDef](./type_defs.md#monitoringdatasetformatpaginatortypedef) 
2. See [:material-code-brackets: ProcessingS3InputModeType](./literals.md#processings3inputmodetype) 
3. See [:material-code-brackets: ProcessingS3DataDistributionTypeType](./literals.md#processings3datadistributiontypetype) 
...
1. See [:material-code-braces: ServiceCatalogProvisioningDetailsPaginatorTypeDef](./type_defs.md#servicecatalogprovisioningdetailspaginatortypedef) 
...
1. See [:material-code-braces: WorkforcePaginatorTypeDef](./type_defs.md#workforcepaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
1. See [:material-code-braces: ArtifactSummaryPaginatorTypeDef](./type_defs.md#artifactsummarypaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
3. See [:material-code-braces: TimeSeriesForecastingJobConfigTypeDef](./type_defs.md#timeseriesforecastingjobconfigtypedef) 
4. See [:material-code-braces: TabularJobConfigTypeDef](./type_defs.md#tabularjobconfigtypedef) 
5. See [:material-code-braces: TextGenerationJobConfigTypeDef](./type_defs.md#textgenerationjobconfigtypedef) 
...
3. See [:material-code-braces: AutoRollbackConfigTypeDef](./type_defs.md#autorollbackconfigtypedef) 
...
2. See [:material-code-braces: ParameterRangesPaginatorTypeDef](./type_defs.md#parameterrangespaginatortypedef) 
3. See [:material-code-braces: HyperParameterAlgorithmSpecificationPaginatorTypeDef](./type_defs.md#hyperparameteralgorithmspecificationpaginatortypedef) 
4. See [:material-code-braces: ChannelPaginatorTypeDef](./type_defs.md#channelpaginatortypedef) 
5. See [:material-code-braces: VpcConfigPaginatorTypeDef](./type_defs.md#vpcconfigpaginatortypedef) 
6. See [:material-code-braces: OutputDataConfigTypeDef](./type_defs.md#outputdataconfigtypedef) 
7. See [:material-code-braces: ResourceConfigPaginatorTypeDef](./type_defs.md#resourceconfigpaginatortypedef) 
8. See [:material-code-braces: HyperParameterTuningResourceConfigPaginatorTypeDef](./type_defs.md#hyperparametertuningresourceconfigpaginatortypedef) 
...
8. See [:material-code-braces: HyperParameterTuningResourceConfigTypeDef](./type_defs.md#hyperparametertuningresourceconfigtypedef) 
9. See [:material-code-braces: StoppingConditionTypeDef](./type_defs.md#stoppingconditiontypedef) 
10. See [:material-code-braces: CheckpointConfigTypeDef](./type_defs.md#checkpointconfigtypedef) 
11. See [:material-code-braces: RetryStrategyTypeDef](./type_defs.md#retrystrategytypedef) 
...
4. See [:material-code-braces: DomainSettingsTypeDef](./type_defs.md#domainsettingstypedef) 
5. See [:material-code-brackets: AppNetworkAccessTypeType](./literals.md#appnetworkaccesstypetype) 
6. See [:material-code-brackets: AppSecurityGroupManagementType](./literals.md#appsecuritygroupmanagementtype) 
7. See [:material-code-braces: DefaultSpaceSettingsTypeDef](./type_defs.md#defaultspacesettingstypedef) 
8. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
1. See [:material-code-braces: AppImageConfigDetailsPaginatorTypeDef](./type_defs.md#appimageconfigdetailspaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
4. See [:material-code-braces: LabelingJobInputConfigPaginatorTypeDef](./type_defs.md#labelingjobinputconfigpaginatortypedef) 
...
1. See [:material-code-braces: WorkteamPaginatorTypeDef](./type_defs.md#workteampaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
4. See [:material-code-braces: MultiModelConfigTypeDef](./type_defs.md#multimodelconfigtypedef) 
...
2. See [:material-code-braces: BatchTransformInputPaginatorTypeDef](./type_defs.md#batchtransforminputpaginatortypedef) 
...
2. See [:material-code-braces: ProcessingOutputConfigPaginatorTypeDef](./type_defs.md#processingoutputconfigpaginatortypedef) 
...
5. See [:material-code-braces: AppSpecificationPaginatorTypeDef](./type_defs.md#appspecificationpaginatortypedef) 
6. See [:material-code-braces: NetworkConfigPaginatorTypeDef](./type_defs.md#networkconfigpaginatortypedef) 
...
4. See [:material-code-braces: AlgorithmSpecificationPaginatorTypeDef](./type_defs.md#algorithmspecificationpaginatortypedef) 
5. See [:material-code-braces: ChannelPaginatorTypeDef](./type_defs.md#channelpaginatortypedef) 
6. See [:material-code-braces: OutputDataConfigTypeDef](./type_defs.md#outputdataconfigtypedef) 
7. See [:material-code-braces: ResourceConfigPaginatorTypeDef](./type_defs.md#resourceconfigpaginatortypedef) 
8. See [:material-code-braces: VpcConfigPaginatorTypeDef](./type_defs.md#vpcconfigpaginatortypedef) 
9. See [:material-code-braces: StoppingConditionTypeDef](./type_defs.md#stoppingconditiontypedef) 
...
13. See [:material-code-braces: DebugHookConfigPaginatorTypeDef](./type_defs.md#debughookconfigpaginatortypedef) 
14. See [:material-code-braces: ExperimentConfigTypeDef](./type_defs.md#experimentconfigtypedef) 
15. See [:material-code-braces: DebugRuleConfigurationPaginatorTypeDef](./type_defs.md#debugruleconfigurationpaginatortypedef) 
...
18. See [:material-code-braces: ProfilerConfigPaginatorTypeDef](./type_defs.md#profilerconfigpaginatortypedef) 
...
14. See [:material-code-braces: DebugHookConfigTypeDef](./type_defs.md#debughookconfigtypedef) 
15. See [:material-code-braces: ExperimentConfigTypeDef](./type_defs.md#experimentconfigtypedef) 
16. See [:material-code-braces: DebugRuleConfigurationTypeDef](./type_defs.md#debugruleconfigurationtypedef) 
...
19. See [:material-code-braces: ProfilerConfigTypeDef](./type_defs.md#profilerconfigtypedef) 
20. See [:material-code-braces: ProfilerRuleConfigurationTypeDef](./type_defs.md#profilerruleconfigurationtypedef) 
...
15. See [:material-code-braces: AutoMLSecurityConfigTypeDef](./type_defs.md#automlsecurityconfigtypedef) 
...
1. See [:material-code-braces: HyperParameterTuningJobConfigPaginatorTypeDef](./type_defs.md#hyperparametertuningjobconfigpaginatortypedef) 
2. See [:material-code-braces: HyperParameterTrainingJobDefinitionPaginatorTypeDef](./type_defs.md#hyperparametertrainingjobdefinitionpaginatortypedef) 
3. See [:material-code-braces: HyperParameterTrainingJobDefinitionPaginatorTypeDef](./type_defs.md#hyperparametertrainingjobdefinitionpaginatortypedef) 
...
9. See [:material-code-braces: HyperParameterTuningJobWarmStartConfigPaginatorTypeDef](./type_defs.md#hyperparametertuningjobwarmstartconfigpaginatortypedef) 
...
1. See [:material-code-braces: LabelingJobSummaryPaginatorTypeDef](./type_defs.md#labelingjobsummarypaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
1. See [:material-code-braces: ContainerDefinitionPaginatorTypeDef](./type_defs.md#containerdefinitionpaginatortypedef) 
2. See [:material-code-braces: ContainerDefinitionPaginatorTypeDef](./type_defs.md#containerdefinitionpaginatortypedef) 
3. See [:material-code-braces: InferenceExecutionConfigTypeDef](./type_defs.md#inferenceexecutionconfigtypedef) 
4. See [:material-code-braces: VpcConfigPaginatorTypeDef](./type_defs.md#vpcconfigpaginatortypedef) 
5. See [:material-code-braces: TagTypeDef](./type_defs.md#tagtypedef) 
...
2. See [:material-code-braces: MonitoringInputPaginatorTypeDef](./type_defs.md#monitoringinputpaginatortypedef) 
3. See [:material-code-braces: MonitoringOutputConfigPaginatorTypeDef](./type_defs.md#monitoringoutputconfigpaginatortypedef) 
4. See [:material-code-braces: MonitoringResourcesTypeDef](./type_defs.md#monitoringresourcestypedef) 
5. See [:material-code-braces: MonitoringAppSpecificationPaginatorTypeDef](./type_defs.md#monitoringappspecificationpaginatortypedef) 
6. See [:material-code-braces: MonitoringStoppingConditionTypeDef](./type_defs.md#monitoringstoppingconditiontypedef) 
7. See [:material-code-braces: NetworkConfigPaginatorTypeDef](./type_defs.md#networkconfigpaginatortypedef) 
...
1. See [:material-code-braces: TransformJobDefinitionPaginatorTypeDef](./type_defs.md#transformjobdefinitionpaginatortypedef) 
...
1. See [:material-code-braces: TrainingJobPaginatorTypeDef](./type_defs.md#trainingjobpaginatortypedef) 
2. See [:material-code-braces: ProcessingJobPaginatorTypeDef](./type_defs.md#processingjobpaginatortypedef) 
...
2. See [:material-code-braces: MonitoringJobDefinitionPaginatorTypeDef](./type_defs.md#monitoringjobdefinitionpaginatortypedef) 
...
1. See [:material-code-braces: ModelPackageValidationProfilePaginatorTypeDef](./type_defs.md#modelpackagevalidationprofilepaginatortypedef) 
...
10. See [:material-code-braces: TrialComponentSourceDetailPaginatorTypeDef](./type_defs.md#trialcomponentsourcedetailpaginatortypedef) 
...
1. See [:material-code-brackets: ScheduleStatusType](./literals.md#schedulestatustype) 
2. See [:material-code-brackets: MonitoringTypeType](./literals.md#monitoringtypetype) 
3. See [:material-code-braces: MonitoringScheduleConfigPaginatorTypeDef](./type_defs.md#monitoringscheduleconfigpaginatortypedef) 
...
6. See [:material-code-braces: BatchTransformInputPaginatorTypeDef](./type_defs.md#batchtransforminputpaginatortypedef) 
...
4. See [:material-code-braces: MonitoringAlertSummaryTypeDef](./type_defs.md#monitoringalertsummarytypedef) 
5. See [:material-code-braces: MonitoringExecutionSummaryTypeDef](./type_defs.md#monitoringexecutionsummarytypedef) 
6. See [:material-code-braces: BatchTransformInputTypeDef](./type_defs.md#batchtransforminputtypedef) 
...
1. See [:material-code-braces: InferenceSpecificationTypeDef](./type_defs.md#inferencespecificationtypedef) 
2. See [:material-code-braces: SourceAlgorithmSpecificationPaginatorTypeDef](./type_defs.md#sourcealgorithmspecificationpaginatortypedef) 
3. See [:material-code-braces: ModelPackageValidationSpecificationPaginatorTypeDef](./type_defs.md#modelpackagevalidationspecificationpaginatortypedef) 
...
11. See [:material-code-braces: AdditionalInferenceSpecificationDefinitionPaginatorTypeDef](./type_defs.md#additionalinferencespecificationdefinitionpaginatortypedef) 
12. See [:material-code-braces: TagTypeDef](./type_defs.md#tagtypedef) 
13. See [:material-code-braces: DriftCheckBaselinesTypeDef](./type_defs.md#driftcheckbaselinestypedef) 
14. See [:material-code-brackets: SkipModelValidationType](./literals.md#skipmodelvalidationtype) 
...
1. See [:material-code-braces: ModelPaginatorTypeDef](./type_defs.md#modelpaginatortypedef) 
2. See [:material-code-braces: ModelDashboardEndpointTypeDef](./type_defs.md#modeldashboardendpointtypedef) 
3. See [:material-code-braces: TransformJobTypeDef](./type_defs.md#transformjobtypedef) 
4. See [:material-code-braces: ModelDashboardMonitoringSchedulePaginatorTypeDef](./type_defs.md#modeldashboardmonitoringschedulepaginatortypedef) 
...
2. See [:material-code-braces: DataCaptureConfigSummaryTypeDef](./type_defs.md#datacaptureconfigsummarytypedef) 
3. See [:material-code-brackets: EndpointStatusType](./literals.md#endpointstatustype) 
4. See [:material-code-braces: MonitoringSchedulePaginatorTypeDef](./type_defs.md#monitoringschedulepaginatortypedef) 
5. See [:material-code-braces: TagTypeDef](./type_defs.md#tagtypedef) 
...
4. See [:material-code-braces: TrialComponentPaginatorTypeDef](./type_defs.md#trialcomponentpaginatortypedef) 
5. See [:material-code-braces: EndpointPaginatorTypeDef](./type_defs.md#endpointpaginatortypedef) 
6. See [:material-code-braces: ModelPackagePaginatorTypeDef](./type_defs.md#modelpackagepaginatortypedef) 
...
12. See [:material-code-braces: ProjectPaginatorTypeDef](./type_defs.md#projectpaginatortypedef) 
13. See [:material-code-braces: HyperParameterTuningJobSearchEntityPaginatorTypeDef](./type_defs.md#hyperparametertuningjobsearchentitypaginatortypedef) 
14. See [:material-code-braces: ModelCardTypeDef](./type_defs.md#modelcardtypedef) 
15. See [:material-code-braces: ModelDashboardModelPaginatorTypeDef](./type_defs.md#modeldashboardmodelpaginatortypedef) 
## SearchRecordTypeDef
...
1. See [:material-code-braces: SearchRecordPaginatorTypeDef](./type_defs.md#searchrecordpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
