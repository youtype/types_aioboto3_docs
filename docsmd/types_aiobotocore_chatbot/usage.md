...
async with session.client("chatbot") as client:  # (1)
    kwargs: CreateChimeWebhookConfigurationRequestRequestTypeDef = {...}  # (2)
    result: CreateChimeWebhookConfigurationResultTypeDef = await client.create_chime_webhook_configuration(**kwargs)  # (3)
```

1. client: [ChatbotClient](./client.md)
2. kwargs: [:material-code-braces: CreateChimeWebhookConfigurationRequestRequestTypeDef](./type_defs.md#createchimewebhookconfigurationrequestrequesttypedef) 
