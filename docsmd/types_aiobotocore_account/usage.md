...
async with session.client("account") as client:  # (1)
    kwargs: AcceptPrimaryEmailUpdateRequestRequestTypeDef = {...}  # (2)
    result: AcceptPrimaryEmailUpdateResponseTypeDef = await client.accept_primary_email_update(**kwargs)  # (3)
```

1. client: [AccountClient](./client.md)
2. kwargs: [:material-code-braces: AcceptPrimaryEmailUpdateRequestRequestTypeDef](./type_defs.md#acceptprimaryemailupdaterequestrequesttypedef) 
