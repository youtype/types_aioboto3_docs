...
Type annotations and code completion for `#!python session.client("datasync").close` method.
...
7. See [:material-code-braces: CreateTaskResponseTypeDef](./type_defs.md#createtaskresponsetypedef) 
...
) -> StartTaskExecutionResponseTypeDef:  # (6)
    ...
```
...
6. See [:material-code-braces: StartTaskExecutionResponseTypeDef](./type_defs.md#starttaskexecutionresponsetypedef) 
